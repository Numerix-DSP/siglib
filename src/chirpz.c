...
void SIGLIB_FUNC_DECL SIF_Czt(SLData_t* SIGLIB_PTR_DECL pAWNr, SLData_t* SIGLIB_PTR_DECL pAWNi, SLData_t* SIGLIB_PTR_DECL pWMr,
                              SLData_t* SIGLIB_PTR_DECL pWMi, SLData_t* SIGLIB_PTR_DECL pvLr, SLData_t* SIGLIB_PTR_DECL pvLi,
                              SLData_t* SIGLIB_PTR_DECL pFFTCoeffs, SLArrayIndex_t* SIGLIB_PTR_DECL pBitReverseAddressTable, const SLData_t Radius,
                              const SLData_t Decay, const SLData_t StartFreq, const SLData_t EndFreq, const SLData_t SampleRate,
                              const SLArrayIndex_t InLen, const SLArrayIndex_t OutLen, const SLArrayIndex_t FFTLength,
                              const SLArrayIndex_t Log2FFTLength)
{
  ...
  SIF_Vl(pvLr, pvLi, W_1, W_12, InLen, OutLen,
         FFTLength);                      // Gen. contour definition coeffs
  SIF_Wm(pWMr, pWMi, W1, W12, OutLen);    // Gen. weighting coeffs

  // Performing this here will save time in the real time process
  SDA_Cfft(pvLr, pvLi, pFFTCoeffs, SIGLIB_NULL_ARRAY_INDEX_PTR, FFTLength,
           Log2FFTLength);    // Contour coeffs. FFT
...
void SIGLIB_FUNC_DECL SIF_Vl(SLData_t* SIGLIB_PTR_DECL pvLr, SLData_t* SIGLIB_PTR_DECL pvLi, const SLComplexRect_s W_1, const SLComplexRect_s W_12,
                             const SLArrayIndex_t InLen, const SLArrayIndex_t OutLen, const SLArrayIndex_t FFTLen)
{
  SLComplexRect_s C, D, Temp;

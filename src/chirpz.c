...
void SIGLIB_FUNC_DECL SIF_Czt (SLData_t * SIGLIB_PTR_DECL pAWNr,
...
void SIGLIB_FUNC_DECL SIF_Awn (SLData_t * SIGLIB_PTR_DECL pAWNr,
    SLData_t * SIGLIB_PTR_DECL pAWNi,
...
void SIGLIB_FUNC_DECL SIF_Vl (SLData_t * SIGLIB_PTR_DECL pvLr,
    SLData_t * SIGLIB_PTR_DECL pvLi,
...
void SIGLIB_FUNC_DECL SIF_Wm (SLData_t * SIGLIB_PTR_DECL pWMr,
    SLData_t * SIGLIB_PTR_DECL pWMi,
    const SLComplexRect_s W1,
    const SLComplexRect_s W12,
    const SLArrayIndex_t SampleLength)

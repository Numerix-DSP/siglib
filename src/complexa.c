...
void SIGLIB_FUNC_DECL SDA_CreateComplexRect(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                            SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
...
void SIGLIB_FUNC_DECL SDA_CreateComplexPolar(const SLData_t* SIGLIB_PTR_DECL pSrcMagn, const SLData_t* SIGLIB_PTR_DECL pSrcPhase,
                                             SLComplexPolar_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                 // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ExtractComplexRect(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDstReal,
                                             SLData_t* SIGLIB_PTR_DECL pDstImag, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ExtractComplexPolar(const SLComplexPolar_s* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDstMagn,
                                              SLData_t* SIGLIB_PTR_DECL pDstPhase, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_ClearComplexRect(SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ClearComplexPolar(SLComplexPolar_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_FillComplexRect(SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLComplexRect_s FillValue, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_FillComplexPolar(SLComplexPolar_s* SIGLIB_PTR_DECL pDst, const SLComplexPolar_s FillValue,
...
void SIGLIB_FUNC_DECL SDA_ComplexRectangularToPolar(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexPolar_s* SIGLIB_PTR_DECL pDst,
                                                    const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
    ...
    if ((pSrc->real < SIGLIB_MIN_THRESHOLD) && (pSrc->real > -SIGLIB_MIN_THRESHOLD) && (pSrc->imag < SIGLIB_MIN_THRESHOLD) &&
...
void SIGLIB_FUNC_DECL SDA_ComplexPolarToRectangular(const SLComplexPolar_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                                    const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_RectangularToPolar(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                             SLData_t* SIGLIB_PTR_DECL pDstMagn, SLData_t* SIGLIB_PTR_DECL pDstPhase,
                                             const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                 // Defined by TI compiler
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
    *pDstMagn++ = SDS_Sqrt(*pSrcReal * *pSrcReal + *pSrcImag * *pSrcImag);
    // Check for close to origin
    if ((*pSrcReal < SIGLIB_MIN_THRESHOLD) && (*pSrcReal > -SIGLIB_MIN_THRESHOLD) && (*pSrcImag < SIGLIB_MIN_THRESHOLD) &&
...
void SIGLIB_FUNC_DECL SDA_PolarToRectangular(const SLData_t* SIGLIB_PTR_DECL pSrcMagn, const SLData_t* SIGLIB_PTR_DECL pSrcPhase,
...
void SIGLIB_FUNC_DECL SDA_ComplexRectSqrt(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                          const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectInverse(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                             const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectConjugate(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                               const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectMagnitude(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                               const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectMagnitudeSquared(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                                      const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectPhase(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                           const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectMultiply(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc1, const SLComplexRect_s* SIGLIB_PTR_DECL pSrc2,
                                              SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectDivide(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc1, const SLComplexRect_s* SIGLIB_PTR_DECL pSrc2,
                                            SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectAdd(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc1, const SLComplexRect_s* SIGLIB_PTR_DECL pSrc2,
                                         SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectSubtract(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc1, const SLComplexRect_s* SIGLIB_PTR_DECL pSrc2,
                                              SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectLog(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                         const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectExp(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                         const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectExpj(const SLData_t* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                          const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectPow(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLData_t Power,
                                         const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectAddScalar(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, const SLData_t Scalar,
                                               SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectSubtractScalar(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, const SLData_t Scalar,
                                                    SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectMultiplyScalar(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, const SLData_t Scalar,
                                                    SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectDivideScalar(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc, const SLData_t Scalar,
                                                  SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexScalarSubtractRect(const SLData_t Scalar, const SLComplexRect_s* SIGLIB_PTR_DECL pSrc,
                                                    SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ComplexRectLinearInterpolate(const SLComplexRect_s rPoint1, const SLComplexRect_s rPoint2,
                                                       SLComplexRect_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t NumberOfInterpolatedPoints)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__    // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);
...
void SIGLIB_FUNC_DECL SDA_ComplexPolarLinearInterpolate(const SLComplexPolar_s Point1, const SLComplexPolar_s Point2,
                                                        SLComplexPolar_s* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t NumberOfInterpolatedPoints)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__    // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);

...
void SIGLIB_FUNC_DECL SIF_FftArb(SLData_t* SIGLIB_PTR_DECL pAWNr, SLData_t* SIGLIB_PTR_DECL pAWNi, SLData_t* SIGLIB_PTR_DECL pWMr,
...
void SIGLIB_FUNC_DECL SDA_RfftArb(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pRealDst, SLData_t* SIGLIB_PTR_DECL pImagDst,
                                  SLData_t* SIGLIB_PTR_DECL pRealTemp, SLData_t* SIGLIB_PTR_DECL pImagTemp, const SLData_t* SIGLIB_PTR_DECL pAWNr,
                                  const SLData_t* SIGLIB_PTR_DECL pAWNi, const SLData_t* SIGLIB_PTR_DECL pWMr, const SLData_t* SIGLIB_PTR_DECL pWMi,
...
void SIGLIB_FUNC_DECL SDA_CfftArb(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                  SLData_t* SIGLIB_PTR_DECL pRealDst, SLData_t* SIGLIB_PTR_DECL pImagDst, SLData_t* SIGLIB_PTR_DECL pRealTemp,
...
void SIGLIB_FUNC_DECL SDA_CifftArb(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                   SLData_t* SIGLIB_PTR_DECL pRealDst, SLData_t* SIGLIB_PTR_DECL pImagDst, SLData_t* SIGLIB_PTR_DECL pRealTemp,
                                   SLData_t* SIGLIB_PTR_DECL pImagTemp, const SLData_t* SIGLIB_PTR_DECL pAWNr,
                                   const SLData_t* SIGLIB_PTR_DECL pAWNi, const SLData_t* SIGLIB_PTR_DECL pWMr,

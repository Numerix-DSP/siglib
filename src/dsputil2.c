...
void SIGLIB_FUNC_DECL SDA_RealSpectralInverse(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                              const SLArrayIndex_t ArrayLength)
{
...
void SIGLIB_FUNC_DECL SDA_ComplexSpectralInverse(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
...
void SIGLIB_FUNC_DECL SDA_FdInterpolate(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* pSrcImag, SLData_t* SIGLIB_PTR_DECL pRealDst,
                                        SLData_t* SIGLIB_PTR_DECL pImagDst, const SLFixData_t RatioUp, const SLFixData_t RatioDown,
                                        const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                 // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_FdInterpolate2(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                         SLData_t* SIGLIB_PTR_DECL pRealDst, SLData_t* SIGLIB_PTR_DECL pImagDst,
                                         const SLArrayIndex_t SrcsampleLength, const SLArrayIndex_t DstsampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                 // Defined by TI compiler
  _nassert((int)pSrcReal % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDS_TdPitchShift(const SLData_t Sample, SLData_t* SIGLIB_PTR_DECL pShiftArray,
                                           SLArrayIndex_t* SIGLIB_PTR_DECL pShiftArrayOffsetIn, SLData_t* SIGLIB_PTR_DECL pShiftArrayOffsetOut,
                                           SLData_t* SIGLIB_PTR_DECL pPreviousSample, const SLData_t ShiftRatio,
                                           const SLArrayIndex_t ShiftArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                    // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_TdPitchShift(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* SIGLIB_PTR_DECL pShiftArray,
                                       SLArrayIndex_t* SIGLIB_PTR_DECL pShiftArrayOffsetIn, SLData_t* SIGLIB_PTR_DECL pShiftArrayOffsetOut,
                                       SLData_t* SIGLIB_PTR_DECL pPreviousSample, const SLData_t ShiftRatio, const SLArrayIndex_t ShiftArrayLength,
                                       const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                    // Defined by TI compiler
...
SLData_t SIGLIB_FUNC_DECL SDS_EchoGenerate(const SLData_t Sample, SLData_t* SIGLIB_PTR_DECL EchoArray,
                                           SLArrayIndex_t* SIGLIB_PTR_DECL EchoArrayOffsetIn, const SLData_t EchoDelay, const SLData_t EchoDecay,
                                           const enum SLEcho_t EchoType, const SLArrayIndex_t EchoArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                  // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_Power(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t power,
                                const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < sampleLength; i++) {
    *pDst++ = SDS_Pow(*pSrc,
                      power);    // Calls the ANSI standard pow() function through the macro
    pSrc++;
  }
}    // End of SDA_Power()
...
SLData_t SIGLIB_FUNC_DECL SDS_Polynomial(const SLData_t data, const SLData_t y0, const SLData_t y1, const SLData_t y2, const SLData_t y3,
                                         const SLData_t y4, const SLData_t y5)
{
  return (y0 + y1 * data + y2 * SDS_Pow(data, SIGLIB_TWO) + y3 * SDS_Pow(data, SIGLIB_THREE) + y4 * SDS_Pow(data, SIGLIB_FOUR) +
          y5 * SDS_Pow(data, SIGLIB_FIVE));
...
void SIGLIB_FUNC_DECL SDA_Polynomial(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t y0, const SLData_t y1,
                                     const SLData_t y2, const SLData_t y3, const SLData_t y4, const SLData_t y5, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDS_Modulo(const SLData_t Sample, const SLData_t Modulo, const enum SLModuloMode_t ModuloType)
{
  SLData_t Tmp = Sample;
...
void SIGLIB_FUNC_DECL SDA_Modulo(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t Modulo,
                                 const enum SLModuloMode_t ModuloType, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
 ...
 *existing gain for use across arrays SLData_t * SIGLIB_PTR_DECL pMax     -
 *Pointer to existing max for use across arrays const SLArrayIndex_t
 *SubsampleLength    - Sub array length const SLArrayIndex_t sampleLength -
 *Array length
 *
 * Return value:
 *  void
...
void SIGLIB_FUNC_DECL SDA_AgcPeak(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t DesiredMagnitude,
                                  const SLData_t MinThreshold, const SLData_t AttackSensitivity, const SLData_t DecaySensitivity,
                                  SLData_t* SIGLIB_PTR_DECL pGain, SLData_t* SIGLIB_PTR_DECL pMax, const SLArrayIndex_t SubsampleLength,
                                  const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
#if (SIGLIB_ARRAY_OR_PTR == SIGLIB_ARRAY_ACCESS)    // Select between array index
                                                    // or pointer access modes
    Max = SDA_AbsMax(pDst + i,
                     SubsampleLength);    // Detect absolute maximum value for peak AGC control
#else
    Max = SDA_AbsMax(pDst - SubsampleLength,
                     SubsampleLength);    // Detect absolute maximum value for peak AGC control
#endif
  }
...
void SIGLIB_FUNC_DECL SIF_AgcMeanAbs(SLData_t* SIGLIB_PTR_DECL pState, SLArrayIndex_t* pStateIndex, SLData_t* pMeanSum, SLData_t* pGain,
                                     SLData_t* pDesiredMeanScaled, SLData_t* pThresholdScaled, const SLData_t DesiredLevel,
                                     const SLData_t Threshold, const SLArrayIndex_t MeanLength)
{
  ...
  *pDesiredMeanScaled = DesiredLevel * (SLData_t)0.636618 * (SLData_t)MeanLength;    // Scaled mean value
  *pThresholdScaled = Threshold * (SLData_t)0.636618 * (SLData_t)MeanLength;         // Scaled threshold value
...
void SIGLIB_FUNC_DECL SDA_AgcMeanAbs(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t DesiredMeanScaled,
                                     const SLData_t ThresholdScaled, const SLData_t AttackSensitivity, const SLData_t DecaySensitivity,
                                     SLData_t* SIGLIB_PTR_DECL pState, SLArrayIndex_t* pStateIndex, SLData_t* pMeanSum, SLData_t* pGain,
                                     const SLArrayIndex_t MeanLength, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < sampleLength; i++) {
    ...
    *pDst++ = Tmp;                    // Store output value
    ...
    if (MeanSum > ThresholdScaled) {    // If signal level is above threshold then
                                        // adjust gain
...
void SIGLIB_FUNC_DECL SIF_AgcMeanSquared(SLData_t* SIGLIB_PTR_DECL pState, SLArrayIndex_t* pStateIndex, SLData_t* pMeanSquaredSum, SLData_t* pGain,
                                         SLData_t* pDesiredMeanSquaredScaled, SLData_t* pThresholdScaled, const SLData_t DesiredLevel,
                                         const SLData_t Threshold, const SLArrayIndex_t MeanLength)
{
  for (SLArrayIndex_t i = 0; i < MeanLength; i++) {    // Initialise the mean state array to 0
    *pState++ = SIGLIB_ZERO;
  ...
  *pMeanSquaredSum = SIGLIB_ZERO;    // Initilaise mean sum
  // *pDesiredMeanSquaredScaled = DesiredLevel * DesiredLevel * 0.405282 *
  // (SLData_t)MeanLength;  // Scaled mean squared value *pThresholdScaled =
  // Threshold * Threshold * 0.405282 * (SLData_t)MeanLength; // Scaled mean
  // squared threshold value
...
void SIGLIB_FUNC_DECL SDA_AgcMeanSquared(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                         const SLData_t DesiredMeanSquaredScaled, const SLData_t ThresholdScaled, const SLData_t AttackSensitivity,
                                         const SLData_t DecaySensitivity, SLData_t* SIGLIB_PTR_DECL pState, SLArrayIndex_t* pStateIndex,
                                         SLData_t* pMeanSquaredSum, SLData_t* pGain, const SLArrayIndex_t MeanLength,
                                         const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef _TMS320C6700              // Defined by TI compiler
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < sampleLength; i++) {
    ...
    *pDst++ = Tmp;                             // Store output value
    ...
    if (MeanSquaredSum > ThresholdScaled) {    // If signal level is above
                                               // threshold then adjust gain
 ...
 *detector coefficient SLData_t * pGain,                             - Pointer
 *to AGC gain
 *
 * Return value:
 *  void
...
void SIGLIB_FUNC_DECL SIF_AgcEnvelopeDetector(const SLData_t envelopeDetectorTimeConstant, const SLData_t sampleRate, SLData_t* pState,
                                              SLData_t* pOnePoleCoefficient, SLData_t* pGain)
{
  *pState = SIGLIB_ZERO;
...
SLData_t SIGLIB_FUNC_DECL SDS_AgcEnvelopeDetector(const SLData_t src, const SLData_t desiredLevel, const SLData_t minThresholdLevel,
                                                  const SLData_t AttackSensitivitySlow, const SLData_t DecaySensitivitySlow,
                                                  const SLData_t AttackSensitivityFast, const SLData_t DecaySensitivityFast, SLData_t* pState,
                                                  const SLData_t onePoleCoefficient, SLData_t* pGain, const SLData_t MaxGain,
                                                  const SLData_t MaxAttenuation)
{
  ...
  if (envelopeDetectorState > minThresholdLevel) {    // If signal level is above
                                                      // threshold then adjust gain
...
void SIGLIB_FUNC_DECL SDA_AgcEnvelopeDetector(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t desiredLevel,
                                              const SLData_t minThresholdLevel, const SLData_t AttackSensitivitySlow,
                                              const SLData_t DecaySensitivitySlow, const SLData_t AttackSensitivityFast,
                                              const SLData_t DecaySensitivityFast, SLData_t* pState, const SLData_t onePoleCoefficient,
                                              SLData_t* pGain, const SLData_t MaxGain, const SLData_t MaxAttenuation,
                                              const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef _TMS320C6700              // Defined by TI compiler
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < sampleLength; i++) {
    ...
    if (envelopeDetectorState > minThresholdLevel) {    // If signal level is above threshold then adjust
                                                        // gain
      if ((envelopeDetectorState * Gain < desiredLevel) && (Gain < MaxGain)) {
        if (envelopeDetectorState < (desiredLevel * SIGLIB_HALF)) {
          Gain *= AttackSensitivityFast;    // Increment gain
...
void SIGLIB_FUNC_DECL SIF_Drc(const SLData_t envelopeDetectorTimeConstant, const SLData_t sampleRate, SLData_t* pState,
 ...
 *SLDrcLevelGainTable_s *drcGainTable,  - Thresholds/Gains table const
 *SLArrayIndex_t numberOfKnees,       - Number of knees const SLData_t
...
SLData_t SIGLIB_FUNC_DECL SDS_Drc(const SLData_t input, SLData_t* envelopeState, const SLData_t envelopeOnePoleCoeff,
                                  const SLData_t envelopeThreshold, const SLDrcLevelGainTable_s* drcGainTable, const SLArrayIndex_t numberOfKnees,
 ...
 *SLDrcLevelGainTable_s *drcGainTable,  - Thresholds/Gains table const
 *SLArrayIndex_t numberOfKnees,       - Number of knees const SLData_t
 *makeupGain)                - Makeup gain const SLArrayIndex_t sampleLength) -
 *Sample length
 *
 * Return value:
 *  void
...
void SIGLIB_FUNC_DECL SDA_Drc(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* envelopeState,
                              const SLData_t envelopeOnePoleCoeff, const SLData_t envelopeThreshold, const SLDrcLevelGainTable_s* drcGainTable,
                              const SLArrayIndex_t numberOfKnees, const SLData_t makeupGain, const SLArrayIndex_t sampleLength)
{
  SLData_t localEnvelopeState = *envelopeState;
...
void SIGLIB_FUNC_DECL SDA_GroupDelay(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* SIGLIB_PTR_DECL PreviousPhase,
                                     const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLFixData_t SIGLIB_FUNC_DECL SDA_ZeroCrossingDetect(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* pPrevValue,
                                                    const enum SLLevelCrossingMode_t ZXT, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDS_ZeroCrossingDetect(const SLData_t Src, SLData_t* pPrevValue, const enum SLLevelCrossingMode_t ZXT)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_FirstZeroCrossingLocation(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pPrevValue,
                                                              const enum SLLevelCrossingMode_t ZXT, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLFixData_t SIGLIB_FUNC_DECL SDA_ZeroCrossingCount(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* pPrevValue, const enum SLLevelCrossingMode_t ZXT,
                                                   const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLFixData_t SIGLIB_FUNC_DECL SDA_LevelCrossingDetect(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t DetectionLevel,
                                                     SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* pPrevValue, const enum SLLevelCrossingMode_t ZXT,
                                                     const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLData_t SIGLIB_FUNC_DECL SDS_LevelCrossingDetect(const SLData_t Src, const SLData_t DetectionLevel, SLData_t* pPrevValue,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_FirstLevelCrossingLocation(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t DetectionLevel,
                                                               SLData_t* SIGLIB_PTR_DECL pPrevValue, const enum SLLevelCrossingMode_t ZXT,
                                                               const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLFixData_t SIGLIB_FUNC_DECL SDA_LevelCrossingCount(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t DetectionLevel, SLData_t* pPrevValue,
                                                    const enum SLLevelCrossingMode_t ZXT, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_Trigger(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pPrevSign, const SLData_t TriggerLevel,
                                            const enum SLLevelCrossingMode_t ZXT, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_ClearLocation(SLData_t pDst[], const SLArrayIndex_t Locn, const SLArrayIndex_t sampleLength)
{
...
void SIGLIB_FUNC_DECL SDA_SetLocation(SLData_t pDst[], const SLArrayIndex_t Locn, const SLData_t Val, const SLArrayIndex_t sampleLength)
{
  if (Locn < sampleLength) {
    pDst[Locn] = Val;
  }
...
void SIGLIB_FUNC_DECL SDA_SortMinToMax(const SLData_t pSrc[], SLData_t pDst[], const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_SortMaxToMin(const SLData_t pSrc[], SLData_t pDst[], const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_SortMinToMax2(const SLData_t pSrc1[], const SLData_t pSrc2[], SLData_t pDst1[], SLData_t pDst2[],
                                        const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_SortMaxToMin2(const SLData_t pSrc1[], const SLData_t pSrc2[], SLData_t pDst1[], SLData_t pDst2[],
                                        const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_SortIndexed(const SLData_t pSrc[], const SLArrayIndex_t pIndex[], SLData_t pDst[], const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_Sign(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_Swap(SLData_t* SIGLIB_PTR_DECL pSrc1, SLData_t* SIGLIB_PTR_DECL pSrc2, const SLArrayIndex_t sampleLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
  _nassert((int)pSrc1 % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLFixData_t SIGLIB_FUNC_DECL SUF_ModuloIncrement(const SLFixData_t Input, const SLFixData_t IncValue, const SLFixData_t Modulus)
{
...
SLFixData_t SIGLIB_FUNC_DECL SUF_ModuloDecrement(const SLFixData_t Input, const SLFixData_t DecValue, const SLFixData_t Modulus)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_IndexModuloIncrement(const SLArrayIndex_t Input, const SLArrayIndex_t IncValue, const SLArrayIndex_t Modulus)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_IndexModuloDecrement(const SLArrayIndex_t Input, const SLArrayIndex_t DecValue, const SLArrayIndex_t Modulus)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_Find(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDataDst,
                                         SLArrayIndex_t* SIGLIB_PTR_DECL pLocationDst, const enum SLFindType_t FindType,
                                         const SLArrayIndex_t ArrayLength)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_FindValue(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t DesiredValue, SLData_t* SIGLIB_PTR_DECL pDataDst,
                                              SLArrayIndex_t* SIGLIB_PTR_DECL pLocationDst, const enum SLFindType_t FindType,
                                              const SLArrayIndex_t ArrayLength)
{
  SLArrayIndex_t NumberOfElements = ((SLArrayIndex_t)0);

...
SLError_t SIGLIB_FUNC_DECL SIF_CostasQamDemodulate(
    SLData_t* pCostasLpVCOPhase, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable, const SLArrayIndex_t CostasLoopVCOLookUpTableSize,
    const SLData_t CostasLoopLPFCutOffFrequency, SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index,
    SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index, SLData_t* SIGLIB_PTR_DECL pCostasLpLPFCoeffs,
    const SLArrayIndex_t CostasLpLPFLength, SLData_t* pCostasLpLoopFilterState, SLData_t* pCostasLoopLoopSample,
    SLData_t* SIGLIB_PTR_DECL pELGMatchedFilterState, SLArrayIndex_t* pELGMatchedFilterIndex, SLData_t* SIGLIB_PTR_DECL pELGMatchedFilterSum,
    SLData_t* SIGLIB_PTR_DECL pELGEarlyGateDelay, SLArrayIndex_t* pELGEarlyGateDelayIndex, const SLArrayIndex_t ELGEarlyGateDelayLength,
    SLData_t* SIGLIB_PTR_DECL pELGLoopFilterState, SLData_t* SIGLIB_PTR_DECL pELGLoopFilterCoeffs, SLArrayIndex_t* pELGLoopFilterIndex,
    const SLArrayIndex_t ELGLoopFilterLength, const SLData_t ELGLoopFilterFc, SLFixData_t* pELGPulseDetectorThresholdFlag,
    SLData_t* pELGZeroCrossingPreviousSample, SLArrayIndex_t* pELGTriggerCount, SLFixData_t* pELGTriggerDetectedFlag,
    SLFixData_t* pELGTriggerUpdatedFlag, SLArrayIndex_t* pELGTriggerLatency, const SLArrayIndex_t SymbolLength, SLData_t* pELGRealOutputSynchDelay,
    SLData_t* pELGImagOutputSynchDelay, SLArrayIndex_t* pELGOutputSynchDelayIndex)
{
  SLError_t ErrorCode = SIGLIB_NO_ERROR;

  // Initialise the Costas loop
  ErrorCode |= SIF_CostasLoop(pCostasLpVCOPhase, pCostasLoopVCOLookUpTable, CostasLoopVCOLookUpTableSize, CostasLoopLPFCutOffFrequency,
                              pCostasLpLPF1State, pCostasLpLPF1Index, pCostasLpLPF2State, pCostasLpLPF2Index, pCostasLpLPFCoeffs, CostasLpLPFLength,
                              pCostasLpLoopFilterState, pCostasLoopLoopSample);

  // Initialise the early-late gate synchronizer with acquisition mode filter
  ErrorCode |= SIF_EarlyLateGateSquarePulse(pELGMatchedFilterState, pELGMatchedFilterIndex, pELGMatchedFilterSum, pELGEarlyGateDelay,
                                            pELGEarlyGateDelayIndex, ELGEarlyGateDelayLength, pELGLoopFilterState, pELGLoopFilterCoeffs,
                                            pELGLoopFilterIndex, ELGLoopFilterLength, ELGLoopFilterFc, pELGPulseDetectorThresholdFlag,
                                            pELGZeroCrossingPreviousSample, pELGTriggerCount, pELGTriggerDetectedFlag, pELGTriggerUpdatedFlag,
                                            SIGLIB_ELG_TRIGGER_MIDDLE, pELGTriggerLatency, SymbolLength);
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDS_CostasQamDemodulate(
    const SLData_t Src, SLData_t* pRealDst, SLData_t* pImagDst, SLData_t* pCostasLpVCOPhase, const SLData_t CostasLpVCOModulationIndex,
    SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable, const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierFreq,
    SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index, SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State,
    SLArrayIndex_t* pCostasLpLPF2Index, const SLData_t* SIGLIB_PTR_DECL pCostasLpLPFCoeffs, const SLArrayIndex_t CostasLpLPFLength,
    SLData_t* pCostasLpLoopFilterState, const SLData_t CostasLpLoopFilterCoeff, const enum SLCostasLoopFeedbackMode_t FeedbackMode,
    SLData_t* pCostasLoopLoopSample, SLData_t* SIGLIB_PTR_DECL pELGMatchedFilterState, SLArrayIndex_t* pELGMatchedFilterIndex,
    SLData_t* SIGLIB_PTR_DECL pELGMatchedFilterSum, SLData_t* SIGLIB_PTR_DECL pELGEarlyGateDelay, SLArrayIndex_t* pELGEarlyGateDelayIndex,
    const SLArrayIndex_t ELGEarlyGateDelayLength, SLData_t* SIGLIB_PTR_DECL pELGLoopFilterState, SLData_t* SIGLIB_PTR_DECL pELGLoopFilterCoeffs,
    SLArrayIndex_t* pELGLoopFilterIndex, const SLArrayIndex_t ELGLoopFilterLength, const SLData_t ELGNoiseThreshold,
    SLFixData_t* pELGPulseDetectorThresholdFlag, SLData_t* pELGZeroCrossingPreviousSample, SLArrayIndex_t* pELGTriggerCount,
    SLFixData_t* pELGTriggerDetectedFlag, SLFixData_t* pELGTriggerUpdatedFlag, const SLArrayIndex_t SymbolLength,
    SLData_t* SIGLIB_PTR_DECL pELGRealOutputSynchDelay, SLData_t* SIGLIB_PTR_DECL pELGImagOutputSynchDelay,
    SLArrayIndex_t* pELGOutputSynchDelayIndex, const SLArrayIndex_t ELGOutputSynchDelayLength)
{
  SLData_t ImagTmp,
  ...
  SDS_FrequencyModulateComplex(*pCostasLoopLoopSample, &RealVCOOutput, &ImagVCOOutput, CarrierFreq, CostasLpVCOModulationIndex, pCostasLpVCOPhase,
                               pCostasLoopVCOLookUpTable, CostasLoopVCOLookUpTableSize);

#if SIGLIB_ENABLE_DEBUG_LOGGING
  SUF_Debugfprintf("CostasQamDemodulate: Src = %lf, CostasLoopLoopSample = "
                   "%lf, RealVCOOutput = %lf, ImagVCOOutput = %lf\n",
...
// *pCostasLoopLoopSample);
  ...
  ELGTriggerOutput =
      SDS_EarlyLateGateSquarePulse(RealTmp, pELGMatchedFilterState, pELGMatchedFilterIndex, pELGMatchedFilterSum, pELGEarlyGateDelay,
                                   pELGEarlyGateDelayIndex, ELGEarlyGateDelayLength, pELGLoopFilterState, pELGLoopFilterCoeffs, pELGLoopFilterIndex,
                                   ELGLoopFilterLength, ELGNoiseThreshold, pELGPulseDetectorThresholdFlag, pELGZeroCrossingPreviousSample,
  ...
  SDS_FixedDelayComplex(RealTmp, ImagTmp, &RealDelayedOutput, &ImagDelayedOutput, pELGRealOutputSynchDelay, pELGImagOutputSynchDelay,
  ...
  if (ELGTriggerOutput != SIGLIB_ZERO) {    // If we have a trigger then output the I & Q sample
    ...
    *pImagDst = ImagDelayedOutput;
    IQOutputFlag = SIGLIB_AI_ONE;    // Set flag to indicate that a symbol has been
                                     // demodulated
  }

  // Calculate one pole loop filter
  *pCostasLoopLoopSample = SDS_OnePoleNormalized(*pCostasLoopLoopSample, CostasLpLoopFilterCoeff, pCostasLpLoopFilterState);
...
#else                                      // The following function has too many parameters for the TI C3x/C4x
                                           // compiler
SLArrayIndex_t SIGLIB_FUNC_DECL SDS_CostasQamDemodulateDebug(
    ...
    SLFixData_t* pELGTriggerDetectedFlag, SLFixData_t* pELGTriggerUpdatedFlag, const SLArrayIndex_t SymbolLength,
    SLData_t* SIGLIB_PTR_DECL pELGRealOutputSynchDelay, SLData_t* SIGLIB_PTR_DECL pELGImagOutputSynchDelay,
    SLArrayIndex_t* pELGOutputSynchDelayIndex, const SLArrayIndex_t ELGOutputSynchDelayLength, SLData_t* pDebugRealFilterOutput,
    SLData_t* pDebugImagFilterOutput, SLData_t* pDebugELGTriggerOutput, SLArrayIndex_t* pTriggerIndexCount)
{
  SLData_t ImagTmp,
      RealTmp;                              // Temporary data processing variables - one for each path
  SLData_t RealVCOOutput, ImagVCOOutput;    // Local VCO output
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_CostasQamDemodulate(
    const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pRealDst, SLData_t* SIGLIB_PTR_DECL pImagDst, SLData_t* pCostasLpVCOPhase,
    const SLData_t CostasLpVCOModulationIndex, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
    const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierFreq, SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State,
    SLArrayIndex_t* pCostasLpLPF1Index, SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index,
    const SLData_t* SIGLIB_PTR_DECL pCostasLpLPFCoeffs, const SLArrayIndex_t CostasLpLPFLength, SLData_t* pCostasLpLoopFilterState,
    const SLData_t CostasLpLoopFilterCoeff, const enum SLCostasLoopFeedbackMode_t FeedbackMode, SLData_t* pCostasLoopLoopSample,
    SLData_t* SIGLIB_PTR_DECL pELGMatchedFilterState, SLArrayIndex_t* pELGMatchedFilterIndex, SLData_t* SIGLIB_PTR_DECL pELGMatchedFilterSum,
    SLData_t* SIGLIB_PTR_DECL pELGEarlyGateDelay, SLArrayIndex_t* pELGEarlyGateDelayIndex, const SLArrayIndex_t ELGEarlyGateDelayLength,
    SLData_t* SIGLIB_PTR_DECL pELGLoopFilterState, SLData_t* SIGLIB_PTR_DECL pELGLoopFilterCoeffs, SLArrayIndex_t* pELGLoopFilterIndex,
...
#  endif
    ...
    SDS_FrequencyModulateComplex(LocalCostasLoopLoopSample, &RealVCOOutput, &ImagVCOOutput, CarrierFreq, CostasLpVCOModulationIndex,
                                 pCostasLpVCOPhase, pCostasLoopVCOLookUpTable, CostasLoopVCOLookUpTableSize);
...
#  endif
    ...
    // Implement early-late gate trigger real data paths
    ELGTriggerOutput = SDS_EarlyLateGateSquarePulse(RealTmp, pELGMatchedFilterState, pELGMatchedFilterIndex, pELGMatchedFilterSum,
                                                    pELGEarlyGateDelay, pELGEarlyGateDelayIndex, ELGEarlyGateDelayLength, pELGLoopFilterState,
                                                    pELGLoopFilterCoeffs, pELGLoopFilterIndex, ELGLoopFilterLength, ELGNoiseThreshold,
                                                    pELGPulseDetectorThresholdFlag, pELGZeroCrossingPreviousSample, pELGTriggerCount,
                                                    pELGTriggerDetectedFlag, pELGTriggerUpdatedFlag, SymbolLength);
    ...
    // Calculate one pole loop filter
    LocalCostasLoopLoopSample = SDS_OnePoleNormalized(LocalCostasLoopLoopSample, CostasLpLoopFilterCoeff, pCostasLpLoopFilterState);
  }
...
void SIGLIB_FUNC_DECL SIF_QpskModulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                       const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                       SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxQFilterIndex,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLData_t RRCFPeriod, const SLData_t RRCFRollOff,
                                       const SLArrayIndex_t RRCFSize, const SLArrayIndex_t RRCFSwitch)
{
  SLData_t SinPhase = SIGLIB_ZERO;

  // 1 + 1/4 wave overlapped cosine and sine table
  SDA_SignalGenerate(pCarrierTable, SIGLIB_SINE_WAVE, SIGLIB_ONE, SIGLIB_FILL, CarrierPhaseIncrement, SIGLIB_ZERO, SIGLIB_ZERO, SIGLIB_ZERO,
  ...
  *pSampleClock = SIGLIB_AI_ZERO;    // Initialise phase for sample clock
  ...
  pMagn->imag = SIGLIB_ZERO;    // Clear magnitude integrator
...
void SIGLIB_FUNC_DECL SDA_QpskModulate(const SLFixData_t TxDiBit, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                       const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                       SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                       const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxQFilterIndex,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLArrayIndex_t RRCFSize, const SLArrayIndex_t RRCFSwitch)
{
...
void SIGLIB_FUNC_DECL SIF_QpskDemodulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                         const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                         SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                         SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex,
                                         SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex,
                                         SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLData_t RRCFPeriod, const SLData_t RRCFRollOff,
                                         const SLArrayIndex_t RRCFSize, const SLArrayIndex_t RRCFSwitch)
{
  SLData_t SinPhase = SIGLIB_ZERO;
...
SLFixData_t SIGLIB_FUNC_DECL SDA_QpskDemodulate(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                                const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                                const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol,
                                                SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex,
                                                SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex,
                                                SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLArrayIndex_t RRCFSize,
  ...
  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    ...
    if (*pSampleClock >= SamplesPerSymbol) {    // We have received a complete symbol
      *pSampleClock = SIGLIB_AI_ZERO;
      ...
      RxDiBit = siglib_numerix_QPSKRxConstellation[(SLArrayIndex_t)((((SLUFixData_t)pMagn->real) + (((SLUFixData_t)pMagn->imag) << 1U)) &
                                                                    SIGLIB_UFIX_THREE)];
...
SLFixData_t SIGLIB_FUNC_DECL SDA_QpskDemodulateDebug(
    const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLArrayIndex_t CarrierTableSize,
    SLData_t* SIGLIB_PTR_DECL pCarrierPhase, SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
    const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol, SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray,
    SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray,
    SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLArrayIndex_t RRCFSize,
    const SLArrayIndex_t RRCFSwitch, SLData_t* SIGLIB_PTR_DECL pEyeSamples, SLComplexRect_s* SIGLIB_PTR_DECL pConstellationPoints)
{
  SLData_t ISample, QSample;    // Data samples
  SLFixData_t RxDiBit = SIGLIB_AI_ZERO;
...
const SLFixData_t siglib_numerix_QPSKTxMapping[] = {1, 3, 0, 2, 3, 2, 1, 0, 0, 1, 2, 3, 2, 0, 3, 1};

// Map quadrant changes to output data
const SLFixData_t siglib_numerix_QPSKRxMapping[] = {2, 3, 0, 1, 0, 2, 1, 3, 3, 1, 2, 0, 1, 0, 3, 2};
...
SLFixData_t SIGLIB_FUNC_DECL SDS_QpskDifferentialEncode(const SLFixData_t TxDiBit, SLFixData_t* SIGLIB_PTR_DECL PreviousQuadrant)
{
  SLFixData_t Quadrant = siglib_numerix_QPSKTxMapping[(SLArrayIndex_t)(((SLUFixData_t)TxDiBit & SIGLIB_QPSK_BIT_MASK) << 2U) + *PreviousQuadrant];
...
SLFixData_t SIGLIB_FUNC_DECL SDS_QpskDifferentialDecode(const SLFixData_t MappedDiBit, SLFixData_t* SIGLIB_PTR_DECL PreviousDiBit)
{
  SLFixData_t Output = siglib_numerix_QPSKRxMapping[(SLArrayIndex_t)(((SLUFixData_t)MappedDiBit & SIGLIB_QPSK_BIT_MASK) << 2U) + *PreviousDiBit];

  *PreviousDiBit = (SLFixData_t)((SLUFixData_t)MappedDiBit & SIGLIB_QPSK_BIT_MASK);    // Save current di-bit
                                                                                       // for next iteration
...
void SIGLIB_FUNC_DECL SIF_DifferentialEncoder(SLArrayIndex_t* SIGLIB_PTR_DECL pEncodeTable, SLArrayIndex_t* SIGLIB_PTR_DECL pDecodeTable,
                                              const SLFixData_t wordLength)
{
...
SLFixData_t SIGLIB_FUNC_DECL SDS_DifferentialEncode(const SLFixData_t srcWord, SLFixData_t* SIGLIB_PTR_DECL pEncodeTable,
                                                    const SLFixData_t wordLength, const SLFixData_t bitMask,
...
SLFixData_t SIGLIB_FUNC_DECL SDS_DifferentialDecode(const SLFixData_t srcWord, SLFixData_t* SIGLIB_PTR_DECL pEncodeTable,
                                                    const SLFixData_t wordLength, const SLFixData_t bitMask,
                                                    SLFixData_t* SIGLIB_PTR_DECL pPreviousWord)
{
  SLFixData_t Word = pEncodeTable[(SLArrayIndex_t)(((SLUFixData_t)srcWord & bitMask) << wordLength) + *pPreviousWord];
...
void SIGLIB_FUNC_DECL SIF_FskModulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
...
void SIGLIB_FUNC_DECL SDA_FskModulateByte(SLFixData_t TxByte, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                          SLData_t* SIGLIB_PTR_DECL LevelOneCarrierPhase, SLData_t* SIGLIB_PTR_DECL LevelZeroCarrierPhase,
                                          const SLData_t LevelOneCarrierPhaseDelta, const SLData_t LevelZeroCarrierPhaseDelta,
                                          const SLFixData_t SamplesPerSymbol, const SLArrayIndex_t SineTableLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLFixData_t SIGLIB_FUNC_DECL SDA_FskDemodulateByte(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pLevelOneFilter,
                                                   const SLData_t* SIGLIB_PTR_DECL pLevelZeroFilter, const SLArrayIndex_t filterLength,
...
void SIGLIB_FUNC_DECL SDA_CpfskModulateByte(SLFixData_t TxByte, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                            SLData_t* SIGLIB_PTR_DECL PhaseOffset, const SLData_t LevelOneCarrierPhaseDelta,
                                            const SLData_t LevelZeroCarrierPhaseDelta, const SLFixData_t SamplesPerSymbol,
                                            const SLArrayIndex_t SineTableLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_FskModulate(SLFixData_t TxBit, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                      SLData_t* SIGLIB_PTR_DECL LevelOneCarrierPhase, SLData_t* SIGLIB_PTR_DECL LevelZeroCarrierPhase,
                                      const SLData_t LevelOneCarrierPhaseDelta, const SLData_t LevelZeroCarrierPhaseDelta,
                                      const SLFixData_t SamplesPerSymbol, const SLArrayIndex_t SineTableLength)
{
...
SLFixData_t SIGLIB_FUNC_DECL SDA_FskDemodulate(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pLevelOneFilter,
                                               const SLData_t* SIGLIB_PTR_DECL pLevelZeroFilter, const SLArrayIndex_t filterLength,
                                               const SLFixData_t SamplesPerSymbol)
{
#if (SIGLIB_ARRAYS_ALIGNED)
...
void SIGLIB_FUNC_DECL SDA_CpfskModulate(SLFixData_t TxBit, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                        SLData_t* SIGLIB_PTR_DECL PhaseOffset, const SLData_t LevelOneCarrierPhaseDelta,
                                        const SLData_t LevelZeroCarrierPhaseDelta, const SLFixData_t SamplesPerSymbol,
                                        const SLArrayIndex_t SineTableLength)
{
...
void SIGLIB_FUNC_DECL SIF_Qam16Modulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                        const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                        SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                        SLData_t* SIGLIB_PTR_DECL pRRCFTxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
                                        SLData_t* SIGLIB_PTR_DECL pRRCFTxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxQFilterIndex,
...
void SIGLIB_FUNC_DECL SDA_Qam16Modulate(const SLFixData_t TxNibble, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                        const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                        SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                        const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol,
                                        SLData_t* SIGLIB_PTR_DECL pRRCFTxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
...
void SIGLIB_FUNC_DECL SIF_Qam16Demodulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                          const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                          SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                          SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex,
                                          SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex,
...
SLFixData_t SIGLIB_FUNC_DECL SDA_Qam16Demodulate(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                                 const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                                 SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                                 const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol,
                                                 SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex,
  ...
  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    ...
    if (*pSampleClock >= SamplesPerSymbol) {    // We have received a complete symbol
      *pSampleClock = SIGLIB_AI_ZERO;
      ...
      // Decode constellation
      pMagn->real += SIGLIB_QAM16_DEMOD_OFFSET;    // Add offset for correct
                                                   // decision boundaries
      ...
      pMagn->imag += SIGLIB_QAM16_DEMOD_OFFSET;    // Add offset for correct
                                                   // decision boundaries
      ...
      RxNibble = siglib_numerix_QAM16RxConstellation[(
          SLFixData_t)((SLUFixData_t)(((SLFixData_t)pMagn->real) + ((12) - (SLFixData_t)(((SLUFixData_t)pMagn->imag) << 2U))) & 0x0fU)];
...
const SLFixData_t siglib_numerix_QAM16TxMapping[] = {0x6, 0x5, 0x9, 0xa, 0x7, 0x1, 0x8, 0xe, 0x2, 0x4, 0xd, 0xb, 0x3, 0x0, 0xc, 0xf};

const SLChar_t siglib_numerix_QAM16RxMapping[] = {0xd, 0x5, 0x8, 0xc, 0x9, 0x1, 0x0, 0x4, 0x6, 0x2, 0x3, 0xb, 0xe, 0xa, 0x7, 0xf};

// Map input data to quadrant changes
const SLFixData_t siglib_numerix_QAM16TxQuadrantChange[] = {1, 0, 3, 2};

// Map quadrant changes to output data
const SLInt16_t siglib_numerix_QAM16RxQuadrantChange[] = {1, 0, 3, 2, 2, 1, 0, 3, 3, 2, 1, 0, 0, 3, 2, 1};
...
SLFixData_t SIGLIB_FUNC_DECL SDA_Qam16DifferentialEncode(const SLFixData_t TxNibble, SLFixData_t* SIGLIB_PTR_DECL PreviousQuadrant)
{
  SLFixData_t Quadrant;

  // Differential phase encoding
  Quadrant = (SLFixData_t)((SLUFixData_t)(*PreviousQuadrant +
...
SLFixData_t SIGLIB_FUNC_DECL SDA_Qam16DifferentialDecode(const SLFixData_t MappedNibble, SLFixData_t* SIGLIB_PTR_DECL PreviousQuadrant)
{
  SLUFixData_t Offset;
  SLFixData_t Output;
  ...
  Output = (SLFixData_t)(siglib_numerix_QAM16RxQuadrantChange[(SLArrayIndex_t)(((SLUFixData_t)*PreviousQuadrant << 2U) +
                                                                               (SLArrayIndex_t)(Offset & SIGLIB_QPSK_BIT_MASK))] +
...
const SLComplexRect_s siglib_numerix_OPSKTxConstellation[] = {
    // Hex  Bit reversed
    {-SIGLIB_SQRT_TWO_DIV_TWO, -SIGLIB_SQRT_TWO_DIV_TWO},    // 0x0 0b000
    {SIGLIB_ZERO, SIGLIB_MINUS_ONE},                         // 0x1 0b100
    {SIGLIB_ZERO, SIGLIB_ONE},                               // 0x2 0b010
    {SIGLIB_SQRT_TWO_DIV_TWO, SIGLIB_SQRT_TWO_DIV_TWO},      // 0x3 0b110
    {SIGLIB_MINUS_ONE, SIGLIB_ZERO},                         // 0x4 0b001
    {SIGLIB_SQRT_TWO_DIV_TWO, -SIGLIB_SQRT_TWO_DIV_TWO},     // 0x5 0b101
    {-SIGLIB_SQRT_TWO_DIV_TWO, SIGLIB_SQRT_TWO_DIV_TWO},     // 0x6 0b011
    {SIGLIB_ONE, SIGLIB_ZERO},                               // 0x7 0b111
};

const SLComplexRect_s siglib_numerix_OPSKRxConstellation[] = {
    // Hex  Bit reversed
    {SIGLIB_SQRT_TWO_DIV_TWO, -SIGLIB_SQRT_TWO_DIV_TWO},     // 0x5 0b101
    {SIGLIB_ONE, SIGLIB_ZERO},                               // 0x7 0b111
    {SIGLIB_MINUS_ONE, SIGLIB_ZERO},                         // 0x4 0b001
...
void SIGLIB_FUNC_DECL SIF_OpskModulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                       const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                       SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxQFilterIndex,
...
void SIGLIB_FUNC_DECL SDA_OpskModulate(const SLFixData_t TxTriBit, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                       const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                       SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                       const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol,
                                       SLData_t* SIGLIB_PTR_DECL pRRCFTxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    if (RRCFSwitch == SIGLIB_ENABLE) {
      if (*pSampleClock == SIGLIB_AI_ZERO) {    // Keep track of sample clock
        // Convert data value to constellation point
        pMagn->real = siglib_numerix_OPSKTxConstellation[(SLUFixData_t)TxTriBit & SIGLIB_UFIX_SEVEN].real;    // Look up I and Q signal magnitudes
        pMagn->imag = siglib_numerix_OPSKTxConstellation[(SLUFixData_t)TxTriBit & SIGLIB_UFIX_SEVEN].imag;
      }
...
void SIGLIB_FUNC_DECL SIF_OpskDemodulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                         const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                         SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                         SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex,
                                         SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex,
...
SLFixData_t SIGLIB_FUNC_DECL SDA_OpskDemodulate(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                                const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                                SLData_t* SIGLIB_PTR_DECL DemodErrorArray, const SLArrayIndex_t CarrierTableIncrement,
                                                const SLFixData_t SamplesPerSymbol, SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs,
                                                const SLArrayIndex_t RRCFSize, const SLArrayIndex_t RRCFSwitch)
{
  SLData_t ISample, QSample;    // Data samples
  SLArrayIndex_t i;
  SLFixData_t RxTriBit = SIGLIB_AI_ZERO;
  ...
  for (i = 0; i < SamplesPerSymbol; i++) {
    ...
    if (*pSampleClock >= SamplesPerSymbol) {    // We have received a complete symbol
      *pSampleClock = SIGLIB_AI_ZERO;
      ...
      for (int i = 0; i < SIGLIB_OPSK_NUMBER_OF_PHASES; i++) {
        DemodErrorArray[i] = SDS_EuclideanDistanceSquared(siglib_numerix_OPSKTxConstellation[i].real, siglib_numerix_OPSKTxConstellation[i].imag,
                                                          pMagn->real, pMagn->imag);
      }

      RxTriBit = SDA_AbsMinIndex(DemodErrorArray, SIGLIB_OPSK_NUMBER_OF_PHASES);
...
SLFixData_t SIGLIB_FUNC_DECL SDA_OpskDemodulateDebug(
    const SLData_t* SIGLIB_PTR_DECL pSrc, const SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLArrayIndex_t CarrierTableSize,
    SLData_t* SIGLIB_PTR_DECL pCarrierPhase, SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
    SLData_t* SIGLIB_PTR_DECL DemodErrorArray, const SLArrayIndex_t CarrierTableIncrement, const SLFixData_t SamplesPerSymbol,
    SLData_t* SIGLIB_PTR_DECL pRRCFRxIStateArray, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxIFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFRxQStateArray,
    SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFRxQFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLArrayIndex_t RRCFSize,
    const SLArrayIndex_t RRCFSwitch, SLData_t* SIGLIB_PTR_DECL pEyeSamples, SLComplexRect_s* SIGLIB_PTR_DECL pConstellationPoints)
{
  SLData_t ISample, QSample;    // Data samples
    ...
    *pEyeSamples++ = pMagn->real;    // Store eye diagram samples
    ...
    if (*pSampleClock >= SamplesPerSymbol) {    // We have received a complete symbol
      *pSampleClock = SIGLIB_AI_ZERO;
      ...
      // SUF_Debugfprintf ("RxTriBit:pMagn->real = %lf\n", pMagn->real);
      // SUF_Debugfprintf ("RxTriBit:pMagn->imag = %lf\n", pMagn->imag);
...
}    // End of SDA_OpskDemodulateDebug()
...
void SIGLIB_FUNC_DECL SIF_BpskModulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement, SLData_t* pSampleCount,
                                       const SLArrayIndex_t SineTableLength)
{
  SLData_t SinPhase = SIGLIB_ZERO;
  // Carrier sine table
...
void SIGLIB_FUNC_DECL SDA_BpskModulate(SLFixData_t TxBit, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                       SLData_t* SIGLIB_PTR_DECL pCarrierPhase, const SLArrayIndex_t SamplesPerSymbol,
                                       const SLData_t CarrierPhaseDelta, const SLArrayIndex_t SineTableLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_BpskModulateByte(SLFixData_t TxByte, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                           SLData_t* SIGLIB_PTR_DECL pCarrierPhase, const SLArrayIndex_t SamplesPerSymbol,
                                           const SLData_t CarrierPhaseDelta, const SLArrayIndex_t SineTableLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
...
void SIGLIB_FUNC_DECL SIF_BpskDemodulate(SLData_t* pCostasLpVCOPhase, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
                                         const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierPhaseIncrement,
                                         ...
                                         SLData_t* pCostasLpLoopFilterState, SLData_t* pSample, SLArrayIndex_t* pRxSampleClock,
                                         SLData_t* pSampleSum)
{
  SIF_CostasLoop(pCostasLpVCOPhase, pCostasLoopVCOLookUpTable, CostasLoopVCOLookUpTableSize, CarrierPhaseIncrement, pCostasLpLPF1State,
                 pCostasLpLPF1Index, pCostasLpLPF2State, pCostasLpLPF2Index, pCostasLpLPFCoeffs, CostasLpLPFLength, pCostasLpLoopFilterState,
                 pSample);

  //  *pRxSampleClock = CostasLpHilbertTformLength >> 1;          // Initialise
  //  Rx sample clock *pRxSampleClock = SIGLIB_AI_ZERO;           // Initialise
  //  Rx sample clock
...
SLFixData_t SIGLIB_FUNC_DECL SDA_BpskDemodulate(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* pCostasLpVCOPhase,
                                                const SLData_t CostasLpVCOModulationIndex, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
                                                const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierFreq,
                                                SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index,
                                                SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index,
                                                const SLData_t* SIGLIB_PTR_DECL pCostasLpLPFCoeffs, const SLArrayIndex_t CostasLpLPFLength,
                                                SLData_t* pCostasLpLoopFilterState, const SLData_t CostasLpLoopFilterCoeff, SLData_t* pSample,
                                                SLArrayIndex_t* pRxSampleClock, SLData_t* pSampleSum, const SLFixData_t SamplesPerSymbol)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                           // Defined by TI compiler
...
#  endif
  ...
  SLData_t RealTmp,
      ImagTmp;                              // Temporary data processing variables - one for each path
  SLData_t RealVCOOutput, ImagVCOOutput;    // Local VCO output

  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    // Use the frequency modulator as a voltage controlled oscillator
    // Input is saved feedback sample from previous iteration
    SDS_FrequencyModulateComplex(*pSample, &RealVCOOutput, &ImagVCOOutput, CarrierFreq, CostasLpVCOModulationIndex, pCostasLpVCOPhase,
                                 pCostasLoopVCOLookUpTable, CostasLoopVCOLookUpTableSize);
    ...
    if (*pRxSampleClock >= SamplesPerSymbol) {    // If we have Rx'd a whole symbol then save it
      if (*pSampleSum > SIGLIB_EPSILON) {         // Check sum for '0' or '1'
        ReturnValue = SIGLIB_FIX_ONE;             // Return demodulated bit - already
                                                  // initialised to zero
      }
...
SLFixData_t SIGLIB_FUNC_DECL SDA_BpskDemodulateDebug(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* pCostasLpVCOPhase,
                                                     const SLData_t CostasLpVCOModulationIndex, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
                                                     const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierFreq,
                                                     SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index,
                                                     SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index,
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    ...
    *pFilterOutput++ = ImagTmp;    // Store filter output for debug
    ...
    if (*pRxSampleClock >= SamplesPerSymbol) {       // If we have Rx'd a whole symbol then save it
      if (*pSampleSum > SIGLIB_EPSILON) {            // Check sum for '0' or '1'
        ReturnValue = (SLFixData_t)SIGLIB_AI_ONE;    // Return demodulated bit -
...
void SIGLIB_FUNC_DECL SIF_DpskModulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement, SLData_t* pSampleCount,
                                       const SLArrayIndex_t SineTableLength, SLData_t* pModulationPhase)
{
  SLData_t SinPhase = SIGLIB_ZERO;
  // Carrier sine table
  SDA_SignalGenerate(pCarrierTable, SIGLIB_SINE_WAVE, SIGLIB_ONE, SIGLIB_FILL, CarrierPhaseIncrement, SIGLIB_ZERO, SIGLIB_ZERO, SIGLIB_ZERO,
...
void SIGLIB_FUNC_DECL SDA_DpskModulate(SLFixData_t TxBit, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                       SLData_t* SIGLIB_PTR_DECL pCarrierPhase, const SLArrayIndex_t SamplesPerSymbol,
                                       const SLData_t pCarrierPhaseDelta, const SLArrayIndex_t SineTableLength, SLData_t* pModulationPhase)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_DpskModulateByte(SLFixData_t TxByte, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t* SIGLIB_PTR_DECL pCarrierTable,
                                           SLData_t* SIGLIB_PTR_DECL pCarrierPhase, const SLArrayIndex_t SamplesPerSymbol,
                                           const SLData_t pCarrierPhaseDelta, const SLArrayIndex_t SineTableLength, SLData_t* pModulationPhase)
{
#if (SIGLIB_ARRAYS_ALIGNED)
...
void SIGLIB_FUNC_DECL SIF_DpskDemodulate(SLData_t* pCostasLpVCOPhase, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
                                         const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierPhaseIncrement,
                                         SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index,
                                         SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index,
                                         SLData_t* SIGLIB_PTR_DECL pCostasLpLPFCoeffs, const SLArrayIndex_t CostasLpLPFLength,
                                         SLData_t* pCostasLpLoopFilterState, SLData_t* pSample, SLArrayIndex_t* pRxSampleClock,
                                         SLData_t* pSampleSum, SLData_t* pPreviousSum)
{
  SIF_CostasLoop(pCostasLpVCOPhase, pCostasLoopVCOLookUpTable, CostasLoopVCOLookUpTableSize, CarrierPhaseIncrement, pCostasLpLPF1State,
                 pCostasLpLPF1Index, pCostasLpLPF2State, pCostasLpLPF2Index, pCostasLpLPFCoeffs, CostasLpLPFLength, pCostasLpLoopFilterState,
                 pSample);
...
SLFixData_t SIGLIB_FUNC_DECL SDA_DpskDemodulate(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* pCostasLpVCOPhase,
                                                const SLData_t CostasLpVCOModulationIndex, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
                                                const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierFreq,
                                                SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index,
                                                SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index,
  ...
  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    ...
    if (*pRxSampleClock >= SamplesPerSymbol) {    // If we have Rx'd a whole symbol then save it
      ...
      if (((*pSampleSum < -SIGLIB_EPSILON) && (*pPreviousSum < -SIGLIB_EPSILON)) ||
        ...
        ReturnValue = SIGLIB_AI_ONE;    // Return demodulated bit - already
                                        // initialised to zero
      }
...
SLFixData_t SIGLIB_FUNC_DECL SDA_DpskDemodulateDebug(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* pCostasLpVCOPhase,
                                                     const SLData_t CostasLpVCOModulationIndex, SLData_t* SIGLIB_PTR_DECL pCostasLoopVCOLookUpTable,
                                                     const SLArrayIndex_t CostasLoopVCOLookUpTableSize, const SLData_t CarrierFreq,
                                                     SLData_t* SIGLIB_PTR_DECL pCostasLpLPF1State, SLArrayIndex_t* pCostasLpLPF1Index,
                                                     SLData_t* SIGLIB_PTR_DECL pCostasLpLPF2State, SLArrayIndex_t* pCostasLpLPF2Index,
                                                     ...
                                                     SLData_t* pCostasLpLoopFilterState, const SLData_t CostasLpLoopFilterCoeff, SLData_t* pSample,
                                                     SLArrayIndex_t* pRxSampleClock, SLData_t* pSampleSum, const SLFixData_t SamplesPerSymbol,
                                                     SLData_t* pPreviousSum, SLData_t* SIGLIB_PTR_DECL pFilterOutput)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                           // Defined by TI compiler
  _nassert((int)pCostasLpLPF1State % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
const SLArrayIndex_t siglib_numerix_PiBy4DQPSKTxDiffEncTable[] = {1, 3, 7, 5, 2, 4, 0, 6, 3, 5, 1, 7, 4, 6, 2, 0,
                                                                  5, 7, 3, 1, 6, 0, 4, 2, 7, 1, 5, 3, 0, 2, 6, 4};

// Pi/4 DQPSK constellation diagram array

const SLComplexRect_s siglib_numerix_PiBy4DQPSKTxModulationIQTable[] = {
    {(SLData_t)1.0, (SLData_t)0.0},  {(SLData_t)0.70710678, (SLData_t)0.70710678},
    {(SLData_t)0.0, (SLData_t)1.0},  {(SLData_t)-0.70710678, (SLData_t)0.70710678},
    {(SLData_t)-1.0, (SLData_t)0.0}, {(SLData_t)-0.70710678, (SLData_t)-0.70710678},
    {(SLData_t)0.0, (SLData_t)-1.0}, {(SLData_t)0.70710678, (SLData_t)-0.70710678},
};
...
void SIGLIB_FUNC_DECL SIF_PiByFourDQpskModulate(SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLData_t CarrierPhaseIncrement,
                                                const SLArrayIndex_t CarrierTableSize, SLData_t* SIGLIB_PTR_DECL pCarrierPhase,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock, SLComplexRect_s* SIGLIB_PTR_DECL pMagn,
                                                SLData_t* SIGLIB_PTR_DECL pRRCFTxIFilterState, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex,
                                                SLData_t* SIGLIB_PTR_DECL pRRCFTxQFilterState, SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxQFilterIndex,
                                                SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs, const SLData_t RRCFPeriod, const SLData_t RRCFRollOff,
                                                const SLArrayIndex_t RRCFSize, const SLArrayIndex_t RRCFSwitch, SLArrayIndex_t* pPrevOutputSymbol)
{
  SLData_t SinPhase = SIGLIB_ZERO;
...
void SIGLIB_FUNC_DECL SDA_PiByFourDQpskModulate(const SLFixData_t TxDiBit, SLData_t* SIGLIB_PTR_DECL pDst,
                                                const SLData_t* SIGLIB_PTR_DECL pCarrierTable, const SLArrayIndex_t CarrierTableSize,
                                                SLData_t* SIGLIB_PTR_DECL pCarrierPhase, SLArrayIndex_t* SIGLIB_PTR_DECL pSampleClock,
                                                SLComplexRect_s* SIGLIB_PTR_DECL pMagn, const SLArrayIndex_t CarrierTableIncrement,
                                                const SLFixData_t SamplesPerSymbol, SLData_t* SIGLIB_PTR_DECL pRRCFTxIFilterState,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxIFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFTxQFilterState,
                                                SLArrayIndex_t* SIGLIB_PTR_DECL pRRCFTxQFilterIndex, SLData_t* SIGLIB_PTR_DECL pRRCFCoeffs,
                                                const SLArrayIndex_t RRCFSize, const SLArrayIndex_t RRCFSwitch, SLArrayIndex_t* pPrevOutputSymbol)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  ...
  for (SLArrayIndex_t i = 0; i < SamplesPerSymbol; i++) {
    if (RRCFSwitch == SIGLIB_ENABLE) {
      if (*pSampleClock == SIGLIB_AI_ZERO) {    // Keep track of sample clock
        ...
        OutputSymbol = siglib_numerix_PiBy4DQPSKTxDiffEncTable[(SLArrayIndex_t)((SLUFixData_t)*pPrevOutputSymbol << 2U) +
...
void SIGLIB_FUNC_DECL SDS_ChannelizationCode(SLData_t ChannelizationCode[], const SLArrayIndex_t SpreadingFactor, const SLArrayIndex_t CodeIndex)
{
...
void SIGLIB_FUNC_DECL SDA_ComplexQPSKSpread(const SLFixData_t TxDiBit, SLComplexRect_s* SIGLIB_PTR_DECL pDst,
                                            const SLData_t* SIGLIB_PTR_DECL ChannelizationCodeI,
                                            const SLData_t* SIGLIB_PTR_DECL ChannelizationCodeQ, const SLData_t WeightI, const SLData_t WeightQ,
                                            const SLComplexRect_s* SIGLIB_PTR_DECL ScramblingCode, const SLArrayIndex_t SpreadingFactor)
{
  SLData_t ChannelizedWeightedI, ChannelizedWeightedQ;
  SLData_t IMagn, QMagn;    // I and Q signal magnitudes

  IMagn = siglib_numerix_QPSKSpreadTxConstellation[(SLArrayIndex_t)((SLUFixData_t)TxDiBit & SIGLIB_UFIX_THREE)]
              .real;    // Look up I and Q signal magnitudes
...
SLFixData_t SIGLIB_FUNC_DECL SDA_ComplexQPSKDeSpread(const SLComplexRect_s* SIGLIB_PTR_DECL pSrc,
                                                     ...
                                                     const SLData_t* SIGLIB_PTR_DECL DeChannelizationCodeQ, const SLData_t DeWeightI,
                                                     const SLData_t DeWeightQ, const SLComplexRect_s* SIGLIB_PTR_DECL DescramblingCode,
                                                     SLData_t* SIGLIB_PTR_DECL DemodErrorArray, const SLArrayIndex_t SpreadingFactor)
{

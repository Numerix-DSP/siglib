...
SLFixData_t SIGLIB_FUNC_DECL SDS_Scrambler1417(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t ITmp = Source;
  SLUInt32_t OTmp = 0U;    // Clear output register

  for (SLUInt32_t i = 0; i < SIGLIB_BYTE_LENGTH; i++) {    // Process each bit in the word
    SRTmp <<= 1U;                                          // Shift state register up by 1
    SLUInt32_t OTmp1 = (ITmp & 0x1U);                      // Bit 0
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Descrambler1417(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t ITmp = Source;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Scrambler1417WithInversion(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister,
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Descrambler1417WithInversion(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister,
                                                              SLFixData_t* SIGLIB_PTR_DECL pOnesBitCount,
                                                              SLFixData_t* SIGLIB_PTR_DECL pBitInversionFlag)
{
  SLUInt32_t SRTmp = *pShiftRegister;
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Scrambler1823(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t ITmp = Source;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Descrambler1823(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t ITmp = Source;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Scrambler523(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t ITmp = Source;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Descrambler523(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t ITmp = Source;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_ScramblerDescramblerPN9(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_ScramblerDescramblerPN15(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_ScramblerDescramblergCRC24(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_ScramblerDescramblergCRC16(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_ScramblerDescramblergCRC12(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
SLFixData_t SIGLIB_FUNC_DECL SDS_ScramblerDescramblergCRC8(const SLFixData_t Source, SLUInt32_t* SIGLIB_PTR_DECL pShiftRegister)
{
  SLUInt32_t SRTmp = *pShiftRegister;
  SLUInt32_t OTmp = 0U;    // Clear output register
...
void SIGLIB_FUNC_DECL SDS_LongCodeGenerator3GPPDL(SLComplexRect_s* SIGLIB_PTR_DECL pDst, SLUInt32_t* SIGLIB_PTR_DECL pXShiftRegister,
                                                  SLUInt32_t* SIGLIB_PTR_DECL pYShiftRegister, const SLArrayIndex_t NumberOfSamples)
{
  SLUInt32_t SRXTmp = *pXShiftRegister;
  SLUInt32_t SRYTmp = *pYShiftRegister;

  for (SLArrayIndex_t i = 0; i < NumberOfSamples; i++) {                     // Process each bit in the word
    SLUInt32_t FXTmp = (SRXTmp >> 15U) ^ (SRXTmp >> 6U) ^ (SRXTmp >> 4U);    // Caclulate feedforward
    SLUInt32_t FYTmp = (SRYTmp >> 15U) ^ (SRYTmp >> 14U) ^ (SRYTmp >> 13U) ^ (SRYTmp >> 12U) ^ (SRYTmp >> 11U) ^ (SRYTmp >> 10U) ^ (SRYTmp >> 9U) ^
                       (SRYTmp >> 8U) ^ (SRYTmp >> 6U) ^ (SRYTmp >> 5U);
...
void SIGLIB_FUNC_DECL SDS_LongCodeGenerator3GPPUL(SLComplexRect_s* SIGLIB_PTR_DECL pDst, SLUInt32_t* SIGLIB_PTR_DECL pXShiftRegister,
                                                  SLUInt32_t* SIGLIB_PTR_DECL pYShiftRegister, const SLArrayIndex_t NumberOfSamples)
{
  SLUInt32_t SRXTmp = *pXShiftRegister;
  SLUInt32_t SRYTmp = *pYShiftRegister;
  ...
  for (SLArrayIndex_t i = 0; i < NumberOfSamples; i++) {                     // Process each bit in the word
    SLUInt32_t FXTmp = (SRXTmp >> 18U) ^ (SRXTmp >> 7U) ^ (SRXTmp >> 4U);    // Caclulate feedforward
    SLUInt32_t FYTmp = (SRYTmp >> 17U) ^ (SRYTmp >> 6U) ^ (SRYTmp >> 4U);

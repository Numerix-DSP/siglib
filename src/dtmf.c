...
void SIGLIB_FUNC_DECL SIF_DtmfGenerate (SLData_t * SIGLIB_PTR_DECL pDTMFGenCoeff,
    const SLData_t SampleRate)

{
    SLData_t    Tmp[SIGLIB_RESONATOR_DELAY_LENGTH];     // We don't need to reset the state array,
...
SLError_t SIGLIB_FUNC_DECL SDA_DtmfGenerate (SLData_t * SIGLIB_PTR_DECL pDst,
    const SLFixData_t KeyCode,
    const SLData_t HalfMagnitude,
...

{
    ...
    switch (KeyCode) {
        case 0 : CosCoeffLowF = pDTMFGenCoeff[0]; SinCoeffLowF = pDTMFGenCoeff[1];
                CosCoeffHighF = pDTMFGenCoeff[8]; SinCoeffHighF = pDTMFGenCoeff[9]; break;
        case 1 : CosCoeffLowF = pDTMFGenCoeff[0]; SinCoeffLowF = pDTMFGenCoeff[1];
                CosCoeffHighF = pDTMFGenCoeff[10]; SinCoeffHighF = pDTMFGenCoeff[11]; break;
        case 2 : CosCoeffLowF = pDTMFGenCoeff[0]; SinCoeffLowF = pDTMFGenCoeff[1];
                CosCoeffHighF = pDTMFGenCoeff[12]; SinCoeffHighF = pDTMFGenCoeff[13]; break;
        case 3 : CosCoeffLowF = pDTMFGenCoeff[0]; SinCoeffLowF = pDTMFGenCoeff[1];
                CosCoeffHighF = pDTMFGenCoeff[14]; SinCoeffHighF = pDTMFGenCoeff[15]; break;
        case 4 : CosCoeffLowF = pDTMFGenCoeff[2]; SinCoeffLowF = pDTMFGenCoeff[3];
                CosCoeffHighF = pDTMFGenCoeff[8]; SinCoeffHighF = pDTMFGenCoeff[9]; break;
        case 5 : CosCoeffLowF = pDTMFGenCoeff[2]; SinCoeffLowF = pDTMFGenCoeff[3];
                CosCoeffHighF = pDTMFGenCoeff[10]; SinCoeffHighF = pDTMFGenCoeff[11]; break;
        case 6 : CosCoeffLowF = pDTMFGenCoeff[2]; SinCoeffLowF = pDTMFGenCoeff[3];
                CosCoeffHighF = pDTMFGenCoeff[12]; SinCoeffHighF = pDTMFGenCoeff[13]; break;
        case 7 : CosCoeffLowF = pDTMFGenCoeff[2]; SinCoeffLowF = pDTMFGenCoeff[3];
                CosCoeffHighF = pDTMFGenCoeff[14]; SinCoeffHighF = pDTMFGenCoeff[15]; break;
        case 8 : CosCoeffLowF = pDTMFGenCoeff[4]; SinCoeffLowF = pDTMFGenCoeff[5];
                CosCoeffHighF = pDTMFGenCoeff[8]; SinCoeffHighF = pDTMFGenCoeff[9]; break;
        case 9 : CosCoeffLowF = pDTMFGenCoeff[4]; SinCoeffLowF = pDTMFGenCoeff[5];
                CosCoeffHighF = pDTMFGenCoeff[10]; SinCoeffHighF = pDTMFGenCoeff[11]; break;
        case 10 : CosCoeffLowF = pDTMFGenCoeff[4]; SinCoeffLowF = pDTMFGenCoeff[5];
                CosCoeffHighF = pDTMFGenCoeff[12]; SinCoeffHighF = pDTMFGenCoeff[13]; break;
        case 11 : CosCoeffLowF = pDTMFGenCoeff[4]; SinCoeffLowF = pDTMFGenCoeff[5];
                CosCoeffHighF = pDTMFGenCoeff[14]; SinCoeffHighF = pDTMFGenCoeff[15]; break;
        case 12 : CosCoeffLowF = pDTMFGenCoeff[6]; SinCoeffLowF = pDTMFGenCoeff[7];
                CosCoeffHighF = pDTMFGenCoeff[8]; SinCoeffHighF = pDTMFGenCoeff[9]; break;
        case 13 : CosCoeffLowF = pDTMFGenCoeff[6]; SinCoeffLowF = pDTMFGenCoeff[7];
                CosCoeffHighF = pDTMFGenCoeff[10]; SinCoeffHighF = pDTMFGenCoeff[11]; break;
        case 14 : CosCoeffLowF = pDTMFGenCoeff[6]; SinCoeffLowF = pDTMFGenCoeff[7];
                CosCoeffHighF = pDTMFGenCoeff[12]; SinCoeffHighF = pDTMFGenCoeff[13]; break;
        case 15 : CosCoeffLowF = pDTMFGenCoeff[6]; SinCoeffLowF = pDTMFGenCoeff[7];
                CosCoeffHighF = pDTMFGenCoeff[14]; SinCoeffHighF = pDTMFGenCoeff[15]; break;
        default : return (SIGLIB_ERROR);
    }

//  SUF_Debugfprintf ("KeyCode = %d, CosCoeffLowF = %lf, SinCoeffLowF = %lf\nCosCoeffHighF = %lf, SinCoeffHighF = %lf\n", (int)KeyCode, CosCoeffLowF, SinCoeffLowF, CosCoeffHighF, SinCoeffHighF);
...
void SIGLIB_FUNC_DECL SIF_DtmfDetect (const SLData_t SampleRate,
    const SLArrayIndex_t SampleLength)
...
#if SIGLIB_ENABLE_DEBUG_FPRINTF
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffL0.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffL0.real, siglib_numerix_GoertzelCoeffL0.imag);
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffL1.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffL1.real, siglib_numerix_GoertzelCoeffL1.imag);
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffL2.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffL2.real, siglib_numerix_GoertzelCoeffL2.imag);
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffL3.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffL3.real, siglib_numerix_GoertzelCoeffL3.imag);

    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffH0.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffH0.real, siglib_numerix_GoertzelCoeffH0.imag);
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffH1.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffH1.real, siglib_numerix_GoertzelCoeffH1.imag);
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffH2.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffH2.real, siglib_numerix_GoertzelCoeffH2.imag);
    SUF_Debugfprintf ("siglib_numerix_GoertzelCoeffH3.real = %lf, .imag = %lf\n", siglib_numerix_GoertzelCoeffH3.real, siglib_numerix_GoertzelCoeffH3.imag);
#endif
...
SLStatus_t SIGLIB_FUNC_DECL SDA_DtmfDetect (SLData_t * SIGLIB_PTR_DECL pSrc,
    const SLArrayIndex_t SampleLength)
...
* Parameters:
*   SLData_t * SIGLIB_PTR_DECL pSrc                 - Source data aray pointer
*   const SLData_t  Threshold,                      - Threshold to detect signal present
*   SLFixData_t *SLStatus_t                         - Storage for previous key  code
*   SLFixData_t *KeyCodeLength                      - Storage for key code length
*   SLFixData_t  *KeyCodeRegistered                 - Storage for key code registration flag
*   const SLArrayIndex_t SampleLength               - Buffer length
*
* Return value:
*   SLStatus_t KeyCode      - Key code for detected key
...
SLStatus_t SIGLIB_FUNC_DECL SDA_DtmfDetectAndValidate (SLData_t * SIGLIB_PTR_DECL pSrc,
    const SLData_t Threshold,
    SLStatus_t  *PreviousKeyCode,
    SLFixData_t  *KeyCodeLength,
    SLFixData_t  *KeyCodeRegistered,
    const SLArrayIndex_t SampleLength)
...
#define ROBUST_DECODE               1                   // Robust decode ensures that more than half the high or low
        ...
        if ((SLUFixData_t)KeyCode & (SLUFixData_t)SIGLIB_NO_DTMF_SIGNAL) {
            ...
            if (KeyCode == *PreviousKeyCode) {              // If this key and the previous one are the same then
...

{
    ...
    switch (LocalKey) {
        case '1' : KeyCode = 0; break;
        case '2' : KeyCode = 1; break;
        case '3' : KeyCode = 2; break;
        case 'A' : KeyCode = 3; break;
        case '4' : KeyCode = 4; break;
        case '5' : KeyCode = 5; break;
        case '6' : KeyCode = 6; break;
        case 'B' : KeyCode = 7; break;
        case '7' : KeyCode = 8; break;
        case '8' : KeyCode = 9; break;
        case '9' : KeyCode = 10; break;
        case 'C' : KeyCode = 11; break;
        case '*' : KeyCode = 12; break;
        case '0' : KeyCode = 13; break;
        case '#' : KeyCode = 14; break;
        case 'D' : KeyCode = 15; break;
        default : KeyCode = SIGLIB_NO_DTMF_KEY; break;
    }
...

{
    ...
    switch ((SLUFixData_t)KeyCode & 0x0fU) {
        ...
        case 14 : Key = '#'; break;
        case 15 : Key = 'D'; break;
        default : Key = SIGLIB_NO_DTMF_KEY; break;      // No DTMF tones
    }

...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinReadData (SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const char endianMode,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinWriteData (const SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const char endianMode,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinReadFile (SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fname,
    const char endianMode,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinWriteFile (const SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fname,
    const char endianMode,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadData (SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvWriteData (const SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLData_t sampleRate,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadFile (SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fname,
    const SLData_t sampleRate,
    const SLArrayIndex_t numColumns,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvWriteFile (const SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fname,
    const SLData_t sampleRate,
    const SLArrayIndex_t sampleIndex,
    const SLArrayIndex_t numColumns,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadMatrix (SLData_t ** SIGLIB_PTR_DECL BPtr,
    const char *filename,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_DatReadData (SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_DatWriteData (const SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLData_t sampleRate,
    const SLArrayIndex_t sampleIndex,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_DatWriteHeader (FILE *p_ioFile,
    const SLData_t sampleRate)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_SigReadData (SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_SigWriteData (const SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_SigReadFile (SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fileName)
{
    FILE            *p_ioFile;
    SLArrayIndex_t  sampleCount = 0;
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavReadData (SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
...
void SIGLIB_FUNC_DECL SUF_WavWriteData (const SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavReadData16 (short * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
...
void SIGLIB_FUNC_DECL SUF_WavWriteData16 (const short *BPtr,
    FILE *p_ioFile,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavReadData32 (SLArrayIndex_t *BPtr,
    FILE *p_ioFile,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
...
void SIGLIB_FUNC_DECL SUF_WavWriteData32 (const SLArrayIndex_t *BPtr,
    FILE *p_ioFile,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
...
void SIGLIB_FUNC_DECL SUF_WavWriteWord (const short Word,
    FILE *p_ioFile)
...
void SIGLIB_FUNC_DECL SUF_WavWriteLong (const SLArrayIndex_t LongWord,
    FILE *p_ioFile)
...
void SIGLIB_FUNC_DECL SUF_WavWriteHeader (FILE *p_ioFile,
    const SLWavFileInfo_s wavInfo)
...
SLWavFileInfo_s SIGLIB_FUNC_DECL SUF_WavSetInfo (const SLArrayIndex_t SampleRate,
...
SLWavFileInfo_s SIGLIB_FUNC_DECL SUF_WavReadFile (SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fileName)
{
    FILE            *p_ioFile;
    SLWavFileInfo_s wavInfo;
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavWriteFile (const SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fileName,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavWriteFileScaled (const SLData_t * SIGLIB_PTR_DECL BPtr,
    const char *fileName,
    const SLWavFileInfo_s wavInfo,
    const SLArrayIndex_t arrayLength)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_XmtReadData (SLData_t * SIGLIB_PTR_DECL BPtr,
    FILE *p_ioFile,
    const SLArrayIndex_t arrayLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_ReadWeightsBinaryFile (const char *filenameWeights,
    SLData_t *layer1Weights,
    SLData_t *layer2Weights)

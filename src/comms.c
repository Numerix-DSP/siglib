...
SLData_t SIGLIB_FUNC_DECL SDA_BitErrorRate (const SLChar_t *pSrc1,
    const SLChar_t *pSrc2,
...
void SIGLIB_FUNC_DECL SDA_Interleave (const SLData_t pSrc[],
    SLData_t pDst[],
    const SLArrayIndex_t Stride,
    const SLArrayIndex_t SampleLength)
...
void SIGLIB_FUNC_DECL SDA_Deinterleave (const SLData_t pSrc[],
    SLData_t pDst[],
    const SLArrayIndex_t Stride,
    const SLArrayIndex_t SampleLength)
...
SLData_t SIGLIB_FUNC_DECL SCV_EuclideanDistance (const SLComplexRect_s SrcVector1,
...
SLData_t SIGLIB_FUNC_DECL SCV_EuclideanDistanceSquared (const SLComplexRect_s SrcVector1,
    const SLComplexRect_s SrcVector2)
...
void SIGLIB_FUNC_DECL SCA_EuclideanDistance (const SLComplexRect_s * SIGLIB_INPUT_PTR_DECL psrcVector1,
    const SLComplexRect_s * SIGLIB_INPUT_PTR_DECL psrcVector2,
...
SLData_t SIGLIB_FUNC_DECL SDS_EuclideanDistance (const SLData_t src1x,
    const SLData_t src1y,
    const SLData_t src2x,
    const SLData_t src2y)
...
SLData_t SIGLIB_FUNC_DECL SDS_EuclideanDistanceSquared (const SLData_t src1x,
    const SLData_t src1y,
    const SLData_t src2x,
    const SLData_t src2y)
...
void SIGLIB_FUNC_DECL SDA_EuclideanDistance (const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc1x,
    const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc1y,
    const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc2x,
    const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc2y,
    SLData_t * SIGLIB_OUTPUT_PTR_DECL pDst,
    const SLArrayIndex_t srcLength)
...
void SIGLIB_FUNC_DECL SDA_EuclideanDistanceSquared (const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc1x,
    const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc1y,
    const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc2x,
    const SLData_t * SIGLIB_INPUT_PTR_DECL pSrc2y,
    SLData_t * SIGLIB_OUTPUT_PTR_DECL pDst,
...
void SIGLIB_FUNC_DECL SIF_DetectNumericalWordSequence (SLFixData_t *pBitMask,
    SLFixData_t * SIGLIB_OUTPUT_PTR_DECL pDetectorState,
    SLArrayIndex_t WordLength,
    SLArrayIndex_t SynchSequenceLength)
...
SLFixData_t SIGLIB_FUNC_DECL SDS_DetectNumericalWordSequence (SLFixData_t InputWord,
    const SLFixData_t * SIGLIB_INPUT_PTR_DECL pSynchSequence,
    SLFixData_t BitMask,
    SLFixData_t * SIGLIB_INOUT_PTR_DECL pDetectorState,
    SLArrayIndex_t SynchSequenceLength)
...
void SIGLIB_FUNC_DECL SIF_DetectNumericalBitSequence (SLFixData_t *pSynchSequenceBitMask,
    SLFixData_t *pDetectorState,
    SLArrayIndex_t SynchSequenceLength)
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDS_DetectNumericalBitSequence (SLFixData_t InputWord,
    const SLFixData_t SynchSequence,
    SLFixData_t SynchSequenceBitMask,
    SLFixData_t *pDetectorState,
    SLArrayIndex_t InputWordLength)
...
void SIGLIB_FUNC_DECL SIF_DetectCharacterSequence (SLChar_t * SIGLIB_OUTPUT_PTR_DECL pDetectorState,
    SLArrayIndex_t SynchSequenceLength)
...
SLFixData_t SIGLIB_FUNC_DECL SDS_DetectCharacterSequence (SLChar_t InputCharacter,
    const SLChar_t * SIGLIB_INPUT_PTR_DECL pSynchSequence,
    SLChar_t * SIGLIB_INOUT_PTR_DECL pDetectorState,
    SLArrayIndex_t SynchSequenceLength)
...
SLData_t SIGLIB_FUNC_DECL SDS_ErrorVector (const SLComplexRect_s IdealPoint,
    const SLComplexRect_s ReceivedPoint)
{
...
SLData_t SIGLIB_FUNC_DECL SDS_ErrorVectorMagnitudePercent (const SLComplexRect_s IdealPoint,
    const SLComplexRect_s ReceivedPoint)
{
    SLData_t    ErrorVector_Real, ErrorVector_Imag;
...
SLData_t SIGLIB_FUNC_DECL SDS_ErrorVectorMagnitudeDecibels (const SLComplexRect_s IdealPoint,
    const SLComplexRect_s ReceivedPoint)
{
    SLData_t    ErrorVector_Real, ErrorVector_Imag;
...
void SIGLIB_FUNC_DECL SDS_QpskBitErrorCount (const SLFixData_t Src1,
    const SLFixData_t Src2,
    SLFixData_t *pBitCount,
    SLFixData_t *pBitErrorCount)
...
SLData_t SIGLIB_FUNC_DECL SDS_BitErrorRate (const SLFixData_t BitCount,
    const SLFixData_t BitErrorCount)

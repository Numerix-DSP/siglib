...
void SIGLIB_FUNC_DECL SDA_CorrelateLinear(const SLData_t* SIGLIB_PTR_DECL pSrc1, const SLData_t* SIGLIB_PTR_DECL pSrc2,
                                          SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t Length1, const SLArrayIndex_t Length2,
                                          const SLArrayIndex_t NumCorr)
{
...
void SIGLIB_FUNC_DECL SDA_CorrelatePartial(const SLData_t* SIGLIB_PTR_DECL pSrc1, const SLData_t* SIGLIB_PTR_DECL pSrc2,
                                           SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t Length1, const SLArrayIndex_t Length2)
{
#if (SIGLIB_ARRAYS_ALIGNED)
...
void SIGLIB_FUNC_DECL SDA_Covariance(SLData_t* SIGLIB_PTR_DECL pSrc1, SLData_t* SIGLIB_PTR_DECL pSrc2, SLData_t* SIGLIB_PTR_DECL pDst,
                                     const SLData_t InverseLength1, const SLData_t InverseLength2, const SLArrayIndex_t Length1,
                                     const SLArrayIndex_t Length2, const SLArrayIndex_t NumCorr)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
  _nassert((int)pSrc1 % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_CovariancePartial(SLData_t* SIGLIB_PTR_DECL pSrc1, SLData_t* SIGLIB_PTR_DECL pSrc2, SLData_t* SIGLIB_PTR_DECL pDst,
                                            const SLData_t InverseLength1, const SLData_t InverseLength2, const SLArrayIndex_t Length1,
                                            const SLArrayIndex_t Length2)
{
#if (SIGLIB_ARRAYS_ALIGNED)
...
void SIGLIB_FUNC_DECL SDA_CorrelateLinearReturnPeak(const SLData_t* SIGLIB_PTR_DECL pSrc1, const SLData_t* SIGLIB_PTR_DECL pSrc2,
                                                    SLData_t* pPeakMagnitude, SLArrayIndex_t* pPeakIndex, const SLArrayIndex_t Length1,
                                                    const SLArrayIndex_t Length2, const SLArrayIndex_t NumCorr)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef _TMS320C6700               // Defined by TI compiler

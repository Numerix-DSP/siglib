...
void SIGLIB_FUNC_DECL SDA_CorrelateLinear (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t Length1,
    const SLArrayIndex_t Length2,
...
void SIGLIB_FUNC_DECL SDA_CorrelatePartial (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t Length1,
    const SLArrayIndex_t Length2)
...
void SIGLIB_FUNC_DECL SDA_CorrelateCircular (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t SampleLength)
...
void SIGLIB_FUNC_DECL SDA_Covariance (SLData_t * SIGLIB_PTR_DECL pSrc1,
...
void SIGLIB_FUNC_DECL SDA_CovariancePartial (SLData_t * SIGLIB_PTR_DECL pSrc1,
    SLData_t * SIGLIB_PTR_DECL pSrc2,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLData_t InverseLength1,
    const SLData_t InverseLength2,
...
void SIGLIB_FUNC_DECL SDA_CorrelateLinearReturnPeak (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    SLData_t * pPeakMagnitude,
    SLArrayIndex_t * pPeakIndex,
    const SLArrayIndex_t Length1,

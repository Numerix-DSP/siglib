...
void SIGLIB_FUNC_DECL SDA_Multiplex (const SLData_t * SIGLIB_PTR_DECL p_SrcMuxArray,
    const SLData_t * SIGLIB_PTR_DECL p_SrcArray,
    SLData_t * SIGLIB_PTR_DECL p_DstMuxArray,
    const SLArrayIndex_t FrameSampleIndex,
...
#pragma DATA_ALIGN(p_SrcMuxArray, 8);       // Align arrays on 64 bit double word boundary for LDDW
#pragma DATA_ALIGN(p_SrcArray, 8);
#pragma DATA_ALIGN(p_DstMuxArray, 8);
#endif
#endif
...
void SIGLIB_FUNC_DECL SDA_Demultiplex (const SLData_t * SIGLIB_PTR_DECL p_SrcMuxArray,
    SLData_t * SIGLIB_PTR_DECL p_DstArray,
    const SLArrayIndex_t FrameSampleIndex,
    const SLArrayIndex_t NumFrames,
    const SLArrayIndex_t NumSamplesInFrame)
...
#ifdef _TMS320C6700                         // Defined by TI compiler
#pragma DATA_ALIGN(p_SrcMuxArray, 8);       // Align arrays on 64 bit double word boundary for LDDW
#pragma DATA_ALIGN(p_DstArray, 8);
#endif
#endif
...
void SIGLIB_FUNC_DECL SDA_Mux2 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
...
void SIGLIB_FUNC_DECL SDA_Demux2 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
...
#pragma DATA_ALIGN(pDst1, 8);
#pragma DATA_ALIGN(pDst2, 8);
#endif
#endif
...
void SIGLIB_FUNC_DECL SDA_Mux3 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
...
void SIGLIB_FUNC_DECL SDA_Demux3 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
    SLData_t * SIGLIB_PTR_DECL pDst2,
...
void SIGLIB_FUNC_DECL SDA_Mux4 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    const SLData_t * SIGLIB_PTR_DECL pSrc3,
...
void SIGLIB_FUNC_DECL SDA_Demux4 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
    SLData_t * SIGLIB_PTR_DECL pDst2,
    SLData_t * SIGLIB_PTR_DECL pDst3,
...
void SIGLIB_FUNC_DECL SDA_Mux5 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    const SLData_t * SIGLIB_PTR_DECL pSrc3,
    const SLData_t * SIGLIB_PTR_DECL pSrc4,
...
void SIGLIB_FUNC_DECL SDA_Demux5 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
    SLData_t * SIGLIB_PTR_DECL pDst2,
    SLData_t * SIGLIB_PTR_DECL pDst3,
    SLData_t * SIGLIB_PTR_DECL pDst4,
...
void SIGLIB_FUNC_DECL SDA_Mux6 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    const SLData_t * SIGLIB_PTR_DECL pSrc3,
    const SLData_t * SIGLIB_PTR_DECL pSrc4,
    const SLData_t * SIGLIB_PTR_DECL pSrc5,
    const SLData_t * SIGLIB_PTR_DECL pSrc6,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t SampleLength)
...
void SIGLIB_FUNC_DECL SDA_Demux6 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
    SLData_t * SIGLIB_PTR_DECL pDst2,
    SLData_t * SIGLIB_PTR_DECL pDst3,
    SLData_t * SIGLIB_PTR_DECL pDst4,
...
void SIGLIB_FUNC_DECL SDA_Mux7 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    const SLData_t * SIGLIB_PTR_DECL pSrc3,
    const SLData_t * SIGLIB_PTR_DECL pSrc4,
    const SLData_t * SIGLIB_PTR_DECL pSrc5,
    const SLData_t * SIGLIB_PTR_DECL pSrc6,
    const SLData_t * SIGLIB_PTR_DECL pSrc7,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t SampleLength)
...
void SIGLIB_FUNC_DECL SDA_Demux7 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
    SLData_t * SIGLIB_PTR_DECL pDst2,
    SLData_t * SIGLIB_PTR_DECL pDst3,
    SLData_t * SIGLIB_PTR_DECL pDst4,
...
void SIGLIB_FUNC_DECL SDA_Mux8 (const SLData_t * SIGLIB_PTR_DECL pSrc1,
    const SLData_t * SIGLIB_PTR_DECL pSrc2,
    const SLData_t * SIGLIB_PTR_DECL pSrc3,
    const SLData_t * SIGLIB_PTR_DECL pSrc4,
    const SLData_t * SIGLIB_PTR_DECL pSrc5,
    const SLData_t * SIGLIB_PTR_DECL pSrc6,
    const SLData_t * SIGLIB_PTR_DECL pSrc7,
    const SLData_t * SIGLIB_PTR_DECL pSrc8,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t SampleLength)
...
void SIGLIB_FUNC_DECL SDA_Demux8 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst1,
    SLData_t * SIGLIB_PTR_DECL pDst2,
    SLData_t * SIGLIB_PTR_DECL pDst3,
    SLData_t * SIGLIB_PTR_DECL pDst4,

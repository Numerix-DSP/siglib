...
SLComplexPolar_s SIGLIB_FUNC_DECL SCV_Polar(const SLData_t IM, const SLData_t IA)
{
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_Rectangular(const SLData_t IR, const SLData_t II)
{
...
SLComplexPolar_s SIGLIB_FUNC_DECL SCV_RectangularToPolar(const SLComplexRect_s Rect)
{
  ...
  if ((Rect.real < SIGLIB_MIN_THRESHOLD) && (Rect.real > -SIGLIB_MIN_THRESHOLD) && (Rect.imag < SIGLIB_MIN_THRESHOLD) &&
      (Rect.imag > -SIGLIB_MIN_THRESHOLD)) {
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_Multiply(const SLComplexRect_s IVect1, const SLComplexRect_s IVect2)
{
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_Divide(const SLComplexRect_s Numerator, const SLComplexRect_s Divisor)
{
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_Add(const SLComplexRect_s IVect1, const SLComplexRect_s IVect2)
{
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_Subtract(const SLComplexRect_s IVect1, const SLComplexRect_s IVect2)
{
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_Pow(const SLComplexRect_s IVect, const SLData_t Power)
{
  SLData_t Magn, Angle;
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_VectorAddScalar(const SLComplexRect_s IVect, const SLData_t Scalar)
{
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_VectorSubtractScalar(const SLComplexRect_s IVect, const SLData_t Scalar)
{
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_VectorMultiplyScalar(const SLComplexRect_s IVect, const SLData_t Scalar)
{
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_VectorDivideScalar(const SLComplexRect_s IVect, const SLData_t Scalar)
{
  SLComplexRect_s OVect;
...
SLComplexRect_s SIGLIB_FUNC_DECL SCV_ScalarSubtractVector(const SLData_t Scalar, const SLComplexRect_s IVect)
{
  SLComplexRect_s OVect;
...
void SIGLIB_FUNC_DECL SCV_Roots(const SLComplexRect_s a, const SLComplexRect_s b, const SLComplexRect_s c, SLComplexRect_s* Root1,
...
enum SLCompareType_t SIGLIB_FUNC_DECL SCV_Compare(const SLComplexRect_s IVect1, const SLComplexRect_s IVect2)
{

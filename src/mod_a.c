...
void SIGLIB_FUNC_DECL SIF_AmplitudeModulate (SLData_t * SIGLIB_PTR_DECL pCarrierTable,
    SLArrayIndex_t *pCarrierTableIndex,
    const SLArrayIndex_t ModulatorArrayLength)
...
void SIGLIB_FUNC_DECL SDA_AmplitudeModulate (const SLData_t * SIGLIB_PTR_DECL pSrc,
    const SLData_t * SIGLIB_PTR_DECL pCarrierTable,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLArrayIndex_t *pCarrierTableIndex,
    const SLArrayIndex_t ModulatorArrayLength,
...
#pragma DATA_ALIGN(pCarrierTable, 8);
#endif
#endif
...
SLData_t  SIGLIB_FUNC_DECL SDS_AmplitudeModulate (const SLData_t Src,
    const SLData_t * SIGLIB_PTR_DECL pCarrierTable,
    SLArrayIndex_t *pCarrierTableIndex,
    const SLArrayIndex_t ModulatorArrayLength)
...
#if (SIGLIB_ARRAYS_ALIGNED)
#ifdef _TMS320C6700                         // Defined by TI compiler
#pragma DATA_ALIGN(pCarrierTable, 8);       // Align arrays on 64 bit double word boundary for LDDW
#endif
#endif
...
void SIGLIB_FUNC_DECL SIF_AmplitudeModulate2 (SLData_t * SIGLIB_PTR_DECL pCarrierTable,
    SLData_t *pCarrierTablePhase,
    const SLArrayIndex_t ModulatorArrayLength)
...
void SIGLIB_FUNC_DECL SDA_AmplitudeModulate2 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    const SLData_t * SIGLIB_PTR_DECL pCarrierTable,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLData_t *pCarrierTablePhase,
    const SLData_t CarrierPhaseIncrement,
...
SLData_t  SIGLIB_FUNC_DECL SDS_AmplitudeModulate2 (const SLData_t Src,
    const SLData_t * SIGLIB_PTR_DECL pCarrierTable,
    SLData_t *pCarrierTablePhase,
    const SLData_t CarrierPhaseIncrement,
    const SLArrayIndex_t ModulatorArrayLength)
...
SLError_t SIGLIB_FUNC_DECL SIF_ComplexShift (SLData_t * SIGLIB_PTR_DECL pRealCombFilter,
    SLData_t * SIGLIB_PTR_DECL RealCombFilterSum,
    SLData_t * SIGLIB_PTR_DECL pImagCombFilter,
    SLData_t * SIGLIB_PTR_DECL ImagCombFilterSum,
    SLArrayIndex_t * SIGLIB_PTR_DECL CombFilterPhase,
...
void SIGLIB_FUNC_DECL SDA_ComplexShift (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLData_t * SIGLIB_PTR_DECL pRealCombFilter,
    SLData_t * SIGLIB_PTR_DECL RealCombFilterSum,
    SLData_t * SIGLIB_PTR_DECL pImagCombFilter,
...
void SIGLIB_FUNC_DECL SIF_FrequencyModulate (SLData_t *pCarrierPhase,
    SLData_t * SIGLIB_PTR_DECL pCosineTable,
    const SLArrayIndex_t TableLength)
...
*   const SLData_t CarrierPhaseIncrement,   Carrier phase increment per sample (radians / 2π)
*   const SLData_t ModIndex,                Modulation index
...
SLData_t SIGLIB_FUNC_DECL SDS_FrequencyModulate (const SLData_t Src,
    const SLData_t CarrierPhaseIncrement,
    const SLData_t ModIndex,
...
*   SLData_t * SIGLIB_PTR_DECL pDst,        Modulated signal destination pointer
*   const SLData_t CarrierPhaseIncrement,   Carrier phase increment per sample (radians / 2π)
*   const SLData_t ModIndex,                Modulation index
*   SLData_t *PhaseOffset,                  Phase offset
...
void SIGLIB_FUNC_DECL SDA_FrequencyModulate (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLData_t CarrierPhaseIncrement,
    const SLData_t ModIndex,
    SLData_t *PhaseOffset,
...
#pragma DATA_ALIGN(pSrc, 8);                // Align arrays on 64 bit double word boundary for LDDW
#pragma DATA_ALIGN(pDst, 8);
#pragma DATA_ALIGN(pLookUpTable, 8);
#endif
#endif
...
void SIGLIB_FUNC_DECL SDA_FrequencyDemodulate (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLData_t * SIGLIB_PTR_DECL DifferentiatePrevious,
    SLData_t * SIGLIB_PTR_DECL EnvelopePrevious,
...
void SIGLIB_FUNC_DECL SIF_FrequencyModulateComplex (SLData_t *pCarrierPhase,
...
* Parameters:
*   const SLData_t Src,                     Modulating signal source
*   SLData_t *pRealDst,                     Modulated real signal destination pointer
*   SLData_t *pImagDst,                     Modulated imaginary signal destination pointer
*   const SLData_t CarrierPhaseIncrement,   Carrier phase increment per sample (radians / 2π)
*   const SLData_t ModIndex,                Modulation index
*   SLData_t *PhaseOffset,                  Phase offset
*   const SLData_t * pLookUpTable,          Look up table pointer
...
void SIGLIB_FUNC_DECL SDS_FrequencyModulateComplex (const SLData_t Src,
    SLData_t *pRealDst,
    SLData_t *pImagDst,
    const SLData_t CarrierPhaseIncrement,
    const SLData_t ModIndex,
    SLData_t *PhaseOffset,
    const SLData_t * pLookUpTable,
    const SLArrayIndex_t SinCosPeriod)
...
* Parameters:
*   const SLData_t * SIGLIB_PTR_DECL pSrc,  Modulating signal source pointer
*   SLData_t * SIGLIB_PTR_DECL pRealDst,    Modulated real signal destination pointer
*   SLData_t * SIGLIB_PTR_DECL pImagDst,    Modulated imaginary signal destination pointer
*   const SLData_t CarrierPhaseIncrement,   Carrier phase increment per sample (radians / 2π)
*   const SLData_t ModIndex,                Modulation index
*   SLData_t *PhaseOffset,                  Phase offset
...
void SIGLIB_FUNC_DECL SDA_FrequencyModulateComplex (const SLData_t * SIGLIB_PTR_DECL pSrc,
...
void SIGLIB_FUNC_DECL SDA_DeltaModulate (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLData_t * SIGLIB_PTR_DECL CurrentModValue,
...
void SIGLIB_FUNC_DECL SDA_DeltaDemodulate (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLData_t * SIGLIB_PTR_DECL CurrentDeModValue,
    const SLArrayIndex_t SampleLength)
...
void SIGLIB_FUNC_DECL SDA_DeltaModulate2 (const SLData_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    SLData_t * SIGLIB_PTR_DECL CurrentIntegralValue,
    const SLData_t IntegratorMax,
    const SLArrayIndex_t SampleLength)

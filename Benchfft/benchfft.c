...
// Uncomment this line to use with Microsoft Embedded Visual C++ - unfortunately, #ifdef causes a conflict
//#include "stdafx.h"
...
#if defined (_WIN32_WCE)    // Microsoft Embedded Visual C++ does not include the clock functions
...
SLData_t RealTestResults [] = {
    ((SLData_t)1.008348e+000), ((SLData_t)1.053076e+000), ((SLData_t)1.237276e+000), ((SLData_t)1.972141e+000), ((SLData_t)-6.845027e+000),
    ((SLData_t)-4.940741e-001),((SLData_t)-3.663189e-002),((SLData_t)1.245789e-001), ((SLData_t)2.042201e-001), ((SLData_t)2.502331e-001),
    ((SLData_t)2.792468e-001), ((SLData_t)2.984821e-001), ((SLData_t)3.115331e-001), ((SLData_t)3.203501e-001), ((SLData_t)3.260425e-001),
    ((SLData_t)3.292417e-001), ((SLData_t)3.302744e-001), ((SLData_t)3.292417e-001), ((SLData_t)3.260425e-001), ((SLData_t)3.203501e-001),
    ((SLData_t)3.115331e-001), ((SLData_t)2.984821e-001), ((SLData_t)2.792468e-001), ((SLData_t)2.502331e-001), ((SLData_t)2.042201e-001),
    ((SLData_t)1.245789e-001), ((SLData_t)-3.663189e-002),((SLData_t)-4.940741e-001),((SLData_t)-6.845027e+000),((SLData_t)1.972141e+000),
    ((SLData_t)1.237276e+000), ((SLData_t)1.053076e+000)
    };
SLData_t ImagTestResults [] = {
    ...
    ((SLData_t)-2.024335e+000),((SLData_t)-1.126322e+000),((SLData_t)-7.755554e-001),((SLData_t)-5.791250e-001),((SLData_t)-4.480799e-001),
    ((SLData_t)-3.508550e-001),((SLData_t)-2.732627e-001),((SLData_t)-2.078686e-001),((SLData_t)-1.503050e-001),((SLData_t)-9.774349e-002),
    ...
    ((SLData_t)-8.288667e-001),((SLData_t)-3.270638e-001)
    };
...
enum SLSignal_t {           // Signal generation types - this includes the full library functionality
    SINE_WAVE,
    COS_WAVE,
    WHITE_NOISE,
    GAUSSIAN_NOISE,
...
enum SLSignalFillMode_t {       // Signal array fill modes - this includes the full library functionality
    SIG_FILL,
    SIG_ADD
};

enum SLSignalSign_t {           // Signal data types - this includes the full library functionality
    SIG_SIGNED_DATA,
    SIG_UNSIGNED_DATA
};

enum SLRoundingMode_t {         // Rounding of data mode - this includes the full library functionality
    SIG_ROUND_UP,
...

{
    ...
    SDA_Rfft (pRealData, pImagData, pFFTCoeffs, FFT_SIZE, LOG_FFT_SIZE);    // Perform FFT
    ...
    stop = clock();
    printf("Execution time = %d cycles, %le seconds at 166 MHz for a %d point real FFT\n", (stop - start - overhead),
            (((float)(stop - start - overhead)) * 6e-9), FFT_SIZE);
#elif defined (_TMS320C6200)
    stop = clock();
    printf("Execution time = %d cycles, %le seconds at 300 MHz for a %d point real FFT\n", (stop - start - overhead),
            (((float)(stop - start - overhead)) * 3.3e-9), FFT_SIZE);
#elif defined (_TMS320C6400)
    stop = clock();
    printf("Execution time = %d cycles, %le seconds at 600 MHz for a %d point real FFT\n", (stop - start - overhead),
            (((float)(stop - start - overhead)) * 1.6e-9), FFT_SIZE);
#endif
...
SLFixData_t SDA_SignalGenerate (SLData_t *ptr,
    enum SLSignal_t signal_type,
    SLData_t peak,
    enum SLSignalFillMode_t buf_fill_mode,
    SLData_t frequency,
...
SLFixData_t SIF_Window (SLData_t *wp,
    enum SLWindow_t window_type,
    SLFixData_t window_length)

{
    ...
    switch (window_type) {
        ...
        default : return (SIGLIB_PARAMETER_ERROR);
    }
}       // End of SIF_Window()
...
void SIF_Fft (SLData_t * pFFTCoeffs,
    const SLFixData_t FFTLength)
...
void SDA_Rfft (SLData_t realData[],
    SLData_t imagData[],
    const SLData_t * pFFTCoeffs,
    const SLFixData_t FFTLength,
    const SLFixData_t Log2Size)
...
#define TEN_FFTS    SDA_Rfft (pRealData, pImagData, pFFTCoeffs, FFT_SIZE, LOG_FFT_SIZE);\
    ...
    SDA_Copy (pWindowData, pRealData, FFT_SIZE);    // Reinitialise data to avoid overflow
    TEN_FFTS;

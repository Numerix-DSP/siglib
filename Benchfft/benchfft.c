...
SLData_t        SDS_Round (
  SLData_t,                                                         // Data sample
  enum SLRoundingMode_t);                                           // Rounding mode

void            SDA_Copy (
  SLData_t *,                                                       // Pointer to source array
  SLData_t *,                                                       // Pointer to destination array
  SLFixData_t);                                                     // Array length
...
SLData_t SDS_Round (
  SLData_t input,
  enum SLRoundingMode_t RoundingMode)
{
  switch (RoundingMode) {
    case SIG_ROUND_UP:

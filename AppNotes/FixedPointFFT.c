...
SLError_t SIGLIB_FUNC_DECL SIF_Window16 (SLInt16_t * SIGLIB_PTR_DECL pWindowCoeffs,
    const enum SLWindow_t WindowType,
    const SLData_t Coeff,
    const SLArrayIndex_t);

void SIGLIB_FUNC_DECL SDA_Window16 (const SLInt16_t * SIGLIB_PTR_DECL pSrc,
    SLInt16_t * SIGLIB_PTR_DECL pDst,
    const SLInt16_t * SIGLIB_PTR_DECL pWindowCoeffs,
    const SLArrayIndex_t);

SLError_t SIGLIB_FUNC_DECL SIF_Window32 (SLInt32_t * SIGLIB_PTR_DECL pWindowCoeffs,
    const enum SLWindow_t WindowType,
    const SLData_t Coeff,
    const SLArrayIndex_t);

void SIGLIB_FUNC_DECL SDA_Window32 (const SLInt32_t * SIGLIB_PTR_DECL pSrc,
...
//  SDA_SignalGenerate (pFloatSrcData, SIGLIB_COSINE_WAVE, ((SLData_t)SIGNAL_MAGNITUDE), SIGLIB_FILL, (SIGLIB_TWO / ((SLData_t)FFT_SIZE)), SIGLIB_ZERO,
    SDA_SignalGenerate (pFloatSrcData, SIGLIB_COSINE_WAVE, ((SLData_t)SIGNAL_MAGNITUDE), SIGLIB_FILL, (SIGLIB_FOUR / ((SLData_t)FFT_SIZE)), SIGLIB_ZERO,
        SIGLIB_ZERO, SIGLIB_ZERO, &CosinePhase, SIGLIB_NULL_DATA_PTR, FFT_SIZE);
...
SLError_t SIGLIB_FUNC_DECL SIF_Fft16 (SLInt16_t * SIGLIB_PTR_DECL pFFTCoeffs,
    const SLArrayIndex_t FFTLength)
...
void SIGLIB_FUNC_DECL SDA_Rfft16 (SLInt16_t SIGLIB_PTR_DECL realData[],
...
SLError_t SIGLIB_FUNC_DECL SIF_Fft32 (SLInt32_t * SIGLIB_PTR_DECL pFFTCoeffs,
    const SLArrayIndex_t FFTLength)
...
void SIGLIB_FUNC_DECL SDA_Rfft32 (SLInt32_t SIGLIB_PTR_DECL realData[],
...
void SIGLIB_FUNC_DECL SUF_Fix16ToSigLibData (SLInt16_t * SIGLIB_PTR_DECL pSrc,
...
void SIGLIB_FUNC_DECL SUF_SigLibDataToFix16 (SLData_t * SIGLIB_PTR_DECL pSrc,
    SLInt16_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t ArrayLength)
...
void SIGLIB_FUNC_DECL SUF_Fix32ToSigLibData (SLInt32_t * SIGLIB_PTR_DECL pSrc,
    SLData_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t ArrayLength)
...
void SIGLIB_FUNC_DECL SUF_SigLibDataToFix32 (SLData_t * SIGLIB_PTR_DECL pSrc,
    SLInt32_t * SIGLIB_PTR_DECL pDst,
    const SLArrayIndex_t ArrayLength)

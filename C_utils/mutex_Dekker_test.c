...
// Cygwin : gcc mutex_Dekker_test.c -lpthread -o mutex_Dekker_test.exe
...
// If this scenario is a possibility then use mutex_dekker_interfaceN_trying() to ensure there is no pending request

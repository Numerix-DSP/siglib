...
// These functions do not support resource request while a current request is pending
...
void mutex_peterson_init (
  h_Mutex * mutex)                                                  // Initialize the mutex
{
  ...
  mutex->Turn = 0;
                                                        ...
                                                        // Interface 1
void mutex_peterson_p1_request (
  h_Mutex * mutex)                                                  // Request access to mutex
{
...
void mutex_peterson_p1_release (
  h_Mutex * mutex)                                                  // Release access to mutex
{
  mutex->Trying1 = MXFalse;                                         // Release the mutex
}

int mutex_peterson_p1_trying (
  h_Mutex * mutex)                                                  // Return pending status
{
  return (mutex->Trying1);
}

                                                        // Interface 2
void mutex_peterson_p2_request (
  h_Mutex * mutex)                                                  // Request access to mutex
{
...
void mutex_peterson_p2_release (
  h_Mutex * mutex)                                                  // Release access to mutex
{
  mutex->Trying2 = MXFalse;                                         // Release the mutex
}

int mutex_peterson_p2_trying (
  h_Mutex * mutex)                                                  // Return pending status
{

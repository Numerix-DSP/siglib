...
// Cygwin : gcc circular_buffer_integer_test.c -lpthread -o circular_buffer_integer_test.exe
...
int main(void)
{
  ...
  cb_integer_init (&myCircularBuffer, circularBuffer, CIRCULAR_BUFFER_SIZE);  // Initialize the circular buffer

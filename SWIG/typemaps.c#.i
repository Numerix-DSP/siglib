...
you would use a real value instead.
        ...
        SLData_t           *INPUT, SLData_t           &INPUT
        SLFixData_t        *INPUT, SLFixData_t        &INPUT
        SLArrayIndex_t     *INPUT, SLArrayIndex_t     &INPUT
...
used when passing the parameter to a function that takes an output parameter.
        ...
        SLData_t           *OUTPUT, SLData_t           &OUTPUT
        SLFixData_t        *OUTPUT, SLFixData_t        &OUTPUT
        SLArrayIndex_t     *OUTPUT, SLArrayIndex_t     &OUTPUT
...
In C#, the 'ref' keyword is used for reference parameters.
        ...
        SLData_t           *INOUT, SLData_t           &INOUT
        SLFixData_t        *INOUT, SLFixData_t        &INOUT
        SLArrayIndex_t     *INOUT, SLArrayIndex_t     &INOUT

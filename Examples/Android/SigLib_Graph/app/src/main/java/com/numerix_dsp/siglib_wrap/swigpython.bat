...
cl -Od -MD -DNDEBUG -DWIN32 -IC:\Anaconda\envs\py33\include -D_CONSOLE -DSIGLIB_STATIC_LIB=1 -DNO_STRICT siglib_wrap_wrap.c /link user32.lib %SIGLIB_PATH%\lib\Microsoft\static_library\Release\siglib.lib C:\Anaconda\envs\py33\libs\python33.lib /DLL /out:siglib_wrap.dll /NODEFAULTLIB:LIBCMT

...
CSLTestWindow::CSLTestWindow()
{
    ...
    if (Signal.GetSize() == 0) {
        ...
        HDResultLocalMem = ::LocalAlloc (LMEM_MOVEABLE | LMEM_ZEROINIT,
            ((UINT)(FFT_LENGTH * sizeof (SLData_t))));
        HDCoeffLocalMem = ::LocalAlloc (LMEM_MOVEABLE | LMEM_ZEROINIT,
        ...
        HDFreqILocalMem = ::LocalReAlloc (FreqI.GetHandle(),
            ((UINT)(FFT_LENGTH * sizeof (SLData_t))), LMEM_MOVEABLE);
        HDCoeffLocalMem = ::LocalReAlloc (Coeff.GetHandle(),
...
afx_msg void CSLTestWindow::OnGenerateSine()
{
    ...
    SDA_SignalGenerate (BufferPtr, SIGLIB_SINE_WAVE, (SLData_t)0.9,
        SIGLIB_FILL, (SLData_t)0.01562, SIGLIB_ZERO, SIGLIB_ZERO, SIGLIB_ZERO,
...
afx_msg void CSLTestWindow::OnGenerateSquare()
{
    ...
    SDA_SignalGenerate (BufferPtr, SIGLIB_SQUARE_WAVE, (SLData_t)0.9,
        SIGLIB_FILL, (SLData_t)0.01562, SIGLIB_ZERO, SIGLIB_HALF, SIGLIB_ZERO,
        &SignalPhase, SIGLIB_NULL_DATA_PTR, Signal.GetSize());
    ::LocalUnlock (HBuffer);            // Unlock the sample array

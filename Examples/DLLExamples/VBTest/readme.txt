...
This directory includes SigLibGlobal.bas, which contains the SigLib
function declarations.

If you wish to use this example please ensure that you have read the section
of the SigLib User's Guide entitled "Using The SigLib DLL With Microsoft
Visual Basic"

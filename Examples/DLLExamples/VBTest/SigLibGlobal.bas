...
Global Const SIGLIB_MEM_ALLOC_ERROR As Long = 2              ' Indicates memory allocation error occurred
Global Const SIGLIB_PARAMETER_ERROR As Long = 4              ' Indicates function parameter error occurred
Global Const SIGLIB_NO_DTMF_SIGNAL As Long = 16              ' No DTMF signal detected
Global Const SIGLIB_NO_DTMF_KEY As Long = 17                 ' No DTMF key detected
Global Const SIGLIB_DTMF_CODE_ERROR As Long = 17             ' DTMF code error - PROVIDED FOR COMPATIBILITY, WILL NOT BE USED IN FUTURE*/
Global Const SIGLIB_NO_SIGNAL_PRESENT As Long = 18           ' No signal present
Global Const SIGLIB_DTMF_CONTINUATION As Long = 19           ' Key code is a continuation of existing code
...
Global Const SIGLIB_ENABLE As Long = 1                       ' Function is enabled
Global Const SIGLIB_DISABLE As Long = 0                      ' Function is disabled
Global Const SIGLIB_TRUE As Long = 1                         ' True
Global Const SIGLIB_FALSE As Long = 0                        ' False

                ' SigLib operational constants
Global Const SIGLIB_CLIP_ABOVE As Long = 1                   ' Buffer data clip direction
Global Const SIGLIB_CLIP_BOTH As Long = 0
Global Const SIGLIB_CLIP_BELOW As Long = -1

Global Const SIGLIB_FIRST_SAMPLE As Long = 0                 ' State control, used for Gaussian noise
Global Const SIGLIB_NOT_FIRST_SAMPLE As Long = 1             ' and one-pole filters

Global Const SIGLIB_GOERTZEL_DELAY_LENGTH As Long = 2        ' State array length for G. filter

Global Const SIGLIB_RESONATOR_DELAY_SIZE As Long = 3         ' Size of resonator state vector
Global Const SIGLIB_RESONATOR_DELAY_length As Long = 3       ' Size of resonator state vector
Global Const SIGLIB_IIR_DELAY_SIZE As Long = 2               ' Size of IIR filter state vector
Global Const SIGLIB_IIR_COEFFS_PER_BIQUAD As Long = 5        ' Number of IIR coefficients per biquad

Global Const SIGLIB_DTMF_STATE_LENGTH As Long = 2            ' State array length for G. filter

                        '/* Viterbi decoder constants

Global Const SIGLIB_VITK3_CONSTRAINT_LENGTH As Long = 3      ' Constraint length
Global Const SIGLIB_VITK3_NUMBER_OF_STATES As Long = 4       ' Number of states in coder
Global Const SIGLIB_VITK3_NUMBER_OF_INPUT_CODES As Long = 2  ' Number of input codes = 2^1 (1 input bit per input symbol)
Global Const SIGLIB_VITK3_TRANSITIONS_PER_STATE As Long = 2  ' Number of transitions from or to each state
Global Const SIGLIB_VITK3_DATA_RATE_RATIO As Long = 2        ' Rate 1/2 coder - 2 output bits for every input bit
Global Const SIGLIB_VITK3_SAMPLES_PER_BYTE As Long = 16      ' Number of output samples per byte

Global Const SIGLIB_VITV32_NUMBER_OF_STATES As Long = 8                 ' Number of states in coder
Global Const SIGLIB_VITV32_NUMBER_OF_INPUT_CODES As Long = 16           ' Number of input codes = 2^4 (4 input bits per input symbol)
Global Const SIGLIB_VITV32_NUMBER_OF_CONSTELLATION_POINTS As Long = 32  ' Number of points in constellation
Global Const SIGLIB_VITV32_TRANSITIONS_PER_STATE As Long = 4            ' Number of transitions from or to each state
Global Const SIGLIB_VITV32_NUMBER_OF_TRANSITIONS As Long = 32           ' Number of transitions between states
Global Const SIGLIB_VITV32_NUMBER_OF_PATH_STATES As Long = 8            ' Total number of path states (outputs)
...
' Window types
Global Const SIGLIB_HANNING As Long = 0
Global Const SIGLIB_HAMMING As Long = 1
Global Const SIGLIB_GENERALIZED_COSINE As Long = 2
Global Const SIGLIB_BLACKMAN As Long = 3
Global Const SIGLIB_BARTLETT_TRIANGLE_ZERO_END_POINTS As Long = 4
Global Const SIGLIB_BARTLETT_TRIANGLE_NON_ZERO_END_POINTS  As Long = 5
Global Const SIGLIB_KAISER As Long = 6
...
Global Const SIGLIB_SINE_WAVE As Long = 0
Global Const SIGLIB_COSINE_WAVE As Long = 1
Global Const SIGLIB_WHITE_NOISE As Long = 2
Global Const SIGLIB_GAUSSIAN_NOISE As Long = 3
Global Const SIGLIB_CHIRP_LIN As Long = 4
Global Const SIGLIB_CHIRP_NL As Long = 5
Global Const SIGLIB_SQUARE_WAVE As Long = 6
Global Const SIGLIB_TRIANGLE_WAVE As Long = 7
Global Const SIGLIB_IMPULSE As Long = 8
Global Const SIGLIB_IMPULSE_STREAM As Long = 9
Global Const SIGLIB_STEP As Long = 10
Global Const PN_SEQUENCE As Long = 11
Global Const SIGLIB_DC_LEVEL As Long = 12

' Signal array fill modes
Global Const SIGLIB_FILL As Long = 0
Global Const SIGLIB_ADD As Long = 1

' Signal data types
Global Const SIGLIB_SIGNED_DATA As Long = 0
Global Const SIGLIB_UNSIGNED_DATA As Long = 1

' Echo types - feedbackward / feedforward
Global Const SIGLIB_ECHO As Long = 0
Global Const SIGLIB_REVERB As Long = 1

' Rounding of data mode
Global Const SIGLIB_ROUND_UP As Long = 0
Global Const SIGLIB_ROUND_TO_NEAREST As Long = 1
Global Const SIGLIB_ROUND_DOWN As Long = 2
Global Const SIGLIB_ROUND_TO_ZERO As Long = 3
Global Const SIGLIB_ROUND_AWAY_FROM_ZERO As Long = 4

' Data modulo arithmetic mode
Global Const SIGLIB_SINGLE_SIDED_MODULO As Long = 0
Global Const SIGLIB_DOUBLE_SIDED_MODULO As Long = 1

' Data clipping modes
Global Const SIGLIB_CLIP_ABOVE As Long = 0
Global Const SIGLIB_CLIP_BOTH As Long = 1
Global Const SIGLIB_CLIP_BELOW As Long = 2

' Data threshold and clamping types
Global Const SIGLIB_SINGLE_SIDED_THOLD As Long = 0
Global Const SIGLIB_DOUBLE_SIDED_THOLD As Long = 1

' Zero crossing types
Global Const SIGLIB_POSITIVE_LEVEL_CROSS As Long = 0
Global Const SIGLIB_NEGATIVE_LEVEL_CROSS As Long = 1
Global Const SIGLIB_ALL_LEVEL_CROSS As Long = 2

' Arbitrary FFT type
Global Const SIGLIB_ARB_FFT_DO_CZT As Long = 0          ' Array is NOT integer power of 2 length, use chirp z-transform
Global Const SIGLIB_ARB_FFT_DO_FFT As Long = 1          ' Array is integer power of 2 length, use FFT

' Asynchronous data parity types
Global Const SIGLIB_NO_PARITY As Long = 0
Global Const SIGLIB_EVEN_PARITY As Long = 1
Global Const SIGLIB_ODD_PARITY As Long = 2

' Early-late gate trigger timing
Global Const SIGLIB_ELG_TRIGGER_START As Long = 0       ' Locate the trigger at the start of the symbol
Global Const SIGLIB_ELG_TRIGGER_MIDDLE As Long = 1      ' Locate the trigger in the middle of the symbol

' Costas loop feedback mode
Global Const COSTAS_LOOP_MULTIPLY_LOOP As Long = 0
Global Const COSTAS_LOOP_POLARITY_LOOP As Long = 1
Global Const COSTAS_LOOP_HARD_LIMITED_LOOP As Long = 2
...
Declare Sub SDA_IndexBitReverseReorder Lib "SIGLIB.DLL" (ByRef iPtr As Long, _
        ByRef iPtr As Long, _
        ByVal iData As Long)

Declare Sub SIF_FastBitReverseReorder Lib "SIGLIB.DLL" (ByRef iPtr As Long, _
        ByVal iData As Long)
...
Declare Function SUF_FftArbAllocLength Lib "SIGLIB.DLL" (ByVal iData As Long) As Long
...
Declare Function SIF_WelchPowerSpectrum Lib "SIGLIB.DLL" (ByRef iPtr As Long, _
        ByVal iData As Long, _
        ByRef iPtr As Long, _
        ByVal fData As Double, _
        ByRef fpBuffer As Double, _
...
Declare Function SUF_FirKaiserApproximation Lib "SIGLIB.DLL" (ByVal fpData As Double, _
        ...
        ByVal fpData As Double, _
        ByVal fpData As Double, _
        ByVal fpData As Double) As Long
...
'SLComplexRect_s SIGLIB_FUNC_DECL SIF_GoertzelDetectComplex (SFLOAT,
'       const SFIX);
...
Declare Function SUF_IncreaseVariableDelay Lib "SIGLIB.DLL" (ByRef iPtr As Long, _
        ByRef iPtr As Long, _
        ByVal iData As Long) As Long

Declare Function SUF_DecreaseVariableDelay Lib "SIGLIB.DLL" (ByRef iPtr As Long, _
        ByRef iPtr As Long, _
        ByVal iData As Long) As Long
...
Declare Function SDA_SignalGenerate Lib "SIGLIB.DLL" (ByRef fpBuffer As Double, _
        ByVal iSigType As Long, _
        ByVal fPeakVal As Double, _
        ByVal iSigFillMode As Long, _
...
Declare Function SDS_ManchesterEncode Lib "SIGLIB.DLL" (ByVal iData As Long) As Long

Declare Function SDS_ManchesterDecode Lib "SIGLIB.DLL" (ByVal iData As Long) As Long
...
Declare Sub SIF_180DegreePhaseDetect Lib "SIGLIB.DLL" (ByRef fpBuffer As Double, _
        ...
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByRef ipBuffer As Long)

Declare Function SDA_180DegreePhaseDetect Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
...
Declare Sub SIF_TriggerReverberator Lib "SIGLIB.DLL" (ByRef ipBuffer As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Long)
...
Declare Function SDS_ConvEncoderK3 Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Long) As Long

Declare Sub SIF_ViterbiDecoderK3 Lib "SIGLIB.DLL" (ByRef fpBuffer As Long, _
        ByRef ipBuffer As Long, _
        ByRef fpBuffer As Double, _
        ByRef ipBuffer As Long, _
        ByRef ipBuffer As Long, _
...
Declare Function SDS_CostasQamDemodulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal fData As Double, _
...
Declare Function SDS_CostasQamDemodulateDebug Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal fData As Double, _
...
Declare Function SDA_CostasQamDemodulateDebug Lib "SIGLIB.DLL" (ByRef fpBuffer As Double, _
        ...
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double) As Long
...
Declare Sub SDA_QpskModulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
        ByRef fpBuffer As Double, _
...
Declare Function SDA_QpskDemodulateDebug Lib "SIGLIB.DLL" (ByRef fpBuffer As Double, _
        ...
        ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        aCRect As SLComplexRect_s) As Long

Declare Function SDA_QpskDifferentialEncode Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDA_QpskDifferentialDecode Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long
...
Declare Sub SDA_FskModulateByte Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
...
Declare Sub SDA_CpfskModulateByte Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal fData As Double, _
...
Declare Sub SDA_FskModulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
...
Declare Sub SDA_CpfskModulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal fData As Double, _
...
Declare Sub SDA_Qam16Modulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
        ByRef fpBuffer As Double, _
...
Declare Function SDA_Qam16DifferentialEncode Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDA_Qam16DifferentialDecode Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long
...
Declare Sub SDA_BpskModulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
...
Declare Sub SIF_BpskDemodulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
        ByVal fData As Double, _
        ByRef fpBuffer As Double, _
...
Declare Sub SDA_DpskModulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
...
Declare Sub SIF_DpskDemodulate Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long, _
        ByVal fData As Double, _
        ByRef fpBuffer As Double, _
...
Declare Function SUF_AsyncCharacterLength Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long

Declare Function SDA_SyncToAsyncConverter Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
...
Declare Function SDA_AsyncToSyncConverter Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
...
Declare Sub SIF_AsyncAddRemoveStopBits Lib "SIGLIB.DLL" (ByRef ipBuffer As Long)

Declare Function SDA_AsyncRemoveStopBits Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
...
Declare Function SDA_AsyncAddStopBits Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
...
Declare Function SDA_DecreaseWordLength Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long

Declare Function SDA_IncreaseWordLength Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef ipBuffer As Long, _
        ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long
...
Declare Function SDS_Descrambler1417 Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDS_Scrambler1417WithInversion Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long, _
        ByRef iPtr As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDS_Descrambler1417WithInversion Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long, _
        ByRef iPtr As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDS_Scrambler1823 Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDS_Descrambler1823 Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long

Declare Function SDS_Scrambler523 Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByRef iPtr As Long) As Long
...
Declare Sub SIF_Decimate Lib "SIGLIB.DLL" (ByRef iPtr As Long)
...
Declare Sub SIF_Interpolate Lib "SIGLIB.DLL" (ByRef iPtr As Long)
...
Declare Function SUF_AsciiToKeyCode Lib "SIGLIB.DLL" (ByVal iData As Long) As Long
...
Declare Sub SIF_CopyWithOverlap Lib "SIGLIB.DLL" (ByRef iPtr As Long)
...
Declare Function SDA_CountOnesBits Lib "SIGLIB.DLL" (ByVal iData As Long) As Long

Declare Function SDS_CountZeroBits Lib "SIGLIB.DLL" (ByVal iData As Long) As Long

Declare Function SDS_CountLeadingOneBits Lib "SIGLIB.DLL" (ByVal iData As Long) As Long

Declare Function SDS_CountLeadingZeroBits Lib "SIGLIB.DLL" (ByVal iData As Long) As Long
...
Declare Function SUF_ModuloIncrement Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long

Declare Function SUF_ModuloDecrement Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long

Declare Function SUF_IndexModuloIncrement Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long

Declare Function SUF_IndexModuloDecrement Lib "SIGLIB.DLL" (ByVal iData As Long, _
        ByVal iData As Long, _
        ByVal iData As Long) As Long
...
Declare Sub SDA_FixToSigLibData Lib "SIGLIB.DLL" (ByRef ipBuffer As Long, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long)
...
Declare Sub SDA_Fix32ToSigLibData Lib "SIGLIB.DLL" (ByRef ipBuffer As Long, _
        ByRef fpBuffer As Double, _
        ByVal iData As Long)

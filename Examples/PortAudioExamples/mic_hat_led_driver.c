...
uint8_t pixelBuffer[] = {
    0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x00, 0x00, 0xEF, 0x00, 0x0F, 0x00, 0xEF, 0x00, 0x00, 0x0F, 0xFF, 0xFF, 0xFF, 0xFF,
};
...
int led_driver(int ledNum, int R, int G, int B, int brightness)
{
  int ret = 0;
  int fd;

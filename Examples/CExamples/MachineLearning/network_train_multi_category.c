...
//    SUF_BinWriteFile ((SLData_t *)layer2Weights, "rand_data2.bin", SIGLIB_LITTLE_ENDIAN, NUM_CATEGORIES*NETWORK_HIDDEN_LAYER_NODES);
//    SUF_BinReadFile  ((SLData_t *)layer2Weights, "rand_data2.bin", SIGLIB_LITTLE_ENDIAN, NUM_CATEGORIES*NETWORK_HIDDEN_LAYER_NODES);
...
// Train the network
    SDA_TwoLayerNCategoryNetworkFit (pShuffledTrainingData,         // Pointer to training data
...
// Write weights to file : Binary plus C header : float and 8 bit words
  ...
  int             numItems = SUF_WriteWeightsIntegerCFile (filenameWeights, // Filename
                                                           ...
                                                           NUM_CATEGORIES * NETWORK_HIDDEN_LAYER_NODES, // layer2Weights array length

  ...
  void)
{
  ...
  printf ("The answer is that the output of the DFT and FFT are scaled by a factor of N, where N\n");
...
// Perform real FFT
  ...
  printf ("Note that this is not scaled by 1/N as may be performed in some mathematics packages.\n");

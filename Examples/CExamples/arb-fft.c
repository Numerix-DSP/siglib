...
int main(int argc, char* argv[])
{
  ...
  if ((NULL == pInput) || (NULL == pWindowCoeffs) || (NULL == pRealData) || (NULL == pImagData) || (NULL == pRealDatac) || (NULL == pImagDatac) ||
      (NULL == AWNrPtr) || (NULL == AWNiPtr) || (NULL == vLrPtr) || (NULL == vLiPtr) || (NULL == CZTRealWorkPtr) || (NULL == CZTImagWorkPtr) ||
  ...
  SIF_FftArb(AWNrPtr,                           // Pointer to AWNr coefficients
             ...
             &InverseSampleLengthXFFTLength,    // Pointer to the inverse (Sample
                                                // length * FFT length)

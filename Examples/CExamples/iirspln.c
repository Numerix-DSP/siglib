...
int main (void)
{
    ...
    SDA_TranslateSPlaneCutOffFrequency (SPlaneNormalizedPoles, SPlanePoles, SDS_PreWarp (PREWARP_MATCH_FREQUENCY, SAMPLE_RATE) * SAMPLE_RATE, IIR_FILTER_STAGES);
    ...
    SDA_IirZplaneToCoeffs (ZPlaneZeros,             // Z-plane zeros
                           ...
                           IIR_FILTER_STAGES);      // Number of poles
                                                    ...
                                                    // Low pass to high pass transformation
    Scale =
        SDA_IirLpHpShift (NormalizedCoeffs,         // Source coefficients

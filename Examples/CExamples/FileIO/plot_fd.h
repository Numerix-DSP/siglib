...
SLError_t       plot_frequency_domain (
  SLData_t * pSrc,
...
SLError_t       plot_complex_frequency_domain (
  SLData_t * pSrcReal,
  SLData_t * pSrcImag,
  const enum SLWindow_t WindowType,
  char *pLabelString,
...
SLError_t       plot_frequency_magnitude (
  SLData_t *,
  SLData_t *,
  char *,
  SLArrayIndex_t);

SLError_t       plot_time_domain (
  SLData_t * pSrcReal,
  char *pLabelString,
  SLArrayIndex_t SequenceLength);

SLError_t       plot_complex_time_domain (
  SLData_t * pSrcReal,
  SLData_t * pSrcImag,
  char *pLabelString,
  SLArrayIndex_t SequenceLength);

...
int main(int argc, char* argv[])
{
  ...
  if ((inputSampleCount = SUF_WavReadData(pDataArray, fpInputFile, wavInfo, wavInfo.NumberOfSamples * wavInfo.NumberOfChannels)) ==
      wavInfo.NumberOfSamples * wavInfo.NumberOfChannels) {

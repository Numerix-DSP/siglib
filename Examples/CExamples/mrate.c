...
int main(void)
{
  ...
  // Uncomment this little lot, if you want to print the filter lengths and
  // coefficients printf ("Filter length 0 = %d\n", PolyPhaseFilterLengths[0]);
  // SUF_PrintArray (pPolyPhaseFilterCoeffPointers[0],
  // PolyPhaseFilterLengths[0]); printf ("\nFilter length 1 = %d\n",
  // PolyPhaseFilterLengths[1]); SUF_PrintArray
  // (pPolyPhaseFilterCoeffPointers[1], PolyPhaseFilterLengths[1]); printf
  // ("\nFilter length 2 = %d\n", PolyPhaseFilterLengths[2]); SUF_PrintArray
  // (pPolyPhaseFilterCoeffPointers[2], PolyPhaseFilterLengths[2]); printf
  // ("\n");

...

{
    ...
    int numItems =
        SUF_ReadWeightsWithBiasesBinaryFile (filenameWeights,           // Filename
    ...
    for (SLArrayIndex_t validationSequenceNumber = 0; validationSequenceNumber < nRows; validationSequenceNumber++) {
        ...
        SLNeuralNetworkPrediction_s prediction =
            SDA_TwoLayer2CategoryWithBiasesNetworkPredict (pValidationData+(validationSequenceNumber*NETWORK_INPUT_SAMPLE_LENGTH),  // Pointer to data to validate

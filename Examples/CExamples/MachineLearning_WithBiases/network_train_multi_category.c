...
static SLData_t         shuffleRowTmp[NETWORK_INPUT_SAMPLE_LENGTH+1];   // Remember line length = NETWORK_INPUT_SAMPLE_LENGTH+1, for the 'category' column
...
//    SUF_BinWriteFile ((SLData_t *)layer2Weights, "rand_data2.bin", 'l', NUM_CATEGORIES*NETWORK_HIDDEN_LAYER_NODES);
//    SUF_BinReadFile  ((SLData_t *)layer2Weights, "rand_data2.bin", 'l', NUM_CATEGORIES*NETWORK_HIDDEN_LAYER_NODES);
...
//        SDA_Copy ((SLData_t *)pTrainingData, (SLData_t *)pShuffledTrainingData, nRows*nCols);
...
#endif
    int numItems =
        SUF_WriteWeightsWithBiasesIntegerCFile (filenameWeights,                                        // Filename
    ...
    if (numItems != (NETWORK_HIDDEN_LAYER_NODES*NETWORK_INPUT_SAMPLE_LENGTH)+(NETWORK_HIDDEN_LAYER_NODES) +
        ...
        printf ("**** ERROR - INCORRECT NUMBER OF WEIGHTS WRITTEN TO INTEGER C HEADER FILE: %s\n\n", filenameWeights);
        exit(-1);
    }
    ...
    numItems =
        SUF_WriteWeightsWithBiasesFloatCFile (filenameWeights,                                          // Filename
                                              (SLData_t *)layer1Weights,                                // layer1Weights
                                              layer1Biases,                                             // Pointer to layer #1 biases
                                              (SLData_t *)layer2Weights,                                // layer2Weights
                                              layer2Biases,                                             // Pointer to layer #2 biases
    ...
    if (numItems != (NETWORK_HIDDEN_LAYER_NODES*NETWORK_INPUT_SAMPLE_LENGTH)+(NETWORK_HIDDEN_LAYER_NODES) +
                    (NUM_OUTPUT_NODES*NETWORK_HIDDEN_LAYER_NODES) + (NUM_OUTPUT_NODES)) {
        printf ("**** ERROR - INCORRECT NUMBER OF WEIGHTS WRITTEN TO FLOATING POINT C HEADER FILE: %s\n\n", filenameWeights);
        exit(-1);
    }
...
#endif
    numItems =
        SUF_WriteWeightsWithBiasesBinaryFile (filenameWeights,                                          // Filename
                                              (SLData_t *)layer1Weights,                                // layer1Weights
                                              layer1Biases,                                             // Pointer to layer #1 biases
                                              (SLData_t *)layer2Weights,                                // layer2Weights
                                              layer2Biases,                                             // Pointer to layer #2 biases
    ...
    if (numItems != (NETWORK_HIDDEN_LAYER_NODES*NETWORK_INPUT_SAMPLE_LENGTH)+(NETWORK_HIDDEN_LAYER_NODES) +
                    (NUM_OUTPUT_NODES*NETWORK_HIDDEN_LAYER_NODES) + (NUM_OUTPUT_NODES)) {
        printf ("**** ERROR - INCORRECT NUMBER OF WEIGHTS WRITTEN TO BINARY FILE: %s\n\n", filenameWeights);
        exit(-1);
    }

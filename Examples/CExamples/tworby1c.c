...
int main(void)
{
  ...
  if ((NULL == pRealData1) || (NULL == pImagData1) || (NULL == pRealData2) || (NULL == pImagData2) || (NULL == pRealDataCopy1) ||
      (NULL == pImagDataCopy1) || (NULL == pRealDataCopy2) || (NULL == pImagDataCopy2) || (NULL == pRealDataCopy3) || (NULL == pImagDataCopy3) ||
      (NULL == pRealDataCopy4) || (NULL == pImagDataCopy4) || (NULL == pOutput2r1cResult1) || (NULL == pOutput2r1cResult2) ||
      (NULL == pFFTCoeffs)) {

...
int main(void)
{
  ...
  if ((pRealData == NULL) || (pImagData == NULL) || (pFFTCoeffs == NULL) || (pWindowCoeffs == NULL) || (pOnePoleState == NULL) ||
      (pLayer1PostActivation == NULL) || (pLayer1PostActivation == NULL) || (pCombFilterStateArray == NULL)) {

  ...
  void)
{
  ...
  printf ("The programmer must verify that the source and destination data is valid.\n\n");
  printf ("For example in the Q format functions the value of m+n must be less than the the fixed point word length.\n\n");
  printf ("SigLib includes the #defines SIGLIB_DATA_WORD_LENGTH and SIGLIB_FIX_WORD_LENGTH\n");

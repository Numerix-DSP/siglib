  ...
  void)
{
  ...
  SIF_Fft4 (pFFTCoeffs,                                             // Pointer to FFT coefficients
            pFFTBitReverseTable,                                    // Digit reverse mode flag / Pointer to digit reverse address table
  ...
  SDA_Cfft4 (pRealData,                                             // Pointer to real array
             pImagData,                                             // Pointer to imaginary array
             pFFTCoeffs,                                            // Pointer to FFT coefficients
             SIGLIB_BIT_REV_STANDARD,                               // Digit reverse mode flag / Pointer to digit reverse address table
             FFT_LENGTH,                                            // FFT length
             LOG4_FFT_LENGTH);                                      // log4 FFT length

...
// #define GAUSSIAN_NOISE_VARIANCE 0.5                                 //
// Gaussian noise variance
#define GAUSSIAN_NOISE_VARIANCE 2.    // Gaussian noise variance

// Declare global variables and arrays

void init_KalmanFilter1D(SLKalmanFilter1D_s* kf)
{
...
int main(int argc, char** argv)
{
  ...
  if ((NULL == pPositionTrue) || (NULL == pPositionNoisy) || (NULL == pPositionKalmanEstimate) || (NULL == pPositionCombFilterEstimate) ||

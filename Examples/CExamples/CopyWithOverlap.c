...
int main (void)
{
    ...
    printf ("Hit <Carriage Return> to copy elements of short sections of a larger array, with stride length %d ...", INDEX_STRIDE_LENGTH);
    getchar();
    ...
    do {
        ...
        copyIndexLength =
            SDA_CopyWithIndex (SrcArrayE,                  // Pointer to source array
                               DstArray,                   // Pointer to destination array
                               &overlapSrcArrayIndex,      // Pointer to source array index

// SigLib microphone array far field beamformer beam pattern calculator
// (Microphone Polar Diversity Response) This example simulates a 16 kHz sample
// rate and includes several different microphone configurations that can be
// independently enabled by changing "#if 0" to "#if  1" where appropriate The
...
#  define MIC_ARRAY_DESCRIPTION \
    "4 Mic Circular (Square), 0.043 mic radius"    // Microphone array description -
                                                   // used in plot title
...
#  define MIC_ARRAY_DESCRIPTION \
    "4 Mic Circular (Square) + centre, 0.043 mic radius"    // Microphone array
                                                            // description - used in
                                                            // plot title
static SLMicrophone_s micDetails[NUM_MICROPHONES] = {
  { 0., 0., 0., 1., },
...
#  define NUM_MICROPHONES 4    // Number of microphones
#  define MIC_ARRAY_DESCRIPTION \
    "4 Mic Circular (Diamond), 0.043 mic radius"    // Microphone array description -
                                                    // used in plot title
static SLMicrophone_s micDetails[NUM_MICROPHONES] = {
  { 0.043, 0.000, 0., 1., },
  { 0.000, 0.043, 0., 1., },
...
#  define NUM_MICROPHONES 5    // Number of microphones
#  define MIC_ARRAY_DESCRIPTION \
    "4 Mic Circular (Diamond) + centre, 0.043 mic radius"    // Microphone array
                                                             // description - used in
                                                             // plot title
static SLMicrophone_s micDetails[NUM_MICROPHONES] = {
  { 0., 0., 0., 1., },
...
#  define NUM_MICROPHONES 4    // Number of microphones
#  define MIC_ARRAY_DESCRIPTION \
    "4 Mic Linear, 0.10 separation"    // Microphone array description - used in plot
                                       // title
static SLMicrophone_s micDetails[NUM_MICROPHONES] = {
  { -0.15, 0., 0., 1., },
  { -0.05, 0., 0., 1., },
...
#  define NUM_MICROPHONES 4    // Number of microphones
#  define MIC_ARRAY_DESCRIPTION \
    "4 Mic Linear, 0.033 separation"    // Microphone array description - used in
                                        // plot title
static SLMicrophone_s micDetails[NUM_MICROPHONES] = {{
                                                         -0.0495,
                                                         0.,
...
int main(void)
{
  ...
  printf("This example plots the polar frequency response of a delay-sum "
         "beamformer\n");
  printf("Enter '+' or '-' to increase / decrease the beam angle or\n");
  printf("Enter the desired beam angle (-1 <= angle < 360),\n");
  printf("A value of -1 represents no beamforming, i.e. just summing the "
         "microphone inputs\n");

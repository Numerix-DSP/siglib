// SigLib - Signal Generator Example - Array basis
...
#define NUM_RANDS 10
  ...
  SLData_t randomNumbers[NUM_RANDS];

  printf("%d Random Numbers Between -1. and -5.:\n", NUM_RANDS);
  SDA_RandomNumber(randomNumbers, SIGLIB_MINUS_ONE, SIGLIB_MINUS_FIVE, NUM_RANDS);

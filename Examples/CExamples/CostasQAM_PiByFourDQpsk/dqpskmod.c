// SigLib example for pi/4 Differential Quadrature Phase Shift Keying (DQPSK)
// modulation
//     Data rate - 2400 bps
//     Baud rate - 1200 Baud
...
// #define SAMPLE_LENGTH                   512                 // Number of
// samples in array
...
#define SYMBOL_LENGTH \
  40    //((SLArrayIndex_t)(SAMPLE_RATE_HZ / SYMBOL_RATE))           // Number of
        // samples per symbol
#define SYMBOLS_PER_LOOP \
  12    //((SLArrayIndex_t)(SAMPLE_LENGTH / SYMBOL_LENGTH))       // Number of
        // symbols per loop for graph

#define CARRIER_SINE_TABLE_SIZE \
  480    //((SLArrayIndex_t)(SAMPLE_RATE_HZ / CARRIER_TABLE_FREQ))    // Number of
         // samples in each of cos and sine table
#define CARRIER_TABLE_INCREMENT \
  18    //((SLArrayIndex_t)(CARRIER_FREQ / CARRIER_TABLE_FREQ))   // Carrier
        // frequency
...
int main(void)
{
  ...
  SIF_PiByFourDQpskModulate(pCarrierTable,                          // Carrier table pointer
                            ...
                            &TxPreviousOutputSymbol);               // Pointer to previous output symbol for
                                                                    // differential coding

...
int main (void)
{
    ...
    for (i = 0; i < 70; i++) {
        Tmp =
            SDS_Scrambler1417 (TxString[i],             // Source character
                               &TxShiftRegister);       // Shift register
        RxString[i] =
            (char)SDS_Descrambler1417 (Tmp,                 // Source character
    ...
    for (i = 0; i < 70; i++) {
        Tmp =
            SDS_Scrambler1417WithInversion (TxString[i],            // Source character
                                            &TxShiftRegister,       // Shift register
                                            &TxOnesBitCount,        // Ones bit counter
                                            &TxBitInversionFlag);   // Bit inversion flag
        RxString[i] =
            (char)SDS_Descrambler1417WithInversion (Tmp,                    // Source character
                                                    &RxShiftRegister,       // Shift register
    ...
    for (i = 0; i < 70; i++) {
        Tmp =
            SDS_Scrambler1823 (TxString[i],         // Source character
                               &TxShiftRegister);   // Shift register
        RxString[i] =
            (char)SDS_Descrambler1823 (Tmp,                 // Source character
                                       &RxShiftRegister);   // Shift register
    }
    RxString[70] = 0;                               // Terminate string for printf
    ...
    for (i = 0; i < 70; i++) {
        Tmp =
            SDS_Scrambler523 (TxString[i],          // Source character
                              &TxShiftRegister);    // Shift register
        RxString[i] =
            (char)SDS_Descrambler523 (Tmp,                  // Source character
                                      &RxShiftRegister);    // Shift register
    }
    RxString[70] = 0;                                   // Terminate string for printf

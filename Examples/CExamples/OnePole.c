...
int main(int argc, char** argv)
{
  ...
  if ((NULL == pSrc1) || (NULL == pSrc2) || (NULL == pRealData) || (NULL == pImagData) || (NULL == pResults) || (NULL == pFiltered) ||
      (NULL == pDelay) || (NULL == pFFTCoeffs)) {
  ...
  printf("512 Point FFT, quantized data - one pole filter per bin "
         "(onePoleFilterCoefficient = %lf)\n",

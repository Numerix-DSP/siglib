// SigLib Non-causal IIR Filter Example
...
static SLData_t     pNCFilterState1[FILTER_STAGES * SIGLIB_IIR_DELAY_SIZE];
static SLData_t     pNCFilterState2[FILTER_STAGES * SIGLIB_IIR_DELAY_SIZE];
...
int main(void)
{
    ...
    SIF_IirNc (pNCFilterState1,                     // Pointer to forward filter state array
               pNCFilterState2,                     // Pointer to reverse filter state array
               FILTER_STAGES);                      // Number of second order stages
    ...
    SDA_IirNc (source,                              // Input array to be filtered
               ...
               pNCFilterState1,                     // Pointer to forward filter state array
               pNCFilterState2,                     // Pointer to reverse filter state array
               pFilterTaps,                         // Pointer to filter coefficients array
               FILTER_STAGES,                       // Number of stages
               SAMPLE_LENGTH);                      // Dataset length

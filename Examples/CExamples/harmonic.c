...
int main(void)
{
  ...
  gpc_plot_2d(h2DPlot,                                                       // Graph handle
              pData,                                                         // Dataset
              SAMPLE_LENGTH,                                                 // Dataset length
              "Fundamental + 2nd + 3rd + 4th + 5th + 6th + 7th Harmonic",    // Dataset
                                                                             // title
              SIGLIB_ZERO,                                                   // Minimum X value
              (double)(SAMPLE_LENGTH - 1),                                   // Maximum X value
              "lines",                                                       // Graph type
  ...
  gpc_plot_2d(h2DPlot,                                                             // Graph handle
              pData,                                                               // Dataset
              SAMPLE_LENGTH,                                                       // Dataset length
              "Fundamental + 2nd + 3rd + 4th + 5th + 6th + 7th + 8th Harmonic",    // Dataset
                                                                                   // title
              SIGLIB_ZERO,                                                         // Minimum X value
              (double)(SAMPLE_LENGTH - 1),                                         // Maximum X value
              "lines",                                                             // Graph type
  ...
  gpc_plot_2d(h2DPlot,          // Graph handle
              ...
              SAMPLE_LENGTH,    // Dataset length
              "Fundamental + 2nd + 3rd + 4th + 5th + 6th + 7th + 8th + 9th + "
              "10th Harmonic",                // Dataset title
              SIGLIB_ZERO,                    // Minimum X value
              (double)(SAMPLE_LENGTH - 1),    // Maximum X value
              "lines",                        // Graph type
              "magenta",                      // Colour
              GPC_NEW);                       // New graph
  printf("\nFundamental + 2nd + 3rd + 4th + 5th + 6th + 7th + 8th + 9th + 10th "
         "Harmonic\nPlease hit <Carriage Return> to continue . . .");
  getchar();

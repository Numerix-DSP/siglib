...
int main (void)
{
    ...
    rPoint1 = SCV_Rectangular (1.0, 0.0);       rPoint2 = SCV_Rectangular (5.0, 0.0);
    ...
    rPoint1 = SCV_Rectangular (0.0, -3.0);      rPoint2 = SCV_Rectangular (0.0, 7.0);
    SDA_ComplexRectLinearInterpolate (rPoint1,              // Interpolation start point
                                      rPoint2,              // Interpolation end point
                                      rInterpolationPoints, // Destination array
    ...
    rPoint1 = SCV_Rectangular (5.0, 0.0);       rPoint2 = SCV_Rectangular (0.0, 5.0);
    SDA_ComplexRectLinearInterpolate (rPoint1,              // Interpolation start point
                                      rPoint2,              // Interpolation end point
                                      rInterpolationPoints, // Destination array

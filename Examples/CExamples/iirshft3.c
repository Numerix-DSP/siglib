...
int main (void)
{
    ...
    Scale =
        SDA_IirLpLpShift (FourPoleButterworth_Fc50_Fs1000,  // Source coefficients
    ...
    printf ("Source Biquad #1 = %lf, %lf, %lf, %lf, %lf\n", NewFilterCoeffs[0],
            NewFilterCoeffs[1], NewFilterCoeffs[2],
            NewFilterCoeffs[3], NewFilterCoeffs[4]);

    printf ("Source Biquad #2 = %lf, %lf, %lf, %lf, %lf\n", NewFilterCoeffs[5],
            NewFilterCoeffs[6], NewFilterCoeffs[7],
            NewFilterCoeffs[8], NewFilterCoeffs[9]);

...
static const SLData_t FourPoleButterworth_Fc50_Fs1000[] = {1.0, 2.0, 1.0, -1.47967421693119360900e+00, 5.55821543282489005600e-01,
                                                           1.0, 2.0, 1.0, -1.70096433194352592000e+00, 7.88499739815297973000e-01};
...
int main(void)
{
  ...
  printf("Source Biquad #1 = %lf, %lf, %lf, %lf, %lf\n", FourPoleButterworth_Fc50_Fs1000[0], FourPoleButterworth_Fc50_Fs1000[1],
         FourPoleButterworth_Fc50_Fs1000[2], FourPoleButterworth_Fc50_Fs1000[3], FourPoleButterworth_Fc50_Fs1000[4]);

  printf("Source Biquad #2 = %lf, %lf, %lf, %lf, %lf\n", FourPoleButterworth_Fc50_Fs1000[5], FourPoleButterworth_Fc50_Fs1000[6],
         FourPoleButterworth_Fc50_Fs1000[7], FourPoleButterworth_Fc50_Fs1000[8], FourPoleButterworth_Fc50_Fs1000[9]);
  ...
  printf("Source Biquad #1 = %lf, %lf, %lf, %lf, %lf\n", NewFilterCoeffs[0], NewFilterCoeffs[1], NewFilterCoeffs[2], NewFilterCoeffs[3],
         NewFilterCoeffs[4]);

  printf("Source Biquad #2 = %lf, %lf, %lf, %lf, %lf\n", NewFilterCoeffs[5], NewFilterCoeffs[6], NewFilterCoeffs[7], NewFilterCoeffs[8],
         NewFilterCoeffs[9]);

...
// Covariance Matrix
// Example test dataset taken from: https://jamesmccaffrey.wordpress.com/2017/11/03/example-of-calculating-a-covariance-matrix/
#if 1
...
#define COVARIANCE_MATRIX_SOURCE_DATASET_LENGTHS  100
  ...
  SLData_t        meanValues[COVARIANCE_NUMBER_OF_SOURCE_DATASETS]; // Temporary array used to calculate the means

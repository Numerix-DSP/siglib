...
static const SLData_t IIRCoefficientArray[] = {
    8.75614678138813662400e-01, -1.75122935627762732500e+00, 8.75614678138813662400e-01, -1.74266432392304926300e+00, 7.59790483942011651800e-01,

    8.91922790247670405000e-01, -1.78384558049534081000e+00, 8.91922790247670405000e-01, -1.77512218573945901300e+00, 7.92567327749221450800e-01,

    9.23711780781054980800e-01, -1.84742356156210996200e+00, 9.23711780781054980800e-01, -1.83839095445962286100e+00, 8.56457874882146308400e-01,

    9.68827962006692744400e-01, -1.93765592401338548900e+00, 9.68827962006692744400e-01, -1.92818340308764635300e+00, 9.47132765310686131100e-01};
...
int main(int argc, char* argv[])
{
  ...
  SLData_t* pFilterState = SUF_IirStateArrayAllocate(IIR_FILTER_STAGES);    // High pass filter state array
  ...
  if ((NULL == pDataArray) || (NULL == pFilterState) || (NULL == pOverlapArray) || (NULL == pWindowCoeffs) || (NULL == pFDPRealData) ||
      (NULL == pFDPImagData) || (NULL == pFDPResults) || (NULL == pFDPFFTCoeffs)) {

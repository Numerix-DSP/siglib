...
void SIGLIB_FUNC_DECL SUF_PrintAlignedArrays (const SLData_t *pSrc1,
...
int main (void)
{
    ...
    SDA_Fill (Dst1, 11111111., ALIGN_SRC_1_LENGTH+ALIGN_SRC_2_LENGTH-1);    // Fill with dummy data to ensure that all elements are written correctly
    SDA_Fill (Dst2, 11111111., ALIGN_SRC_1_LENGTH+ALIGN_SRC_2_LENGTH-1);

    outputLength =
        SDA_Align (AlignSrc1,                       // Pointer to input array #1

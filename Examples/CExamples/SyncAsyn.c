...
static const unsigned char SyncSequence[] = "Hello World - "
...
int main(void)
{
  ...
  // If the sequence "0x00, 0x01, 0x02 ..." is used then the next line can be
  // uncommented to test Parity error checking. This will convert the 3rd
  // character from 0x03 to 0x07 This works with 8 data bits, 1 stop bit and

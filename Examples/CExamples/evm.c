  ...
  void)
{
  ...
  printf ("Ideal point = 1+j0, Received point = %lf + j%lf\nError Vector = %lf\n",
          ReceivedConstellationPoints[0].real, ReceivedConstellationPoints[0].imag, ErrorVector);
  ...
  printf ("Ideal point = 1+j0, Received point = %lf + j%lf\nError Vector = %lf\n",
          ReceivedConstellationPoints[1].real, ReceivedConstellationPoints[1].imag, ErrorVector);
  printf ("EVM (Percent) = %lf, EVM (dB) = %lf\n\n", ErrorVectorMagnitudePercent, ErrorVectorMagnitudeDecibels);
  ...
  printf ("Ideal point = 1+j0, Received point = %lf + j%lf\nError Vector = %lf\n",
          ReceivedConstellationPoints[2].real, ReceivedConstellationPoints[2].imag, ErrorVector);
  printf ("EVM (Percent) = %lf, EVM (dB) = %lf\n\n", ErrorVectorMagnitudePercent, ErrorVectorMagnitudeDecibels);
  ...
  printf ("Ideal point = 1+j0, Received point = %lf + j%lf\nError Vector = %lf\n",
          ReceivedConstellationPoints[3].real, ReceivedConstellationPoints[3].imag, ErrorVector);
  printf ("EVM (Percent) = %lf, EVM (dB) = %lf\n\n", ErrorVectorMagnitudePercent, ErrorVectorMagnitudeDecibels);

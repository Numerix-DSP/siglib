...
static const SLData_t COS_MOD1[SIZE_COS_MOD1] = {
     1.0000000000, -0.3090170443, -0.8090169327,  0.8090170869,  0.3090167948,
...
int main(void)
{
    ...
    for (i = 0; i < SAMPLE_LENGTH; i++) {
        ...
        working_data =
            SDS_Iir (working_data,                  // Input data sample to be filtered

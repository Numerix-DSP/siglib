...
// Initialise FFT
  ...
  SIF_FirComplexWithStore (RealFilterState,                         // Real state array pointer
...
// Apply complex fir filter
  SDA_FirComplexWithStore (pRealData,                               // Real input array pointer
  ...
  for (SLArrayIndex_t i = 0; i < SAMPLE_LENGTH; i++) {
    SDS_FirComplexWithStore (pRealData[i],                          // Real input array pointer

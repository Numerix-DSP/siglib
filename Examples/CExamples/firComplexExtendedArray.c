...
int main(void)
{
  ...
  if ((NULL == pRealData) || (NULL == pImagData) || (NULL == pResults) || (NULL == pFFTCoeffs) || (NULL == pRealFilterState) ||
      (NULL == pImagFilterState) || (NULL == pRealFilterProcCoeffs) || (NULL == pImagFilterProcCoeffs)) {

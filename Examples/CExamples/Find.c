...
int main (void)
{
    ...
    printf ("Data :\n"); {SLArrayIndex_t j; for (j = 0; j < NumberOfElements; j++) printf ("%lf, ", DstDataArray[j]); printf ("\n");}
    printf ("Location :\n"); {SLArrayIndex_t j; for (j = 0; j < NumberOfElements; j++) printf ("%d, ", DstLocationArray[j]); printf ("\n");}

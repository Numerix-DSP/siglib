...
//     SIF_ArbCrossPowerSpectrum / SDA_ArbCrossPowerSpectrum - Cross-spectrum functions
//
// The XXX_FastAutoPowerSpectrum and XXX_FastCrossPowerSpectrum functions will perform
// the given functions on sequences where the length is a power of two and use
// the Fast Fourier transform functions.
//
// The XXX_ArbAutoPowerSpectrum and XXX_ArbCrossPowerSpectrum functions will perform
// the given functions on an arbitrary length sequence and will use
// the arbitrary length Fourier transform functions. The use of the SigLib arbitrary
// length Fourier transform functionality makes this function more complex than
// performing a regular Fourier transform but this does provide a far higher level
// of performance.

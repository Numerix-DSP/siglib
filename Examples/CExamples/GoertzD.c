...
int main (void)
{
    ...
    GoertzelCoeff =
        SIF_GoertzelDetect (FREQ0,                  // Filter frequency
                            SAMPLE_LENGTH);         // Filter length
    Result1 =
        SDA_GoertzelDetect (pData,                  // Pointer to input data
                            GoertzelCoeff,          // Complex filter coefficients
                            SAMPLE_LENGTH);         // Dataset length

    GoertzelCoeff =
        SIF_GoertzelDetect (FREQ1,                  // Filter frequency
                            SAMPLE_LENGTH);         // Filter length
    Result2 =
        SDA_GoertzelDetect (pData,                  // Pointer to input data
                            GoertzelCoeff,          // Complex filter coefficients
    ...
    GoertzelCoeff =
        SIF_GoertzelDetect (FREQ2,                  // Filter frequency
                            SAMPLE_LENGTH);         // Filter length
    Result3 =
        SDA_GoertzelDetect (pData,                  // Pointer to input data
                            GoertzelCoeff,          // Complex filter coefficients
    ...
    GoertzelCoeff =
        SIF_GoertzelDetect (FREQ3,                  // Filter frequency
                            SAMPLE_LENGTH);         // Filter length
    Result4 =
        SDA_GoertzelDetect (pData,                  // Pointer to input data
                            GoertzelCoeff,          // Complex filter coefficients

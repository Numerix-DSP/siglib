...
int main(void)
{
    ...
    NumberOfCrossings =
        SDA_ZeroCrossingDetect (pSrc,                       // Pointer to source array
    ...
    DetectorPrevValue = SIGLIB_ZERO;
    FirstPos =
        SDA_FirstZeroCrossingLocation (pSrc,                        // Pointer to source array
                                       &DetectorPrevValue,          // Pointer to previous source data value
                                       SIGLIB_POSITIVE_LEVEL_CROSS, // Zero crossing type - +ve, -ve, both
                                       SAMPLE_LENGTH);              // Dataset length
    ...
    DetectorPrevValue = SIGLIB_ZERO;
    NumberOfCrossings =
        SDA_LevelCrossingDetect (pSrc,                          // Pointer to source array
    ...
    DetectorPrevValue = SIGLIB_ZERO;
    FirstPos =
        SDA_FirstLevelCrossingLocation (pSrc,                       // Pointer to source array
                                        DC_LEVEL,                   // Detection level
                                        &DetectorPrevValue,         // Pointer to previous source data value
                                        SIGLIB_POSITIVE_LEVEL_CROSS,    // Level crossing type - +ve, -ve, both
                                        SAMPLE_LENGTH);             // Dataset length

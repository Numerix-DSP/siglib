...
static SLData_t siglib_numerix_IIRButterworth1[] = {(SLData_t)3.53296003486988308200e-01, (SLData_t)3.53296003486988308200e-01,
                                                    (SLData_t)0.00000000000000000000e+00, (SLData_t)-2.93407993026023383700e-01,
                                                    (SLData_t)0.00000000000000000000e+00};

static SLData_t siglib_numerix_IIRButterworth2[] = {(SLData_t)1.44104971248169844200e-01, (SLData_t)2.88209942496339688300e-01,
                                                    (SLData_t)1.44104971248169844200e-01, (SLData_t)-6.77490874949784771600e-01,
                                                    (SLData_t)2.53910759942464092600e-01};
...
static SLData_t* siglib_numerix_pIIRButterworthFilters[] = {
    ...
    siglib_numerix_IIRButterworth1, siglib_numerix_IIRButterworth2, siglib_numerix_IIRButterworth3, siglib_numerix_IIRButterworth4,
    siglib_numerix_IIRButterworth5, siglib_numerix_IIRButterworth6, siglib_numerix_IIRButterworth7, siglib_numerix_IIRButterworth8,
    siglib_numerix_IIRButterworth9, siglib_numerix_IIRButterworth10};

// z-plane Bessel filter coefficients
static SLData_t siglib_numerix_IIRBessel1[] = {(SLData_t)3.53296016761471598500e-01, (SLData_t)3.53296016761471598500e-01,
                                               (SLData_t)0.00000000000000000000e+00, (SLData_t)-2.93407966477056803000e-01,
                                               (SLData_t)0.00000000000000000000e+00};

static SLData_t siglib_numerix_IIRBessel2[] = {(SLData_t)1.44104982456742969400e-01, (SLData_t)2.88209964913485938700e-01,
                                               (SLData_t)1.44104982456742969400e-01, (SLData_t)-6.77490815431722293000e-01,
                                               (SLData_t)2.53910745258694226000e-01};
...
static SLData_t* siglib_numerix_pIIRBesselFilters[] = {
    ...
    siglib_numerix_IIRBessel1, siglib_numerix_IIRBessel2, siglib_numerix_IIRBessel3, siglib_numerix_IIRBessel4, siglib_numerix_IIRBessel5,
    siglib_numerix_IIRBessel6, siglib_numerix_IIRBessel7, siglib_numerix_IIRBessel8, siglib_numerix_IIRBessel9, siglib_numerix_IIRBessel10};

// S-plane Bessel filter coefficients
static SLComplexRect_s siglib_numerix_SPlaneBesselPoles1[] = {{(SLData_t)-1.0000000000, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneBesselPoles2[] = {{(SLData_t)-1.10160133059, (SLData_t)0.636009824757}};

static SLComplexRect_s siglib_numerix_SPlaneBesselPoles3[] = {{(SLData_t)-1.0474091610, (SLData_t)0.9992644363},
                                                              {(SLData_t)-1.3226757999, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneBesselPoles4[] = {{(SLData_t)-0.995208764350, (SLData_t)1.257105739450},
                                                              {(SLData_t)-1.370067830550, (SLData_t)0.410249717494}};

static SLComplexRect_s siglib_numerix_SPlaneBesselPoles5[] = {{(SLData_t)-0.9576765486, (SLData_t)1.4711243207},
                                                              {(SLData_t)-1.3808773259, (SLData_t)0.7179095876},
                                                              {(SLData_t)-1.5023162714, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneBesselPoles6[] = {{(SLData_t)-0.930656522947, (SLData_t)1.661863268940},
                                                              {(SLData_t)-1.381858097600, (SLData_t)0.971471890712},
                                                              {(SLData_t)-1.571490403620, (SLData_t)0.320896374221}};

static SLComplexRect_s siglib_numerix_SPlaneBesselPoles7[] = {{(SLData_t)-0.9098677806, (SLData_t)1.8364513530},
...
static SLComplexRect_s siglib_numerix_SPlaneBesselPoles8[] = {{(SLData_t)-0.892869718847, (SLData_t)1.998325843640},
...
static SLComplexRect_s siglib_numerix_SPlaneBesselPoles9[] = {{(SLData_t)-0.8783992762, (SLData_t)2.1498005243},
...
static SLComplexRect_s siglib_numerix_SPlaneBesselPoles10[] = {{(SLData_t)-0.865756901707, (SLData_t)2.292604830980},
...
static SLComplexRect_s* siglib_numerix_pSPlaneBesselFilters[] = {
    ...
    siglib_numerix_SPlaneBesselPoles1, siglib_numerix_SPlaneBesselPoles2, siglib_numerix_SPlaneBesselPoles3, siglib_numerix_SPlaneBesselPoles4,
    siglib_numerix_SPlaneBesselPoles5, siglib_numerix_SPlaneBesselPoles6, siglib_numerix_SPlaneBesselPoles7, siglib_numerix_SPlaneBesselPoles8,
    siglib_numerix_SPlaneBesselPoles9, siglib_numerix_SPlaneBesselPoles10};

// S-plane Butterworth filter coefficients map
static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles1[] = {{(SLData_t)-1.0000000000, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles2[] = {{(SLData_t)-0.7071067812, (SLData_t)0.7071067812}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles3[] = {{(SLData_t)-0.5000000000, (SLData_t)0.8660254038},
                                                                   {(SLData_t)-1.0000000000, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles4[] = {{(SLData_t)-0.3826834324, (SLData_t)0.9238795325},
                                                                   {(SLData_t)-0.9238795325, (SLData_t)0.3826834324}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles5[] = {{(SLData_t)-0.3090169944, (SLData_t)0.9510565163},
                                                                   {(SLData_t)-0.8090169944, (SLData_t)0.5877852523},
                                                                   {(SLData_t)-1.0000000000, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles6[] = {{(SLData_t)-0.2588190451, (SLData_t)0.9659258263},
                                                                   {(SLData_t)-0.7071067812, (SLData_t)0.7071067812},
                                                                   {(SLData_t)-0.9659258263, (SLData_t)0.2588190451}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles7[] = {{(SLData_t)-0.2225209340, (SLData_t)0.9749279122},
                                                                   {(SLData_t)-0.6234898019, (SLData_t)0.7818314825},
                                                                   {(SLData_t)-0.9009688679, (SLData_t)0.4338837391},
                                                                   {(SLData_t)-1.0000000000, (SLData_t)0.0000000000}};

static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles8[] = {{(SLData_t)-0.1950903220, (SLData_t)0.9807852804},
...
static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles9[] = {{(SLData_t)-0.1736481777, (SLData_t)0.9848077530},
...
static SLComplexRect_s siglib_numerix_SPlaneButterworthPoles10[] = {{(SLData_t)-0.1564344650, (SLData_t)0.9876883406},
...
static SLComplexRect_s* siglib_numerix_pSPlaneButterworthFilters[] = {
    siglib_numerix_SPlaneButterworthPoles1,    // Dummy -there is no zero length
                                               // filter

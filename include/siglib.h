...
// file_io.c
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinReadData (SLData_t SIGLIB_OUTPUT_PTR_DECL *, FILE *, const char, const SLArrayIndex_t);             // Functions for reading and writing .bin files
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinWriteData (const SLData_t SIGLIB_INPUT_PTR_DECL *, FILE *, const char, const SLArrayIndex_t);
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinReadFile (SLData_t SIGLIB_OUTPUT_PTR_DECL *, const char *, const char, const SLArrayIndex_t);
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinWriteFile (const SLData_t SIGLIB_INPUT_PTR_DECL *, const char *, const char, const SLArrayIndex_t);
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadData (SLData_t SIGLIB_OUTPUT_PTR_DECL *, FILE *, const SLData_t, const SLArrayIndex_t, const SLArrayIndex_t);         // Functions for reading and writing .csv files
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvWriteData (const SLData_t SIGLIB_INPUT_PTR_DECL *, FILE *, const SLData_t, const SLArrayIndex_t, const SLArrayIndex_t, const SLArrayIndex_t);
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavWriteFileScaled (const SLData_t SIGLIB_INPUT_PTR_DECL *, const char *, const SLWavFileInfo_s, const SLArrayIndex_t);
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_XmtReadData (SLData_t *, FILE *, const SLArrayIndex_t);                         // Functions for reading and writing .xmt files
...
void SIGLIB_FUNC_DECL SIF_FastBitReverseReorder (SLArrayIndex_t * SIGLIB_OUTPUT_PTR_DECL,   // Bit reverse mode flag / Pointer to bit reverse address table
    const SLArrayIndex_t);                                  // Vector length
...
void SIGLIB_FUNC_DECL SIF_FastDigitReverseReorder4 (SLArrayIndex_t * SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit reverse address table
    const SLArrayIndex_t);                                  // Vector length
...
SLFixData_t SIGLIB_FUNC_DECL SUF_FirKaiserApproximation (SLData_t, // Pass-band cut off frequency
...
void SIGLIB_FUNC_DECL SIF_IirBandPassFilter (SLData_t * SIGLIB_OUTPUT_PTR_DECL,  // Pointer to output IIR filter coefficients
...
SLData_t SIGLIB_FUNC_DECL SDA_InterpolateArbitraryThreePointQuadraticVertexMagnitude (const SLData_t * SIGLIB_INPUT_PTR_DECL,   // Pointer to source array
    const SLArrayIndex_t);                                  // Array length

SLData_t SIGLIB_FUNC_DECL SDA_InterpolateArbitraryThreePointQuadraticVertexLocation (const SLData_t * SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
    const SLArrayIndex_t);                                  // Array length

SLData_t SIGLIB_FUNC_DECL SDA_InterpolateArbitraryThreePointQuadraticPeakVertexMagnitude (const SLData_t * SIGLIB_INPUT_PTR_DECL,   // Pointer to source array
    const SLArrayIndex_t);                                  // Array length

SLData_t SIGLIB_FUNC_DECL SDA_InterpolateArbitraryThreePointQuadraticPeakVertexLocation (const SLData_t * SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
    const SLArrayIndex_t);                                  // Array length

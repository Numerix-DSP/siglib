...
// Filtering functions - iirfilt.c
  ...
  double _stdcall SDA_IirModifyFilterGain (
  ...
  void _stdcall SIF_IirBandPassFilter (
  double * SIGLIB_OUTPUT_PTR_DECL,                                // Pointer to output IIR filter coefficients
...
#line 3687 "siglib.h"
  ...
  long _stdcall SDA_QpskDifferentialEncode (
   long,                                                // Tx di-bit
  long *);                                                   // Previous Tx quadrant pointer

  long _stdcall SDA_QpskDifferentialDecode (
...
// DSP utility functions - dsputils.c
  ...
  double _stdcall SDS_LinearTodBm (
   double,                                                   // Linear value
   double);                                                  // Zero dBm Level

  void _stdcall SDA_LinearTodBm (
   double * SIGLIB_PTR_DECL,                                 // Pointer to source array
  double * SIGLIB_OUTPUT_PTR_DECL,                                // Pointer to destination array
   double,                                                   // Zero dBm level
   long);                                            // Array lengths

  double _stdcall SDS_dBmToLinear (
   double,                                                   // dBm value
   double);                                                  // Zero dBm Level

  void _stdcall SDA_dBmToLinear (
   double * SIGLIB_PTR_DECL,                                 // Pointer to source array
  double * SIGLIB_OUTPUT_PTR_DECL,                                // Pointer to destination array
   double,                                                   // Zero dBm level
   long);                                            // Array lengths

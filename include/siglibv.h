...
long _stdcall
SDA_IirOrderNInitializeCoefficients( double* SIGLIB_INPUT_PTR_DECL,    // Pointer to feedforward coefficients
...
double _stdcall
SDA_InterpolateArbitraryThreePointQuadraticVertexMagnitude( double* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                            long);                    // Array length

double _stdcall
SDA_InterpolateArbitraryThreePointQuadraticVertexLocation( double* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                           long);                    // Array length

double _stdcall
SDA_InterpolateArbitraryThreePointQuadraticPeakVertexMagnitude( double* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                                long);                    // Array length

double _stdcall
SDA_InterpolateArbitraryThreePointQuadraticPeakVertexLocation( double* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                               long);                    // Array length

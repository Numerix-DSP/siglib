...
// siglib.c
double _stdcall SUF_SiglibVersion (
  void);
                                                                                                                                                                                                                                                                                                                                                                     
// Parameter description
// Fast Fourier Transform Functions - ffourier.c
void _stdcall  SIF_Fft (
  ...
  long);                                                            // FFT length
void _stdcall  SDA_Rfft (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to real input/output array
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SDA_BitReverseReorder (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long *SIGLIB_INPUT_PTR_DECL,                                      // Bit reverse mode flag / Pointer to bit reverse address table
  long);                                                            // Vector length
void _stdcall  SDA_IndexBitReverseReorder (
  long *SIGLIB_INPUT_PTR_DECL,                                     // Pointer to source array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to destination array
  long);                                                            // Vector length
void _stdcall  SIF_FastBitReverseReorder (
  long *SIGLIB_OUTPUT_PTR_DECL,                                    // Bit reverse mode flag / Pointer to bit reverse address table
  long);                                                            // Vector length
void _stdcall  SDA_RealRealCepstrum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SDA_RealComplexCepstrum (
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SDA_ComplexComplexCepstrum (
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SIF_FftTone (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  long);                                                            // FFT length
void _stdcall  SDA_RfftTone (
  ...
  long,                                                             // FFT length
  long);                                                            // log2 FFT length
void _stdcall  SDA_Rfftr (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to imaginary array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to FFT coefficients
  long *SIGLIB_INPUT_PTR_DECL,                                      // Bit reverse mode flag / Pointer to bit reverse address table
  long,                                                             // FFT length
  long);                                                            // log2 FFT length
void _stdcall  SIF_Fft4 (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  long);                                                            // FFT length
void _stdcall  SDA_Rfft4 (
  ...
  long,                                                             // FFT length
  long);                                                            // log2 FFT length
void _stdcall  SDA_DigitReverseReorder4 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Vector length
void _stdcall  SDA_IndexDigitReverseReorder4 (
  long *SIGLIB_INPUT_PTR_DECL,                                     // Pointer to source array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to destination array
  long);                                                            // Vector length
void _stdcall  SIF_FastDigitReverseReorder4 (
  long *SIGLIB_OUTPUT_PTR_DECL,                                    // Bit reverse mode flag / Pointer to bit reverse address table
  long);                                                            // Vector length
void _stdcall  SDA_Cfft2rBy1c (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real input array
  ...
  long,                                                             // FFT length
  long);                                                            // log2 FFT length
void _stdcall  SDA_Cfft42rBy1cr (
  ...
  long,                                                             // FFT length
  long);                                                            // log2 FFT length
void _stdcall  SDS_Cfft2 (
  double,                                                          // Source sample real 1
...
void _stdcall  SDA_Cfft2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Pointer to imaginary destination array
void _stdcall  SDS_Cfft3 (
...
// Generic Fourier Transform Functions - fourier.c
long _stdcall  SIF_ZoomFft (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to real comb filter state array
  ...
  long);                                                            // FFT length
void _stdcall  SDA_ZoomFft (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SIF_ZoomFftSimple (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Comb filter 1 pointer
  ...
  long,                                                             // Mixer sine table size
  long);                                                            // FFT length
void _stdcall  SDA_ZoomFftSimple (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Input array pointer
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SIF_FdHilbert (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  double *,                                                         // Inverse FFT length
  long);                                                            // Hilbert transform size
void _stdcall  SDA_FdHilbert (
...
void _stdcall  SIF_FdAnalytic (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  double *,                                                         // Inverse FFT length
  long);                                                            // Hilbert transform size
void _stdcall  SDA_FdAnalytic (
  ...
  long,                                                             // Hilbert transform size
  long);                                                            // Log2 Hilbert transform size
void _stdcall  SDA_InstantFreq (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Leading phase input array pointer
  double *SIGLIB_INPUT_PTR_DECL,                                    // Lagging phase input array pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Rdft (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Transform size
void _stdcall  SDA_Ridft (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Transform size
void _stdcall  SDA_Cdft (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Transform size
void _stdcall  SDA_Cidft (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Transform size
void _stdcall  SDA_FftShift (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_CfftShift (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array length
void _stdcall  SDA_FftExtend (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array length
  long);                                                            // Destination array length
void _stdcall  SDA_CfftExtend (
...
// Arbitrary Length Fast Fourier Transform Functions - arbfft.c
void _stdcall  SIF_FftArb (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to AWNr coefficients
  ...
  long);                                                            // Array length
long _stdcall  SUF_FftArbAllocLength (
  long);                                                           // Array length
void _stdcall  SDA_RfftArb (
...
// Power spectrum functions - pspect.c
void _stdcall  SIF_FastAutoCrossPowerSpectrum (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  double *,                                                         // Pointer to inverse FFT length
  long);                                                            // FFT length
void _stdcall  SDA_FastAutoPowerSpectrum (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Real array pointer
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to imaginary array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to FFT coefficients
  long *SIGLIB_INPUT_PTR_DECL,                                      // Bit reverse mode flag / Pointer to bit reverse address table
  long,                                                             // FFT length
  long,                                                             // log2 FFT length
  double);                                                          // Inverse FFT length
void _stdcall  SDA_FastCrossPowerSpectrum (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Real source array 1 pointer
  ...
  long,                                                             // log2 FFT length
  double);                                                          // Inverse FFT length
void _stdcall  SIF_ArbAutoCrossPowerSpectrum (
  ...
  long);                                                            // Array length
void _stdcall  SDA_ArbAutoPowerSpectrum (
  ...
  long);                                                            // Arbitrary FFT length
void _stdcall  SDA_ArbCrossPowerSpectrum (
  ...
  double,                                                           // Inverse arbitrary FFT length
  long);                                                            // Arbitrary FFT length
long _stdcall  SIF_WelchPowerSpectrum (
...
void _stdcall  SDA_WelchRealPowerSpectrum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source data
  ...
  long);                                                            // Source array length
void _stdcall  SDA_WelchComplexPowerSpectrum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source data
  ...
  double,                                                           // Inverse of number of arrays averaged
  long);                                                            // Source array length
void _stdcall  SIF_MagnitudeSquaredCoherence (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  double *,                                                         // Pointer to the inverse FFT length
  long);                                                            // FFT length
void _stdcall  SDA_MagnitudeSquaredCoherence (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to real source data 1
...
// Frequency domain filtering functions - fdfilter.c
void _stdcall  SIF_FirOverlapAdd (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Time Domain Coefficients pointer
  ...
  long);                                                            // Filter length
void _stdcall  SDA_FirOverlapAdd (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FirOverlapSave (
  ...
  long,                                                             // Log10 FFT Length
  long);                                                            // Filter length
void _stdcall  SDA_FirOverlapSave (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FftConvolvePre (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to time domain filter coefficients
  ...
  long,                                                             // FFT length
  long);                                                            // Log 2 FFT length
void _stdcall  SDA_FftConvolvePre (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real time domain source data
  ...
  long,                                                             // Log 2 FFT length
  double);                                                          // Inverse FFT length
void _stdcall  SDA_FftConvolveArb (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real time domain source data 1
  ...
  long,                                                             // Log 2 FFT length
  double);                                                          // Inverse FFT length
void _stdcall  SIF_FftCorrelatePre (
  ...
  long,                                                             // FFT length
  long);                                                            // Log 2 FFT length
void _stdcall  SDA_FftCorrelatePre (
  ...
  long,                                                             // Log 2 FFT length
  double);                                                          // Inverse FFT length
void _stdcall  SDA_FftCorrelateArb (
...
// Windowing functions - window.c
  ...
  long);                                                            // Window size
double _stdcall SDA_WindowInverseCoherentGain (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array pointer
  long);                                                            // Window size
double _stdcall SDA_WindowEquivalentNoiseBandwidth (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array pointer
  long);                                                            // Window size
double _stdcall SDA_WindowProcessingGain (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array pointer
  long);                                                            // Window size
double _stdcall SDS_I0Bessel (
  double);                                                         // x

// Filtering functions - firfilt.c
void _stdcall  SIF_Fir (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to filter state array
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
double _stdcall SDS_Fir (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDA_Fir (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array to be filtered
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SDS_FirAddSample (
  double,                                                          // Input sample to add to delay line
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDA_FirAddSamples (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Input array of samples to add to delay line
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long *,                                                           // Pointer to filter index register
  long,                                                             // Filter length
  long);                                                            // Source array length
void _stdcall  SIF_Comb (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter delay state array
  long *,                                                           // Pointer to filter index register
  double *,                                                         // Pointer to filter sum register
  long);                                                            // Filter length
double _stdcall SDS_Comb (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long *,                                                           // Pointer to filter index register
  double *,                                                         // Pointer to filter sum register
  long);                                                            // Filter length
void _stdcall  SDA_Comb (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FirComplex (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Real state array pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Imaginary state array pointer
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDS_FirComplex (
  double,                                                          // Real input sample
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FirWithStore (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to filter state array
  long);                                                            // Filter length
double _stdcall SDS_FirWithStore (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients
  long);                                                            // Filter length
void _stdcall  SDA_FirWithStore (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FirComplexWithStore (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Real state array pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Imaginary state array pointer
  long);                                                            // Filter length
void _stdcall  SDS_FirComplexWithStore (
  ...
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary coefficient array
  long);                                                            // Filter length
void _stdcall  SDA_FirComplexWithStore (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SDS_FirWithStoreAddSample (
  double,                                                          // Input sample
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long);                                                            // Filter length
void _stdcall  SDA_FirWithStoreAddSamples (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FirExtendedArray (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter processing coefficients
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
double _stdcall SDS_FirExtendedArray (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDA_FirExtendedArray (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SIF_FirComplexExtendedArray (
  ...
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDS_FirComplexExtendedArray (
  ...
  long *,                                                           // Filter index
  long);                                                            // Filter length
void _stdcall  SDA_FirComplexExtendedArray (
  ...
  long,                                                             // Filter length
  long);                                                            // Array length
void _stdcall  SDS_FirExtendedArrayAddSample (
  double,                                                          // Input sample to add to delay line
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDA_FirExtendedArrayAddSamples (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Input array of samples to add to delay line
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  long *,                                                           // Pointer to filter index register
  long,                                                             // Filter length
  long);                                                            // Source array length
long _stdcall  SIF_FirLowPassFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Filter coeffs array
  double,                                                           // Filter cut off frequency
  int SLWindow_t,                                                   // Window type
  long);                                                            // Filter length
long _stdcall  SIF_FirHighPassFilter (
  ...
  int SLWindow_t,                                                   // Window type
  long);                                                            // Filter length
void _stdcall  SIF_FirLowPassFilterWindow (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Filter coeffs array
  double,                                                           // Filter cut off frequency
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to window coefficients
  long);                                                            // Filter length
void _stdcall  SIF_FirHighPassFilterWindow (
  ...
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to window coefficients
  long);                                                            // Filter length
long _stdcall  SUF_FirKaiserApproximation (
  double,                                                          // Pass-band cut off frequency
  ...
  long);                                                            // Filter length
double _stdcall SDA_FirFilterInverseCoherentGain (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to filter coefficients
  long);                                                            // Filter length
void _stdcall  SIF_TappedDelayLine (
...
double _stdcall SDS_TappedDelayLine (
  ...
  long,                                                             // Number of taps
  long);                                                            // State array length
void _stdcall  SDA_TappedDelayLine (
  ...
  long,                                                             // State array length
  long);                                                            // Array length
void _stdcall  SIF_TappedDelayLineComplex (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to real state array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary state array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to delay index
  long);                                                            // State array length
void _stdcall  SDS_TappedDelayLineComplex (
  double,                                                          // Real source sample
  ...
  long,                                                             // Number of taps
  long);                                                            // State array length
void _stdcall  SDA_TappedDelayLineComplex (
  ...
  long,                                                             // State array length
  long);                                                            // Array length
void _stdcall  SIF_TappedDelayLineIQ (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to real state array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary state array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to delay index
  long);                                                            // State array length
void _stdcall  SDS_TappedDelayLineIQ (
  ...
  long,                                                             // Number of taps
  long);                                                            // State array length
void _stdcall  SDA_TappedDelayLineIQ (
...
// Filtering functions - iirfilt.c
...
double _stdcall SDS_Iir (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients array
  long);                                                            // Number of biquads
void _stdcall  SDA_Iir (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Input array to be filtered
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Filtered output array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients array
  long,                                                             // Number of biquads
  long);                                                            // Array length
double _stdcall SDS_IirMac (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients array
  long);                                                            // Number of biquads
void _stdcall  SDA_IirMac (
  ...
  long,                                                             // Number of biquads
  long);                                                            // Array length
void _stdcall  SIF_IirOrderN (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter state array
  long *,                                                           // Pointer to filter index
  long);                                                            // Filter Order
double _stdcall SDS_IirOrderN (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients array
  long *,                                                           // Pointer to filter index
  long);                                                            // Filter Order
void _stdcall  SDA_IirOrderN (
  ...
  long,                                                             // Filter Order
  long);                                                            // Array length
void _stdcall  SIF_IirNc (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter state array
  long);                                                            // Source array length
void _stdcall  SDA_IirNc (
...
_stdcall        SDA_IirModifyFilterGain (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source IIR filter coefficients
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to modified IIR filter coefficients
  double,                                                           // Centre frequency normalised to 1 Hz
  double,                                                           // Desired gain
  long);                                                            // Number of biquads
void _stdcall  SIF_IirLowPassFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double);                                                          // Filter Q factor
void _stdcall  SIF_IirHighPassFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double);                                                          // Filter Q factor
void _stdcall  SIF_IirAllPassFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double);                                                          // Filter Q factor
void _stdcall  SIF_IirBandPassFilterConstantSkirtGain (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency (low)
  double);                                                          // Filter cut-off frequency (high)
void _stdcall  SIF_IirBandPassFilter0dBPeakGain (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency (low)
  double);                                                          // Filter cut-off frequency (high)
void _stdcall  SIF_IirNotchFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double);                                                          // Filter Q factor
void _stdcall  SIF_IirPeakingFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double,                                                           // Filter Q factor
  double);                                                          // Filter gain (dB)
void _stdcall  SIF_IirLowShelfFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double,                                                           // Filter Q factor
  double);                                                          // Filter shelf gain (dB)
void _stdcall  SIF_IirHighShelfFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to output IIR filter coefficients
  double,                                                           // Filter cut-off frequency
  double,                                                           // Filter Q factor
  double);                                                          // Filter shelf gain (dB)
double _stdcall SDS_IirRemoveDC (
  double,                                                          // Input sample
  double *,                                                         // Previous input sample
  double *,                                                         // Previous output sample
  double);                                                          // Convergence rate
void _stdcall  SDA_IirRemoveDC (
  ...
  double,                                                           // Convergence rate
  long);                                                            // Array length
void _stdcall  SIF_OnePole (
  double *);                                                       // Filter state
double _stdcall SDS_OnePole (
  double,                                                          // Input data
  double,                                                           // Filter alpha
  double *);                                                        // Filter state
void _stdcall  SDA_OnePole (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Filter alpha
  double *,                                                         // Filter state
  long);                                                            // Array length
double _stdcall SDS_OnePoleNormalized (
  double,                                                          // Input data
  double,                                                           // Filter alpha
  double *);                                                        // Filter state
void _stdcall  SDA_OnePoleNormalized (
  ...
  double,                                                           // Filter alpha
  long);                                                            // Array length
void _stdcall  SIF_OnePoleHighPass (
  double *);                                                       // Filter state
double _stdcall SDS_OnePoleHighPass (
  double,                                                          // Input data
  double,                                                           // Filter alpha
  double *);                                                        // Filter state
void _stdcall  SDA_OnePoleHighPass (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Filter alpha
  double *,                                                         // Filter state
  long);                                                            // Array length
double _stdcall SDS_OnePoleHighPassNormalized (
  double,                                                          // Input data
  double,                                                           // Filter alpha
  double *);                                                        // Filter state
void _stdcall  SDA_OnePoleHighPassNormalized (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Filter alpha
  double *,                                                         // Filter state
  long);                                                            // Array length
void _stdcall  SDA_OnePoleHighPassPerSample (
  ...
  long *,                                                           // Pointer to filter index
  long);                                                            // Filter order
double _stdcall SDS_AllPole (
  double,                                                          // Input sample
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients
  long *,                                                           // Pointer to filter index
  long);                                                            // Filter order
void _stdcall  SDA_AllPole (
  ...
  long,                                                             // Filter order
  long);                                                            // Array length
void _stdcall  SDA_ZDomainCoefficientReorg (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source z-domain coefficient array
  ...
  long);                                                            // Filter order
long _stdcall  SIF_IirNotchFilter2 (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter coefficients
  double,                                                           // Notch frequency
  double,                                                           // Pole magnitude
  long);                                                            // Filter order
long _stdcall  SIF_IirNormalizedCoefficients (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter coefficients
  int SLIIRNormalizedCoeffs_t,                                      // Filter coefficient type
  long);                                                            // Filter order
long _stdcall  SIF_IirNormalizedSPlaneCoefficients (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter coefficients
  int SLIIRNormalizedCoeffs_t,                                      // Filter coefficient type
  long);                                                            // Filter order
void _stdcall  SDA_TranslateSPlaneCutOffFrequency (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source filter poles / zeros
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination filter poles / zeros
  double,                                                           // New cut-off frequency
  long);                                                            // Filter order
double _stdcall SDA_IirLpLpShift (
  ...
  double,                                                           // Cut-off frequency
  double);                                                          // Pole radius
double _stdcall SDS_Iir2Pole (
  double,                                                          // Input data sample to be filtered
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL);                                   // Pointer to filter coefficients array
void _stdcall  SDA_Iir2Pole (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Input array to be filtered
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Filtered output array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to filter coefficients array
  long);                                                            // Array length
void _stdcall  SDA_IirNegateAlphaCoeffs (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source filter coefficients array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination filter coefficients array
  long);                                                            // Number of biquads
long _stdcall  SIF_GraphicalEqualizerFilterBank (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to filter cut-off frequency array
...
// Filtering functions - filter.c
  ...
  long);                                                            // Array length
void _stdcall  SDA_Differentiate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to output data
  double *,                                                         // Pointer to previous value
  long);                                                            // Array length
void _stdcall  SIF_LeakyIntegrator (
  double *);                                                       // Pointer to state variable
double _stdcall SDS_LeakyIntegrator1 (
  double,                                                          // Data value
  double *,                                                         // Pointer to state variable
  double,                                                           // Leak value
  double);                                                          // Peak value
double _stdcall SDS_LeakyIntegrator2 (
  ...
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to state array
  double);                                                          // Filter coefficient
double _stdcall SIF_GoertzelDetect (
  double,                                                          // Filter frequency
  long);                                                            // Filter length
double _stdcall SDA_GoertzelDetect (
  ...
  double,                                                           // Alpha
  long);                                                            // Filter length
double _stdcall SDS_ZTransform (
  double,                                                          // Location in z-plane to calculate
...
double _stdcall SDS_ZTransformDB (
...
double _stdcall SUF_FrequenciesToOctaves (
  double Fl,                                                       // Low frequency
  double Fh);                                                       // High frequency
double _stdcall SUF_FrequenciesToCentreFreqHz (
  double Fl,                                                       // Low frequency
  double Fh);                                                       // High frequency
double _stdcall SUF_FrequenciesToQFactor (
  double Fl,                                                       // Low frequency
  double Fh);                                                       // High frequency
double _stdcall SUF_BandwidthToQFactor (
...
// Acoustic processing functions - acoustic.c
...
void _stdcall  SDA_LinearMicrophoneArrayBeamPatternLinear (
  ...
  double,                                                           // Calculation end angle (Degrees)
  long);                                                            // Number of angles to calculate
                               double _stdcall SDS_TemperatureToSpeedOfSoundInAir (
  double);                                                         // Temperature

// Adaptive filtering functions - adaptive.c
void _stdcall  SIF_Lms (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LMS filter state array
...
void _stdcall  SDA_LmsUpdate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to LMS filter state array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to LMS filter coefficients
  long *,                                                           // Pointer to LMS filter index
  long,                                                             // LMS filter length
  double,                                                           // Adaptation step size
  double);                                                          // Error
void _stdcall  SDA_LeakyLmsUpdate (
  ...
  double);                                                          // Error
void _stdcall  SDA_NormalizedLmsUpdate (
  ...
  double,                                                           // Adaptation step size
  double);                                                          // Error
void _stdcall  SDA_SignErrorLmsUpdate (
  ...
  double,                                                           // Adaptation step size
  double);                                                          // Error
void _stdcall  SDA_SignDataLmsUpdate (
  ...
  double,                                                           // Adaptation step size
  double);                                                          // Error
void _stdcall  SDA_SignSignLmsUpdate (
...
// Convolution functions - convolve.c
void _stdcall  SDA_ConvolveLinear (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to impulse response data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Input data length
  long);                                                            // Impulse response length
void _stdcall  SDA_ConvolvePartial (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to impulse response data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Input data length
  long);                                                            // Impulse response length
void _stdcall  SDA_ConvolveCircular (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to impulse response data
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Length of input arrays
void _stdcall  SDA_ConvolveLinearComplex (
  ...
  long,                                                             // Input data length
  long);                                                            // Impulse response length
void _stdcall  SDA_ConvolvePartialComplex (
  ...
  long,                                                             // Input data length
  long);                                                            // Impulse response length
void _stdcall  SDA_ConvolveCircularComplex (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array length
void _stdcall  SDA_FftDeconvolution (
  ...
  long,                                                             // log2 FFT length
  double);                                                          // Inverse FFT length
void _stdcall  SIF_FftDeconvolutionPre (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to impulse response array
  ...
  long,                                                             // FFT length
  long);                                                            // Log2 FFT length
void _stdcall  SDA_FftDeconvolutionPre (
...
// Correlation functions - correlate.c
void _stdcall  SDA_CorrelateLinear (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array #1
...
void _stdcall  SDA_CorrelatePartial (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to input array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Length of array #1
  long);                                                            // Length of array #2
void _stdcall  SDA_CorrelateCircular (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to input array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to input array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Length of input arrays
void _stdcall  SDA_Covariance (
  ...
  long,                                                             // Length of array #2
  long);                                                            // Impulse response length
void _stdcall  SDA_CovariancePartial (
  ...
  long,                                                             // Length of array #1
  long);                                                            // Length of array #2
void _stdcall  SDA_CorrelateLinearReturnPeak (
...
// Delay functions - delay.c
  ...
  long,                                                             // Delay length
  long);                                                            // Array length
void _stdcall  SIF_FixedDelayComplex (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to real delay state array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary delay state array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to delay state index
  long);                                                            // Delay length
void _stdcall  SDS_FixedDelayComplex (
  double,                                                          // Real input data sample
  ...
  long *,                                                           // Pointer to delay state index
  long);                                                            // Delay length
void _stdcall  SDA_FixedDelayComplex (
  ...
  long,                                                             // Delay length
  long);                                                            // Array length
void _stdcall  SDA_ShortFixedDelay (
  ...
  long);                                                            // Array length
long _stdcall  SIF_VariableDelay (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to the delay state array
...
double _stdcall SDS_VariableDelay (
  double,                                                          // Input value
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to the delay state array
  long *,                                                           // Pointer to the FIFO input index
  long *,                                                           // Pointer to the FIFO output index
  long);                                                            // Maximum delay length
void _stdcall  SDA_VariableDelay (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to the input array
...
long _stdcall  SIF_VariableDelayComplex (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to the real delay state array
  ...
  long,                                                             // Initial FIFO delay value
  long);                                                            // Maximum delay length
void _stdcall  SDS_VariableDelayComplex (
  double,                                                          // Real input value
  ...
  long *,                                                           // Pointer to the FIFO output index
  long);                                                            // Maximum delay length
void _stdcall  SDA_VariableDelayComplex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to the real input array
  ...
  long,                                                             // Maximum delay length
  long);                                                            // Input / output array length
long _stdcall  SUF_IncreaseVariableDelay (
  long *,                                                          // Pointer to the FIFO output index
  long *,                                                           // Pointer to delay length
  long);                                                            // Maximum delay length
long _stdcall  SUF_DecreaseVariableDelay (
  long *,                                                          // Pointer to the FIFO output index
  long *,                                                           // Pointer to delay length
  long);                                                            // Maximum delay length
long _stdcall  SDA_Align (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
...
void _stdcall  SIM_Fft2d (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
...
void _stdcall  SIF_Fft2d (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to FFT coefficients
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Bit reverse mode flag / Pointer to bit reverse address table
  long);                                                            // FFT length
void _stdcall  SIM_Conv3x3 (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to coefficients array
  long,                                                             // Line length
  long);                                                            // Column length
void _stdcall  SIM_Sobel3x3 (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  long,                                                             // Line length
  long);                                                            // Column length
void _stdcall  SIM_SobelVertical3x3 (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  long,                                                             // Line length
  long);                                                            // Column length
void _stdcall  SIM_SobelHorizontal3x3 (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  long,                                                             // Line length
  long);                                                            // Column length
void _stdcall  SIM_Median3x3 (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  long,                                                             // Line length
  long);                                                            // Column length
long _stdcall  SIF_ConvCoefficients3x3 (
  double *,                                                        // Pointer to coefficient array
  int SL3x3Coeffs_t);                                               // Filter type
int _stdcall   SIM_Max (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  long);                                                            // Array length
int _stdcall   SIM_Min (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  long);                                                            // Array length

// Image coding functions
void _stdcall  SIF_Dct8x8 (
  void);                                                           // Void
void _stdcall  SIM_Dct8x8 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source sub image
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Pointer to destination sub image
void _stdcall  SIM_Idct8x8 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source sub image
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Pointer to destination sub image
void _stdcall  SIM_ZigZagScan (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Square image line length
void _stdcall  SIM_ZigZagDescan (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Square image line length

// Signal generation functions - siggen.c
long _stdcall  SDA_SignalGenerate (
  ...
  long);                                                            // Array length
long _stdcall  SDS_SignalGenerate (
  ...
  long);                                                            // Array length
void _stdcall  SIF_Resonator1 (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to state array
  double,                                                           // Resonant frequency
  double *,                                                         // Pointer to cosine coefficient
  double *,                                                         // Pointer to sine coefficient
  long *);                                                          // Pointer to first iteration flag
void _stdcall  SDA_Resonator1 (
  ...
  double,                                                           // Sine coefficient
  long);                                                            // Array length
void _stdcall  SDA_Resonator1Add (
  ...
  double,                                                           // Sine coefficient
  long);                                                            // Array length
void _stdcall  SDA_SignalGeneratePolarWhiteNoise (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Destination array pointer
  double,                                                           // Peak level
  int SLSignalFillMode_t,                                           // Array fill mode, fill up or add to
  long);                                                            // Array length
double _stdcall SDS_SignalGeneratePolarWhiteNoise (
  double);                                                         // Peak level
void _stdcall  SDA_SignalGeneratePolarGaussianNoise (
  ...
  int SLSignalFillMode_t,                                           // Array fill mode, fill up or add to
  long);                                                            // Array length
double _stdcall SDS_SignalGeneratePolarGaussianNoise (
  double,                                                          // Noise variance
  double *,                                                         // Noise phase offset
  double *);                                                        // Noise current value
void _stdcall  SDA_SignalAddPolarJitterAndGaussianNoise (
  ...
  double *,                                                         // Noise current value
  long);                                                            // Array length
double _stdcall SDS_SignalAddPolarJitterAndGaussianNoise (
  ...
  double *,                                                         // Phase offset
  double *);                                                        // Noise current value
void _stdcall  SDA_Ramp (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Destination array pointer
  double,                                                           // Start value
  double,                                                           // Increment value
  long);                                                            // Array length
void _stdcall  SIF_RandomNumber (
  void);                                                           // void
double _stdcall SDS_RandomNumber (
  double,                                                          // Lower bound
  double);                                                          // Upper bound
void _stdcall  SDA_RandomNumber (
...
// Communication functions - comms.c
double _stdcall SDA_BitErrorRate (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Source 1 pointer
  int *SIGLIB_INPUT_PTR_DECL,                                       // Source 2 pointer
  double,                                                           // Inverse of number of bits
  long);                                                            // Array length
void _stdcall  SDA_Interleave (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to destination array
  long,                                                             // Stride
  long);                                                            // Length of input array
void _stdcall  SDA_Deinterleave (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to destination array
  long,                                                             // Stride
  long);                                                            // Length of input array
double _stdcall SCV_EuclideanDistance (
  double,                                                          // Complex source vector 1
  double);                                                          // Complex source vector 2
double _stdcall SCV_EuclideanDistanceSquared (
  double,                                                          // Complex source vector 1
  double);                                                          // Complex source vector 2
void _stdcall  SCA_EuclideanDistance (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source vector #1
...
void _stdcall  SCA_EuclideanDistanceSquared (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source vector #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source vector #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination
  long);                                                            // Number of samples
double _stdcall SDS_EuclideanDistance (
  double,                                                          // Source #1 x-axis value
  double,                                                           // Source #1 y-axis value
  double,                                                           // Source #2 x-axis value
  double);                                                          // Source #2 y-axis value
double _stdcall SDS_EuclideanDistanceSquared (
  double,                                                          // Source #1 x-axis value
  double,                                                           // Source #1 y-axis value
  double,                                                           // Source #2 x-axis value
  double);                                                          // Source #2 y-axis value
void _stdcall  SDA_EuclideanDistance (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source #1 x-axis values
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination
  long);                                                            // Number of samples
void _stdcall  SDA_EuclideanDistanceSquared (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination
  long);                                                            // Number of samples
int _stdcall   SDS_ManchesterEncode (
  int);                                                            // Input bit
int _stdcall   SDS_ManchesterDecode (
  int);                                                            // Input dibit
long _stdcall  SDS_ManchesterEncodeByte (
  int);                                                            // Input byte of bits
long _stdcall  SDS_ManchesterDecodeByte (
  long);                                                           // Input short word of dibits
void _stdcall  SIF_DetectNumericalWordSequence (
  long *,                                                          // Bit mask
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Detector state array
  long,                                                             // Word length
  long);                                                            // Synchronization sequence length
long _stdcall  SDS_DetectNumericalWordSequence (
  long,                                                            // Input word
  long *SIGLIB_INPUT_PTR_DECL,                                      // Synchronization sequence
  long,                                                             // Input bit mask
  long *SIGLIB_INOUT_PTR_DECL,                                      // Detector state array
  long);                                                            // Synchronization sequence length
void _stdcall  SIF_DetectNumericalBitSequence (
  long *,                                                          // Synchronization sequence bit mask
  long *,                                                           // Detector state variable
  long);                                                            // Synchronization sequence length
long _stdcall  SDS_DetectNumericalBitSequence (
  long,                                                            // Input word
  long,                                                             // Synchronization sequence
  long,                                                             // Synchronization sequence bit mask
  long *,                                                           // Detector state variable
  long);                                                            // Input word length
void _stdcall  SIF_DetectCharacterSequence (
  int *SIGLIB_OUTPUT_PTR_DECL,                                     // Detector state array
  long);                                                            // Synchronization sequence length
long _stdcall  SDS_DetectCharacterSequence (
  int,                                                             // Input character
  int *SIGLIB_INPUT_PTR_DECL,                                       // Synchronization sequence
  int *SIGLIB_INOUT_PTR_DECL,                                       // Detector state array
  long);                                                            // Synchronization sequence length
double _stdcall SDS_ErrorVector (
  double,                                                          // Ideal point
  double);                                                          // Received point
double _stdcall SDS_ErrorVectorMagnitudePercent (
  double,                                                          // Ideal point
  double);                                                          // Received point
double _stdcall SDS_ErrorVectorMagnitudeDecibels (
  double,                                                          // Ideal point
  double);                                                          // Received point
long _stdcall  SDS_ReverseDiBits (
  long);                                                           // Input di-bits
void _stdcall  SDS_QpskBitErrorCount (
  long,                                                            // Input di-bits
  long,                                                             // Output data bits
  long *,                                                           // Pointer to bit count
  long *);                                                          // Pointer to bit error count
double _stdcall SDS_BitErrorRate (
  long,                                                            // Bit count
  long);                                                            // Bit error count

// Communications timing detection functions - timing.c
void _stdcall  SIF_PhaseLockedLoop (
...
double _stdcall SDS_PhaseLockedLoop (
  ...
  long,                                                             // Filter length
  double *);                                                        // Pointer to delayed sample
void _stdcall  SDA_PhaseLockedLoop (
  ...
  double *);                                                        // Pointer to delayed sample
double _stdcall SDS_CostasLoop (
  ...
  double *,                                                         // Pointer to loop filter state
  double *);                                                        // Pointer to delayed sample
void _stdcall  SIF_180DegreePhaseDetect (
...
long _stdcall  SDA_180DegreePhaseDetect (
  ...
  long *,                                                           // Pointer to sign of previous output
  long);                                                            // Length of input array
void _stdcall  SIF_TriggerReverberator (
  long *,                                                          // Pointer to trigger counter
  long *,                                                           // Pointer to trigger detected flag
  long *);                                                          // Pointer to trigger updated flag
void _stdcall  SDA_TriggerReverberator (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source trigger sequence
...
double _stdcall SDS_TriggerReverberator (
  double,                                                          // Input trigger signal
  long *,                                                           // Pointer to trigger counter
  long *,                                                           // Pointer to trigger detected flag
  long *,                                                           // Pointer to trigger updated flag
  long);                                                            // Nominal period of output trigger sequence
long _stdcall  SDA_TriggerSelector (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source data sequence
...
long _stdcall  SIF_EarlyLateGate (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to matched filter signal
...
void _stdcall  SDA_EarlyLateGate (
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Source array length
void _stdcall  SDA_EarlyLateGateDebug (
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Source array length
double _stdcall SDS_EarlyLateGate (
  double,                                                          // Source data value
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to matched filter state array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to matched filter coefficients
  long *,                                                           // Pointer to matched filter index
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to early gate state array
  ...
  long *,                                                           // Pointer to trigger updated flag
  long);                                                            // Samples per symbol
long _stdcall  SIF_EarlyLateGateSquarePulse (
  ...
  long *,                                                           // Pointer to trigger latency
  long);                                                            // Samples per symbol
void _stdcall  SDA_EarlyLateGateSquarePulse (
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Source array length
void _stdcall  SDA_EarlyLateGateSquarePulseDebug (
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Source array length
double _stdcall SDS_EarlyLateGateSquarePulse (
...
// Convolutional encoding / Viterbi decoding functions - viterbi.c
short _stdcall SDS_ConvEncoderK3 (
  int,                                                             // Input character
  long *);                                                          // Pointer to history word
void _stdcall  SIF_ViterbiDecoderK3 (
...
int _stdcall   SDS_ViterbiDecoderK3 (
  double *,                                                        // Source data pointer
  long *,                                                           // Counts the bits into the output word so they are correctly aligned
  int *,                                                            // This is where the decoded bits are built up into a byte
  double *,                                                         // Accumulated error array
  long *,                                                           // Survivor state history table
  ...
  long *,                                                           // Flag is set to SIGLIB_TRUE when we are in trace back mode
  long);                                                            // Trace back depth
double _stdcall SDS_ConvEncoderV32 (
  int,                                                             // Input nibble
  long *,                                                           // Previous input for differential encoder
  long *);                                                          // Convolutional encoder state
void _stdcall  SIF_ViterbiDecoderV32 (
  double *,                                                        // Accumulated error array
  long *,                                                           // Survivor state history table
  long *,                                                           // Offset into state history array - this is used as a circular pointer
  long *,                                                           // Flag is set to SIGLIB_TRUE when we are in trace back mode
  long);                                                            // Trace back depth
int _stdcall   SDS_ViterbiDecoderV32 (
  double,                                                          // Source channel data
  double *,                                                         // Accumulated error array
  long *,                                                           // Survivor state history table
  long *,                                                           // Offset into state history array - this is used as a circular pointer
...
// Analog modulation functions - mod_a.c
void _stdcall  SIF_AmplitudeModulate (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Carrier table pointer
  long *,                                                           // Carrier table index
  long);                                                            // Modulator array length
void _stdcall  SDA_AmplitudeModulate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Modulating signal source pointer
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier table pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Modulated signal destination pointer
  long *,                                                           // Carrier table index
  long,                                                             // Modulator array length
  long);                                                            // Array length
double _stdcall SDS_AmplitudeModulate (
  double,                                                          // Modulating signal source data
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier table pointer
  long *,                                                           // Carrier table index
  long);                                                            // Modulator array length
void _stdcall  SIF_AmplitudeModulate2 (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Carrier table pointer
  double *,                                                         // Carrier table index
  long);                                                            // Modulator array length
void _stdcall  SDA_AmplitudeModulate2 (
  ...
  long,                                                             // Modulator array length
  long);                                                            // Array length
double _stdcall SDS_AmplitudeModulate2 (
  double,                                                          // Modulating signal source data
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier table pointer
  double *,                                                         // Carrier table phase
  double,                                                           // Carrier frequency
  long);                                                            // Modulator array length
long _stdcall  SIF_ComplexShift (
...
void _stdcall  SDA_ComplexShift (
  ...
  long,                                                             // Look up table size
  long);                                                            // Array length
void _stdcall  SDA_FrequencyDemodulate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Modulated signal source pointer
  ...
  long);                                                            // Array length
void _stdcall  SIF_FrequencyModulateComplex (
  double *,                                                        // Pointer to carrier phase
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to LUT array
  long);                                                            // Table length
void _stdcall  SDS_FrequencyModulateComplex (
  ...
  long);                                                            // Look up table size
void _stdcall  SDA_FrequencyModulateComplex (
  ...
  long,                                                             // Look up table size
  long);                                                            // Array length
void _stdcall  SDA_DeltaModulate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double *,                                                         // Pointer to current modulator integral value
  double,                                                           // Delta magnitude
  long);                                                            // Input Array length
void _stdcall  SDA_DeltaDemodulate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double *,                                                         // Pointer to current modulator integral value
  long);                                                            // Source array length
void _stdcall  SDA_DeltaModulate2 (
...
long _stdcall  SIF_CostasQamDemodulate (
...
long _stdcall  SDS_CostasQamDemodulate (
...
long _stdcall   SDS_CostasQamDemodulateDebug (
...
long _stdcall  SDA_CostasQamDemodulate (
  ...
  long,                                                             // ELG output synchronization delay length
  long);                                                            // Source array length
long _stdcall  SDA_CostasQamDemodulateDebug (
...
#line 3804 "siglib.h"
...
void _stdcall  SDA_QpskModulate (
  long,                                                            // Source data di-bit
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
void _stdcall  SIF_QpskDemodulate (
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
long _stdcall  SDA_QpskDemodulate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier table pointer
  long,                                                             // Carrier sine table size
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
long _stdcall  SDA_QpskDemodulateDebug (
...
long _stdcall  SDS_QpskDifferentialEncode (
  long,                                                            // Tx di-bit
  long *);                                                          // Previous Tx quadrant pointer
long _stdcall  SDS_QpskDifferentialDecode (
...
void _stdcall  SDA_FskModulateByte (
  long,                                                            // Source data byte
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination data pointer
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Sine table size
void _stdcall  SDA_FskModulate (
  long,                                                            // Source data bit
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination data pointer
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier sinusoid table
  double *SIGLIB_INOUT_PTR_DECL,                                    // Level '1' carrier phase
  double *SIGLIB_INOUT_PTR_DECL,                                    // Level '0' carrier phase
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Sine table size
long _stdcall  SDA_FskDemodulate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source data pointer
  double *SIGLIB_INOUT_PTR_DECL,                                    // Level '1' filter pointer
  double *SIGLIB_INOUT_PTR_DECL,                                    // Level '0' filter pointer
  long,                                                             // Filter length
  long);                                                            // Samples per symbol
void _stdcall  SDA_CpfskModulate (
  ...
  long,                                                             // Samples per symbol
  long);                                                            // Sine table size
void _stdcall  SIF_Qam16Modulate (
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
void _stdcall  SDA_Qam16Modulate (
  long,                                                            // Source data nibble
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier table pointer
  long,                                                             // Carrier sine table size
  double *SIGLIB_INOUT_PTR_DECL,                                    // Carrier phase pointer
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
void _stdcall  SIF_Qam16Demodulate (
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
long _stdcall  SDA_Qam16Demodulate (
  ...
  long,                                                             // RRCF size
  long);                                                            // RRCF enable / disable switch
long _stdcall  SDA_Qam16DemodulateDebug (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Eye samples pointer
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Constellation points pointer
long _stdcall  SDA_Qam16DifferentialEncode (
  ...
  long);                                                            // Carrier sine table size
void _stdcall  SDA_BpskModulate (
  ...
  long);                                                            // Carrier sine table size
void _stdcall  SDA_BpskModulateByte (
  long,                                                            // Modulating byte
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Carrier table pointer
  double *,                                                         // Carrier phase pointer
  long,                                                             // Samples per symbol
  double,                                                           // Carrier table increment
  long);                                                            // Carrier sine table size
void _stdcall  SIF_BpskDemodulate (
...
long _stdcall  SDA_BpskDemodulate (
  ...
  double *,                                                         // Pointer to Rx sample sum - used to decide which bit was Tx'd
  long);                                                            // Samples per symbol
long _stdcall  SDA_BpskDemodulateDebug (
...
void _stdcall  SIF_DpskModulate (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Carrier table pointer
  double,                                                           // Carrier phase increment per sample (radians / 2Ï€)
  double *,                                                         // Transmitter sample count - tracks samples
  long,                                                             // Carrier sine table size
  double *);                                                        // Pointer to modulation phase value
void _stdcall  SDA_DpskModulate (
  ...
  long,                                                             // Carrier sine table size
  double *);                                                        // Pointer to modulation phase value
void _stdcall  SDA_DpskModulateByte (
  ...
  long,                                                             // Carrier sine table size
  double *);                                                        // Pointer to modulation phase value
void _stdcall  SIF_DpskDemodulate (
...
long _stdcall  SDA_DpskDemodulate (
  ...
  long,                                                             // Samples per symbol
  double *);                                                        // Previous Rx'd sample sum
long _stdcall  SDA_DpskDemodulateDebug (
  ...
  double *,                                                         // Previous Rx'd sample sum
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Pointer to filter output data
void _stdcall  SIF_PiByFourDQpskModulate (
...
void _stdcall  SDA_PiByFourDQpskModulate (
  ...
  long,                                                             // RRCF enable / disable switch
  long *);                                                          // Pointer to previous output symbol for differential coding
void _stdcall  SDS_ChannelizationCode (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Channelization code array
  long,                                                             // Spreading factor
  long);                                                            // Channelization code index
void _stdcall  SDA_ComplexQPSKSpread (
  ...
  long);                                                            // Spreading factor
long _stdcall  SDA_ComplexQPSKDeSpread (
...
// Modem utility functions - modem.c
  ...
  long,                                                             // Number of stop bits
  long);                                                            // Source array length
long _stdcall  SDA_AsyncToSyncConverter (
  ...
  long);                                                            // Source array length
void _stdcall  SIF_AsyncAddRemoveStopBits (
  long *);                                                         // Pointer to counter for adding and removing stop bits
long _stdcall  SDA_AsyncRemoveStopBits (
  ...
  long);                                                            // Source array length
long _stdcall  SDA_AsyncAddStopBits (
  ...
  long);                                                            // Source array length
long _stdcall  SDA_DecreaseWordLength (
  char *,                                                          // Pointer to source data
  char *,                                                           // Pointer to destination data
  long,                                                             // Input word length
  long,                                                             // Output word length
  long);                                                            // Source array length
long _stdcall  SDA_IncreaseWordLength (
...
long _stdcall  SDS_Scrambler1417 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_Descrambler1417 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_Scrambler1417WithInversion (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL,                                       // Shift register
  long *SIGLIB_INOUT_PTR_DECL,                                      // Ones bit counter
  long *SIGLIB_INOUT_PTR_DECL);                                     // Bit inversion flag
long _stdcall  SDS_Descrambler1417WithInversion (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL,                                       // Shift register
  long *SIGLIB_INOUT_PTR_DECL,                                      // Ones bit counter
  long *SIGLIB_INOUT_PTR_DECL);                                     // Bit inversion flag
long _stdcall  SDS_Scrambler1823 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_Descrambler1823 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_Scrambler523 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_Descrambler523 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_ScramblerDescramblerPN9 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_SequenceGeneratorPN9 (
  int *SIGLIB_INOUT_PTR_DECL);                                     // Shift register
long _stdcall  SDS_ScramblerDescramblerPN15 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_SequenceGeneratorPN15 (
  int *SIGLIB_INOUT_PTR_DECL);                                     // Shift register
long _stdcall  SDS_ScramblerDescramblergCRC24 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_SequenceGeneratorgCRC24 (
  int *SIGLIB_INOUT_PTR_DECL);                                     // Shift register
long _stdcall  SDS_ScramblerDescramblergCRC16 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_SequenceGeneratorgCRC16 (
  int *SIGLIB_INOUT_PTR_DECL);                                     // Shift register
long _stdcall  SDS_ScramblerDescramblergCRC12 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_SequenceGeneratorgCRC12 (
  int *SIGLIB_INOUT_PTR_DECL);                                     // Shift register
long _stdcall  SDS_ScramblerDescramblergCRC8 (
  long,                                                            // Source character
  int *SIGLIB_INOUT_PTR_DECL);                                      // Shift register
long _stdcall  SDS_SequenceGeneratorgCRC8 (
  int *SIGLIB_INOUT_PTR_DECL);                                     // Shift register
void _stdcall  SDS_LongCodeGenerator3GPPDL (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to destination array
  int *SIGLIB_INOUT_PTR_DECL,                                       // X shift register
  int *SIGLIB_INOUT_PTR_DECL,                                       // Y shift register
  long);                                                            // Output Array length
void _stdcall  SDS_LongCodeGenerator3GPPUL (
...
void _stdcall   SDA_Multiplex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source multiplexed array
...
// Decimation and interpolation functions - decint.c
  ...
  long,                                                             // Filter length
  long);                                                            // Source array length
void _stdcall  SIF_InterpolateAndFilter (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to filter state array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to interpolation index register
  long *,                                                           // Pointer to filter index register
  long);                                                            // Filter length
void _stdcall  SDA_InterpolateAndFilter (
  ...
  long,                                                             // Filter length
  long);                                                            // Destination array length
long _stdcall  SDA_ResampleLinear (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // New sample period
  long);                                                            // Source array length
long _stdcall  SDA_ResampleLinearNSamples (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // New sample period
  long,                                                             // Source array length
  long);                                                            // Destination array length
double _stdcall SDA_InterpolateLinear1D (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to Y source array
  double,                                                           // Input x value
  long);                                                            // Source array length
double _stdcall SDA_InterpolateLinear2D (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y source array
  double,                                                           // Input x value
  long);                                                            // Source array length
void _stdcall  SIF_ResampleSinc (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to sinc LUT array
  double *,                                                         // Pointer to phase gain
  long,                                                             // Number of adjacent samples
  long);                                                            // Sinc look up table length
void _stdcall  SIF_ResampleWindowedSinc (
  ...
  double,                                                           // Window coefficient
  long);                                                            // Sinc look up table length
long _stdcall  SDA_ResampleSinc (
  ...
  long,                                                             // Number of adjacent samples
  long);                                                            // Source array length
long _stdcall  SDA_ResampleSincNSamples (
  ...
  long,                                                             // Source array length
  long);                                                            // Destination array length
void _stdcall  SIF_InterpolateSinc1D (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to sinc LUT array
  double *,                                                         // Pointer to phase gain
  long,                                                             // Number of adjacent samples
  long);                                                            // Sinc look up table length
void _stdcall  SIF_InterpolateWindowedSinc1D (
  ...
  double,                                                           // Window coefficient
  long);                                                            // Sinc look up table length
double _stdcall SDA_InterpolateSinc1D (
  ...
  long,                                                             // Number of adjacent samples
  long);                                                            // Source array length
void _stdcall  SIF_ResampleLinearContiguous (
  double *,                                                        // Pointer to previous X value
  double *);                                                        // Pointer to previous Y value
long _stdcall  SDA_ResampleLinearContiguous (
  ...
  long);                                                            // Source array length
void _stdcall  SIF_ResampleSincContiguous (
  ...
  long,                                                             // Number of adjacent samples
  long);                                                            // Sinc look up table length
void _stdcall  SIF_ResampleWindowedSincContiguous (
  ...
  double,                                                           // Window coefficient
  long);                                                            // Sinc look up table length
long _stdcall  SDA_ResampleSincContiguous (
  ...
  long,                                                             // Number of adjacent samples
  long);                                                            // Source array length
double _stdcall SDS_InterpolateQuadratic1D (
  double,                                                          // y(0) input sample magnitude
  double,                                                           // y(1) input sample magnitude
  double,                                                           // y(2) input sample magnitude
  double);                                                          // Alpha x
double _stdcall SDS_InterpolateQuadraticBSpline1D (
  double,                                                          // y(0) input sample magnitude
  double,                                                           // y(1) input sample magnitude
  double,                                                           // y(2) input sample magnitude
  double);                                                          // Alpha x
double _stdcall SDS_InterpolateQuadraticLagrange1D (
...
// DTMF generation and detection functions - dtmf.c
  ...
  long);                                                            // Array length
long _stdcall  SDA_DtmfDetectAndValidate (
  ...
  long);                                                            // Array length
long _stdcall  SUF_AsciiToKeyCode (
  long);                                                           // ASCII key code
long _stdcall  SUF_KeyCodeToAscii (
  long);                                                           // SigLib key code

// Speech processing functions - speech.c
void _stdcall  SIF_PreEmphasisFilter (
  double *);                                                       // Pointer to filter state
void _stdcall  SDA_PreEmphasisFilter (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Filter coefficient
  double *,                                                         // Pointer to filter state
  long);                                                            // Array length
void _stdcall  SIF_DeEmphasisFilter (
  double *SIGLIB_OUTPUT_PTR_DECL);                                 // Pointer to filter state
void _stdcall  SDA_DeEmphasisFilter (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Filter coefficient
  double *,                                                         // Pointer to filter state
  long);                                                            // Array length
void _stdcall  SDA_AdpcmEncoder (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_AdpcmEncoderDebug (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to estimate array
  long);                                                            // Array length
void _stdcall  SDA_AdpcmDecoder (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length

// Min max and peak hold functions - minmax.c
double _stdcall SDA_Max (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_AbsMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_Min (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_AbsMin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_Middle (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_Range (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
long _stdcall  SDA_MaxIndex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
long _stdcall  SDA_AbsMaxIndex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
long _stdcall  SDA_MinIndex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
long _stdcall  SDA_AbsMinIndex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDS_Max (
  double,                                                          // Sample 1
  double);                                                          // Sample 2
double _stdcall SDS_AbsMax (
  double,                                                          // Sample 1
  double);                                                          // Sample 2
double _stdcall SDS_Min (
  double,                                                          // Sample 1
  double);                                                          // Sample 2
double _stdcall SDS_AbsMin (
  double,                                                          // Sample 1
  double);                                                          // Sample 2
double _stdcall SDA_LocalMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long,                                                             // Location
  long,                                                             // Number of samples to search either side of centre
  long);                                                            // Array length
double _stdcall SDA_LocalAbsMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long,                                                             // Location
  long,                                                             // Number of samples to search either side of centre
  long);                                                            // Array length
double _stdcall SDA_LocalMin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long,                                                             // Location
  long,                                                             // Number of samples to search either side of centre
  long);                                                            // Array length
double _stdcall SDA_LocalAbsMin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long,                                                             // Location
  long,                                                             // Number of samples to search either side of centre
  long);                                                            // Array length
void _stdcall  SDA_Max2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_AbsMax2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SignedAbsMax2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Min2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_AbsMin2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SignedAbsMin2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_PeakHold (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to peak array
  double,                                                           // Peak decay rate
  double *,                                                         // Pointer to previous peak
  long);                                                            // Array lengths
void _stdcall  SDA_PeakHoldPerSample (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to peak array
  double,                                                           // Peak decay rate
  long);                                                            // Array length
long _stdcall  SDA_DetectFirstPeakOverThreshold (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // Threshold over which peak will be detected
  long);                                                            // Array length
double _stdcall SDS_Round (
  double,                                                          // Data sample
  int SLRoundingMode_t);                                            // Rounding mode
void _stdcall  SDA_Round (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  int SLRoundingMode_t,                                             // Rounding mode
  long);                                                            // Array length
double _stdcall SDS_Clip (
  double,                                                          // Source value
  double,                                                           // Value to clip signal to
  int SLClipMode_t);                                                // Clip type
void _stdcall  SDA_Clip (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array address
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination array address
  double,                                                           // Value to clip signal to
  int SLClipMode_t,                                                 // Clip type
  long);                                                            // Array length
double _stdcall SDS_Threshold (
  double,                                                          // Source value
  double,                                                           // Threshold
  int SLThresholdMode_t);                                           // Threshold type
void _stdcall  SDA_Threshold (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Threshold
  int SLThresholdMode_t,                                            // Threshold type
  long);                                                            // Array length
double _stdcall SDS_SoftThreshold (
  double,                                                          // Source value
  double);                                                          // Threshold
void _stdcall  SDA_SoftThreshold (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Threshold
  long);                                                            // Array length
double _stdcall SDS_ThresholdAndClamp (
  double,                                                          // Source value
  double,                                                           // Threshold
  double,                                                           // Clamp level
  int SLThresholdMode_t);                                           // Threshold type
void _stdcall  SDA_ThresholdAndClamp (
  ...
  int SLThresholdMode_t,                                            // Threshold type
  long);                                                            // Array length
double _stdcall SDS_Clamp (
  double,                                                          // Source value
  double,                                                           // Threshold
  double,                                                           // Clamp value
  int SLThresholdMode_t);                                           // Threshold type
void _stdcall  SDA_Clamp (
  ...
  int SLThresholdMode_t,                                            // Threshold type
  long);                                                            // Array length
long _stdcall  SDA_TestOverThreshold (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // Threshold
  long);                                                            // Array length
long _stdcall  SDA_TestAbsOverThreshold (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // Threshold
  long);                                                            // Array length
void _stdcall  SDA_SelectMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SelectMin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SelectMagnitudeSquaredMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array 1
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array length
void _stdcall  SDA_SelectMagnitudeSquaredMin (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array length
double _stdcall SDS_SetMinValue (
  double src,                                                      // Input sample
  double);                                                          // Minimum value
void _stdcall  SDA_SetMinValue (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Minimum value
  long);                                                            // Array length
double _stdcall SDA_PeakToAverageRatio (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_PeakToAveragePowerRatio (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_PeakToAveragePowerRatioDB (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_PeakToAverageRatioComplex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  long);                                                            // Array length
double _stdcall SDA_PeakToAveragePowerRatioComplex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  long);                                                            // Array length
double _stdcall SDA_PeakToAveragePowerRatioComplexDB (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  long);                                                            // Array length
void _stdcall  SDA_MovePeakTowardsDeadBand (
  ...
  double *,                                                         // Pointer to one-pole state variable
  long);                                                            // Input array length
double _stdcall SDS_InterpolateThreePointQuadraticVertexMagnitude (
  double,                                                          // y0
  double,                                                           // y1
  double);                                                          // y2
double _stdcall SDS_InterpolateThreePointQuadraticVertexLocation (
  double,                                                          // y0
  double,                                                           // y1
  double);                                                          // y2
double _stdcall SDS_InterpolateArbitraryThreePointQuadraticVertexMagnitude (
  ...
  double,                                                           // x2
  double);                                                          // y2
double _stdcall SDS_InterpolateArbitraryThreePointQuadraticVertexLocation (
  ...
  double,                                                           // x2
  double);                                                          // y2
double _stdcall SDA_InterpolateThreePointQuadraticVertexMagnitude (
  double *SIGLIB_INPUT_PTR_DECL);                                  // Pointer to source array
double _stdcall SDA_InterpolateThreePointQuadraticVertexLocation (
  double *SIGLIB_INPUT_PTR_DECL);                                  // Pointer to source array
double _stdcall SDA_InterpolateArbitraryThreePointQuadraticVertexMagnitude (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_InterpolateArbitraryThreePointQuadraticVertexLocation (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_InterpolateArbitraryThreePointQuadraticPeakVertexMagnitude (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_InterpolateArbitraryThreePointQuadraticPeakVertexLocation (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_FirstMinVertex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
long _stdcall  SDA_FirstMinVertexPos (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_FirstMaxVertex (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
long _stdcall  SDA_FirstMaxVertexPos (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
void _stdcall  SDA_NLargest (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array length
  long);                                                            // Number of values to find
void _stdcall  SDA_NSmallest (
...
// DSP Math functions - smath.c
void _stdcall  SDA_Divide (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // Divisor
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Divide2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
void _stdcall  SDA_Multiply (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // Multiplier
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Multiply2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
void _stdcall  SDS_ComplexMultiply (
  double,                                                          // Real source 1
  double,                                                           // Imaginary source 1
  double,                                                           // Real source 2
  double,                                                           // Imaginary source 2
  double *,                                                         // Real result
  double *);                                                        // Imaginary result
void _stdcall  SDS_ComplexInverse (
  double,                                                          // Real source 1
  double,                                                           // Imaginary source 1
  double *,                                                         // Real result
  double *);                                                        // Imaginary result
void _stdcall  SDA_ComplexInverse (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array 1
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array lengths
void _stdcall  SDS_ComplexDivide (
  ...
  double *,                                                         // Real result
  double *);                                                        // Imaginary result
void _stdcall  SDA_ComplexScalarMultiply (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array lengths
void _stdcall  SDA_ComplexMultiply2 (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array lengths
void _stdcall  SDA_ComplexScalarDivide (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array lengths
void _stdcall  SDA_ComplexDivide2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real numerator source array
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array lengths
double _stdcall SDA_RealDotProduct (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source vector 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source vector 2
  long);                                                            // Vector length
            void _stdcall SDA_SumAndDifference (
  ...
  long);                                                            // Array length
void _stdcall  SDA_Add2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Add3 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 3
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Add4 (
  ...
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_WeightedSum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Sum weight
  long);                                                            // Vector length
void _stdcall  SDA_Subtract2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Add (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // Offset
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDA_PositiveOffset (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDA_NegativeOffset (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Negate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Inverse (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Square (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Sqrt (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Difference (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDA_SumOfDifferences (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  long);                                                            // Array length
long _stdcall  SDS_Roots (
  double,                                                          // a
  double,                                                           // b
  double,                                                           // c
  double *,                                                         // Pointer to root # 1
  double *);                                                        // Pointer to root # 2
double _stdcall SDS_Factorial (
  double);                                                         // Input value
double _stdcall SDS_Permutations (
  double n,                                                        // Set size
  double k);                                                        // Selection size
double _stdcall SDS_Combinations (
  double n,                                                        // Set size
  double k);                                                        // Selection size
void _stdcall  SIF_OverlapAndAddLinear (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to the value used to in(de)crement between the two arrays
  long);                                                            // Array length
void _stdcall  SDA_OverlapAndAddLinear (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Value used to in(de)crement between the two arrays
  long);                                                            // Array length
void _stdcall  SDA_OverlapAndAddLinearWithClip (
  ...
  double,                                                           // Value used to in(de)crement between the two arrays
  long);                                                            // Array length
void _stdcall  SDA_OverlapAndAddArbitrary (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to window function array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_OverlapAndAddArbitraryWithClip (
  ...
  double,                                                           // Threshold limiting value
  long);                                                            // Array length
double _stdcall SDS_DegreesToRadians (
  double);                                                         // Angle in degrees
void _stdcall  SDA_DegreesToRadians (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDS_RadiansToDegrees (
  double);                                                         // Angle in radians
void _stdcall  SDA_RadiansToDegrees (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
long _stdcall  SDS_DetectNAN (
  double);                                                         // Source sample
long _stdcall  SDA_DetectNAN (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length

// DSP utility functions - dsputils.c
void _stdcall  SDA_Rotate (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array address
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination array address
  long,                                                             // Number of bins to rotate data
  long);                                                            // Array length
void _stdcall  SDA_Reverse (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array address
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination array address
  long);                                                            // Array length
double _stdcall SDA_Scale (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Source array address
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Destination array address
  double,                                                           // Maximum scaled value
  long);                                                            // Array length
double _stdcall SDA_MeanSquare (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
double _stdcall SDA_MeanSquareError (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double,                                                           // Inverse of the array length
  long);                                                            // Array length
double _stdcall SDA_RootMeanSquare (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
void _stdcall  SDA_Magnitude (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  ...
  long);                                                            // Array length
void _stdcall  SDA_MagnitudeSquared (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to square magnitude destination array
  long);                                                            // Array length
double _stdcall SDS_Magnitude (
  double,                                                          // Real source sample
  double);                                                          // Imaginary source sample
double _stdcall SDS_MagnitudeSquared (
  double,                                                          // Real source sample
  double);                                                          // Imaginary source sample
double _stdcall SDS_Phase (
  double,                                                          // Real source sample
  double);                                                          // Imaginary source sample
void _stdcall  SDA_PhaseWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_PhaseUnWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_MagnitudeAndPhaseWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to magnitude destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_MagnitudeAndPhaseUnWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to magnitude destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_MagnitudeSquaredAndPhaseWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to square magnitude destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_MagnitudeSquaredAndPhaseUnWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to square magnitude destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_PhaseWrap (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_PhaseUnWrap (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDS_Log2 (
  double);                                                         // Source value
void _stdcall  SDA_Log2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDS_LogN (
  double,                                                          // Source value
  double);                                                          // Base number
void _stdcall  SDA_LogN (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Base number
  long);                                                            // Array length
void _stdcall  SDA_LogDistribution (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to destination array
  double,                                                           // Start value
  double,                                                           // End value
  long);                                                            // Number of steps
void _stdcall  SDA_Copy (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_CopyWithStride (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long,                                                             // Pointer to source array stride
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Pointer to source array stride
  long);                                                            // Source array length
void _stdcall  SIF_CopyWithOverlap (
  long *);                                                         // Pointer to source array index
long _stdcall  SDA_CopyWithOverlap (
  ...
  long,                                                             // Overlap length
  long);                                                            // Destination array length
void _stdcall  SIF_CopyWithIndex (
  long *);                                                         // Pointer to source array index
long _stdcall  SDA_CopyWithIndex (
  ...
  long,                                                             // Stride length
  long);                                                            // Destination array length
void _stdcall  SDA_20Log10 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_10Log10 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_LogMagnitude (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to log magnitude destination array
  long);                                                            // Array length
void _stdcall  SDA_LogMagnitudeAndPhaseWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to log magnitude destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_LogMagnitudeAndPhaseUnWrapped (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real data source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary data source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to log magnitude destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to phase destination array
  long);                                                            // Array length
void _stdcall  SDA_Lengthen (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array size
  long);                                                            // Destination array size
void _stdcall  SDA_Shorten (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Destination array size
void _stdcall  SIF_ReSize (
  long *);                                                         // Pointer to state array length
long _stdcall  SDA_ReSize (
  ...
  long,                                                             // Source array length
  long);                                                            // Destination array length
void _stdcall  SDA_ReSizeInput (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to state array
  long *,                                                           // Pointer to state array length
  long);                                                            // Source array length
long _stdcall  SDA_ReSizeOutput (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to destination array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to state array
  long *,                                                           // Pointer to state array length
  long);                                                            // Destination array length
void _stdcall  SDA_Fill (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Pointer to array
  double,                                                           // Fill value
  long);                                                            // Array length
void _stdcall  SDA_Clear (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long);                                                            // Array length
void _stdcall  SDA_Histogram (
  ...
  long,                                                             // Source array size
  long);                                                            // Destination array size
void _stdcall  SDA_HistogramCumulative (
  ...
  long,                                                             // Source array size
  long);                                                            // Destination array size
void _stdcall  SDA_HistogramExtended (
  ...
  long,                                                             // Source array size
  long);                                                            // Destination array size
void _stdcall  SDA_HistogramExtendedCumulative (
  ...
  long,                                                             // Source array size
  long);                                                            // Destination array size
void _stdcall  SIF_Histogram (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to histogram array
  long);                                                            // Histogram array size
void _stdcall  SDA_HistogramEqualize (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // New peak value
  long);                                                            // Source array size
void _stdcall  SDA_Quantize (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Quantisation number of bits
  double,                                                           // Peak value
  long);                                                            // Source array size
double _stdcall SDS_Quantize (
  double,                                                          // Source sample
  long,                                                             // Quantisation number of bits
  double);                                                          // Peak value
void _stdcall  SDA_Quantize_N (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Quantisation number
  long);                                                            // Source array size
double _stdcall SDS_Quantise_N (
  double,                                                          // Source sample
  double);                                                          // Quantisation number
void _stdcall  SDA_Abs (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
double _stdcall SDS_PeakValueToBits (
  double,                                                          // Peak value
  int SLSignalSign_t);                                              // Sign type of the signal
double _stdcall SDS_BitsToPeakValue (
  double,                                                          // Number of bits
  int SLSignalSign_t);                                              // Sign type of the signal
double _stdcall SDS_VoltageTodBm (
  ...
  double,                                                           // Zero dBm level
  long);                                                            // Array lengths
double _stdcall SDS_dBmToVoltage (
  ...
  double,                                                           // Comparison threshold
  long);                                                            // Array lengths
double _stdcall SDS_Int (
  double);                                                         // Source sample
double _stdcall SDS_Frac (
  double);                                                         // Source sample
double _stdcall SDS_AbsFrac (
  double);                                                         // Source sample
void _stdcall  SDA_Int (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
void _stdcall  SDA_Frac (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
void _stdcall  SDA_AbsFrac (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
void _stdcall  SDA_SetMin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // New minimum value
  long);                                                            // Array lengths
void _stdcall  SDA_SetMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // New maximum value
  long);                                                            // Array lengths
void _stdcall  SDA_SetRange (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // New minimum value
  double,                                                           // New maximum value
  long);                                                            // Array lengths
void _stdcall  SDA_SetMean (
...
// dsputil2.c
void _stdcall  SDA_RealSpectralInverse (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array lengths
void _stdcall  SDA_ComplexSpectralInverse (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to imaginary source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to real destination array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to imaginary destination array
  long);                                                            // Array lengths
void _stdcall  SDA_FdInterpolate (
  ...
  long,                                                             // Ratio down
  long);                                                            // Array lengths
void _stdcall  SDA_FdInterpolate2 (
  ...
  long,                                                             // Source array length
  long);                                                            // Destination array length
double _stdcall SDS_TdPitchShift (
...
void _stdcall  SDA_TdPitchShift (
  ...
  long,                                                             // Length of pitch shift array
  long);                                                            // Array length
double _stdcall SDS_EchoGenerate (
...
void _stdcall  SDA_Power (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Power to raise samples
  long);                                                            // Array length
double _stdcall SDS_Polynomial (
  ...
  double,                                                           // x^5 coefficient
  long);                                                            // Array length
double _stdcall SDS_Modulo (
  double,                                                          // Source data
  double,                                                           // Modulo number
  int SLModuloMode_t);                                              // Modulo mode
void _stdcall  SDA_Modulo (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Modulo number
  int SLModuloMode_t,                                               // Modulo mode
  long);                                                            // Array length
void _stdcall  SDA_AgcPeak (
  ...
  double,                                                           // Threshold for update of AGC
  long);                                                            // Length of moving average
void _stdcall  SDA_AgcMeanSquared (
  ...
  long);                                                            // Array length
long _stdcall  SDA_ZeroCrossingDetect (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
double _stdcall SDS_ZeroCrossingDetect (
  double,                                                          // Input source sample
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t);                                       // Zero crossing type - +ve, -ve, both
long _stdcall  SDA_FirstZeroCrossingLocation (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
long _stdcall  SDA_ZeroCrossingCount (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
long _stdcall  SDA_LevelCrossingDetect (
  ...
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
double _stdcall SDS_LevelCrossingDetect (
  double,                                                          // Input source sample
  double DetectionLevel,                                            // Detection level
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t);                                       // Zero crossing type - +ve, -ve, both
long _stdcall  SDA_FirstLevelCrossingLocation (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double DetectionLevel,                                            // Detection level
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
long _stdcall  SDA_LevelCrossingCount (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double DetectionLevel,                                            // Detection level
  double *,                                                         // Pointer to previous source data value
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
long _stdcall  SDA_Trigger (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *,                                                         // Pointer to sign from last array processed
  double,                                                           // Trigger Level
  int SLLevelCrossingMode_t,                                        // Zero crossing type - +ve, -ve, both
  long);                                                            // Array length
void _stdcall  SDA_ClearLocation (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  long,                                                             // Location to clear
  long);                                                            // Array length
void _stdcall  SDA_SetLocation (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to real source array
  long,                                                             // Location to set
  double,                                                           // Value to set
  long);                                                            // Array length
void _stdcall  SDA_SortMinToMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SortMaxToMin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SortMinToMax2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array #1
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array #2
  long);                                                            // Array length
void _stdcall  SDA_SortMaxToMin2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array #1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array #2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array #1
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array #2
  long);                                                            // Array length
void _stdcall  SDA_SortIndexed (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to index array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
long _stdcall  SDS_CountOneBits (
  long);                                                           // Input data word
long _stdcall  SDS_CountZeroBits (
  long);                                                           // Input data word
long _stdcall  SDS_CountLeadingOneBits (
  long);                                                           // Input data word
long _stdcall  SDS_CountLeadingZeroBits (
  long);                                                           // Input data word
void _stdcall  SDA_Sign (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Swap (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to array 2
  long);                                                            // Array length
long _stdcall  SUF_ModuloIncrement (
  long,                                                            // Input value
  long,                                                             // Increment value
  long);                                                            // modulo value
long _stdcall  SUF_ModuloDecrement (
  long,                                                            // Input value
  long,                                                             // Decrement value
  long);                                                            // modulo value
long _stdcall  SUF_IndexModuloIncrement (
  long,                                                            // Input value
  long,                                                             // Increment value
  long);                                                            // modulo value
long _stdcall  SUF_IndexModuloDecrement (
  long,                                                            // Input value
  long,                                                             // Decrement value
  long);                                                            // modulo value
long _stdcall  SDA_Find (
...
// dsputil3.c
  ...
  double *,                                                         // Current level holdover
  long);                                                            // Array length
long _stdcall  SDA_RemoveDuplicates (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Source array length
long _stdcall  SDA_FindAllDuplicates (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array length 1
  long);                                                            // Source array length 2
long _stdcall  SDA_FindFirstDuplicates (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array length 1
  long);                                                            // Source array length 2
long _stdcall  SDA_FindSortAllDuplicates (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array length 1
  long);                                                            // Source array length 2
long _stdcall  SDA_FindSortFirstDuplicates (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array 1
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array 2
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // Source array length 1
  long);                                                            // Source array length 2
void _stdcall  SDA_Shuffle (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Source array length
void _stdcall  SDA_InsertSample (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double,                                                           // New sample
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // New sample location
  long);                                                            // Source array length
void _stdcall  SDA_InsertArray (
  ...
  long);                                                            // Source array length
double _stdcall SDA_ExtractSample (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long,                                                             // New sample location
  long);                                                            // Source array length
void _stdcall  SDA_ExtractArray (
...
void _stdcall  SDA_SigLibDataToFix (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_FixToSigLibData (
  long *SIGLIB_INPUT_PTR_DECL,                                     // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SigLibDataToImageData (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_ImageDataToSigLibData (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SigLibDataToFix16 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  short *SIGLIB_OUTPUT_PTR_DECL,                                    // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Fix16ToSigLibData (
  short *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_SigLibDataToFix32 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  int *SIGLIB_OUTPUT_PTR_DECL,                                      // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Fix32ToSigLibData (
  int *SIGLIB_INPUT_PTR_DECL,                                      // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
long _stdcall  SDS_SigLibDataToQFormatInteger (
  double x,                                                        // Source value
  long,                                                             // m
  long);                                                            // n
double _stdcall SDS_QFormatIntegerToSigLibData (
  long,                                                            // Q format integer data
  long);                                                            // n
void _stdcall  SDA_SigLibDataToQFormatInteger (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  long *SIGLIB_OUTPUT_PTR_DECL,                                     // Pointer to destination array
  long,                                                             // m
  long,                                                             // n
  long);                                                            // Array length
void _stdcall  SDA_QFormatIntegerToSigLibData (
...
// Order analysis functions - order.c
double _stdcall SDA_ExtractOrder (
  ...
  long);                                                            // Input array length
double _stdcall SDA_SumLevelWholeSpectrum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  int SLSignalCoherenceType_t,                                      // Signal coherence type
  long,                                                             // Log magnitude flag
  double,                                                           // Linear scaling value
  long);                                                            // Input array length
void _stdcall  SIF_OrderAnalysis (
  ...
  long);                                                            // FFT length
double _stdcall SDA_OrderAnalysis (
...
double _stdcall SDA_Sum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to array
  long);                                                            // Array length
double _stdcall SDA_AbsSum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to array
  long);                                                            // Array length
double _stdcall SDA_SumOfSquares (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to array
  long);                                                            // Array length
double _stdcall SDA_Mean (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to array
  double,                                                           // Inverse of array length
  long);                                                            // Array length
double _stdcall SDA_AbsMean (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to array
  double,                                                           // Inverse of array length
  long);                                                            // Array length
void _stdcall  SDA_SubtractMean (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Inverse of array length
  long);                                                            // Array length
void _stdcall  SDA_SubtractMax (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDA_SampleSd (
...
double _stdcall SDA_LinraConstantCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_LinraRegressionCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_LinraCorrelationCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_LinraEstimateX (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // Y value
  long);                                                            // Array length
double _stdcall SDA_LinraEstimateY (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // X value
  long);                                                            // Array length
 double _stdcall SDA_LograConstantCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_LograRegressionCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_LograCorrelationCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_LograEstimateX (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // Y value
  long);                                                            // Array length
double _stdcall SDA_LograEstimateY (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // X value
  long);                                                            // Array length
 double _stdcall SDA_ExpraConstantCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_ExpraRegressionCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_ExpraCorrelationCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_ExpraEstimateX (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // Y value
  long);                                                            // Array length
double _stdcall SDA_ExpraEstimateY (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // X value
  long);                                                            // Array length
 double _stdcall SDA_PowraConstantCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_PowraRegressionCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_PowraCorrelationCoeff (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  long);                                                            // Array length
double _stdcall SDA_PowraEstimateX (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // Y value
  long);                                                            // Array length
double _stdcall SDA_PowraEstimateY (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to X array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Y array
  double,                                                           // X value
  long);                                                            // Array length
void _stdcall  SDA_Detrend (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double *SIGLIB_INOUT_PTR_DECL,                                    // Pointer to ramp array
  long);                                                            // Array length
void _stdcall  SDA_ExtractTrend (
...
// Trigonometrical functions - trig.c
void _stdcall  SDA_Sin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Cos (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SDA_Tan (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
void _stdcall  SIF_FastSin (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  long);                                                            // Table length
void _stdcall  SDA_FastSin (
  ...
  long);                                                            // Array length
double _stdcall SDS_FastSin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Sine table pointer
  double *,                                                         // Sine table phase
  double,                                                           // Sine wave frequency
  long);                                                            // Sine wave look up table length
void _stdcall  SIF_FastCos (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  long);                                                            // Table length
void _stdcall  SDA_FastCos (
  ...
  long);                                                            // Array length
double _stdcall SDS_FastCos (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Cosine table pointer
  double *,                                                         // Cosine table phase
  double,                                                           // Cosine wave frequency
  long);                                                            // Cosine wave look up table length
void _stdcall  SIF_FastSinCos (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  long);                                                            // Table length
void _stdcall  SDA_FastSinCos (
  ...
  double,                                                           // Sine wave frequency
  long);                                                            // Sine wave period
void _stdcall  SIF_QuickSin (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  double *,                                                         // Pointer to phase gain
  long);                                                            // Table length
void _stdcall  SDA_QuickSin (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Sine table pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Phase gain
  long);                                                            // Array length
double _stdcall SDS_QuickSin (
  double,                                                          // Angle
  double *SIGLIB_INPUT_PTR_DECL,                                    // Sine table pointer
  double);                                                          // Phase gain
void _stdcall  SIF_QuickCos (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  double *,                                                         // Pointer to phase gain
  long);                                                            // Table length
void _stdcall  SDA_QuickCos (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Cosine table pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Phase gain
  long);                                                            // Array length
double _stdcall SDS_QuickCos (
  double,                                                          // Angle
  double *SIGLIB_INPUT_PTR_DECL,                                    // Cosine table pointer
  double);                                                          // Phase gain
void _stdcall  SIF_QuickSinCos (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  double *,                                                         // Pointer to phase gain
  long);                                                            // Sine table period
void _stdcall  SDA_QuickSinCos (
  ...
  double,                                                           // Phase gain
  long);                                                            // Sine wave look up table period
void _stdcall  SIF_QuickTan (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to LUT array
  double *,                                                         // Pointer to phase gain
  long);                                                            // Table length
void _stdcall  SDA_QuickTan (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Tangent table pointer
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Phase gain
  long);                                                            // Array length
double _stdcall SDS_QuickTan (
  double,                                                          // Angle
  double *SIGLIB_INPUT_PTR_DECL,                                    // Tangent table pointer
  double);                                                          // Phase gain
void _stdcall  SDA_Sinc (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  long);                                                            // Array length
double _stdcall SDS_Sinc (
  double);                                                         // Source 'x' value
void _stdcall  SIF_QuickSinc (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Pointer to Sinc look up table
  double *,                                                         // Pointer to phase gain
  double,                                                           // Maximum input 'x' value
  long);                                                            // Look up table length
void _stdcall  SDA_QuickSinc (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source array
  double *SIGLIB_INPUT_PTR_DECL,                                    // Pointer to Sinc look up table
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination array
  double,                                                           // Phase gain
  long);                                                            // Source array length
double _stdcall SDS_QuickSinc (
...
// 2D Matrix manipulation functions and macros - matrix.c
...
void _stdcall  SMX_CreateIdentity (
  double *SIGLIB_OUTPUT_PTR_DECL,                                  // Output Matrix pointer
  long);                                                            //  Destination matrix # of rows and columns
long _stdcall  SMX_Inverse2x2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Pointer to destination matrix
long _stdcall  SMX_ComplexInverse2x2 (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to complex source matrix
  double *SIGLIB_OUTPUT_PTR_DECL);                                  // Pointer to complex destination matrix
long _stdcall  SMX_Inverse (
...
long _stdcall  SMX_LuDecompose (
  double *SIGLIB_INOUT_PTR_DECL,                                   // Source and destination matrix pointer
  long *SIGLIB_INOUT_PTR_DECL,                                      // Index matrix pointer
  double *SIGLIB_INOUT_PTR_DECL,                                    // Scaling factor array
  long);                                                            // Number of rows and columns in matrix
void _stdcall  SMX_LuSolve (
  ...
  double *SIGLIB_INOUT_PTR_DECL,                                    // Scaling factor array
  long);                                                            // Number of rows and columns in matrix
double _stdcall SMX_LuDeterminant (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  long *SIGLIB_INOUT_PTR_DECL,                                      // Index matrix pointer
  long);                                                            // Number of rows and columns in matrix
void _stdcall  SMX_RotateClockwise (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_RotateAntiClockwise (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_Reflect (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_Flip (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_InsertRow (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_ExtractRow (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Row number to extract
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_InsertColumn (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_ExtractColumn (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Column number to extract
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_InsertNewRow (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_DeleteOldRow (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Row number to delete
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_InsertNewColumn (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_DeleteOldColumn (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Column number to delete
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_InsertRegion (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_ExtractRegion (
  ...
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_InsertDiagonal (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_INPUT_PTR_DECL,                                    // New data to place on diagonal
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long);                                                            // Dimension of square matrix
void _stdcall  SMX_ExtractDiagonal (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long);                                                            // Dimension of square matrix
void _stdcall  SMX_SwapRows (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_Sum (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_ShuffleColumns (
  ...
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_ShuffleRows (
  double *SIGLIB_INPUT_PTR_DECL,                                   // Pointer to source matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to destination matrix
  double *SIGLIB_OUTPUT_PTR_DECL,                                   // Pointer to temporary array
  long,                                                             // Number of rows in matrix
  long);                                                            // Number of columns in matrix
void _stdcall  SMX_ExtractCategoricalColumn (

...
void LineGraph::SetStatusBarValueText (
  wxString String)
{
...
wxString LineGraph::GetStatusBarValueText (
  void)
{
...
void LineGraph::SetQuantizeXAxisFlag (
  bool flag)
{
...
bool LineGraph::GetQuantizeXAxisFlag (
  void)
{
...
void LineGraph::SetStatusBarIndexMultiplier (
  double Multiplier)
{
...
double LineGraph::GetStatusBarIndexMultiplier (
  void)
{
...
void LineGraphCanvas::OnMouseMove (
  wxMouseEvent & event)
{
...
// Define the repainting behaviour
void PoleZeroPlotCanvas::OnPaint (
  wxPaintEvent & WXUNUSED (event))
{

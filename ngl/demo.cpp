    ...
    : wxFrame((wxFrame*)NULL, wxID_ANY, Title, Position, Size, wxDEFAULT_FRAME_STYLE)
{
  ...
  // Create graph window
  //  wxWindow *MyWindow = new wxWindow (this, -1, wxDefaultPosition,
  //  GetClientSize()); FilterGraphDisplay = new GraphDisplay (MyWindow);
  //  GlobalGraphDisplay = FilterGraphDisplay;

  wxBoxSizer* VSizer = new wxBoxSizer(wxVERTICAL);

  wxPanel* MyPanel = new wxPanel(this, -1, wxDefaultPosition, wxDefaultSize);
  //  wxPanel *MyPanel = new wxPanel (this, -1, wxDefaultPosition,
  //  GetClientSize());
...
{
  wxMessageBox(_T ("Numerix Graphics Library Demo V1.20 (C) 2007, Delta Numerix"), _T ("About Numerix Graphics Library Demo"),
...
{
  //  wxMessageBox (_T("Got Here"), _T("mainFrame::DisplayStatusLineText"), wxOK

...
void generate_gaussian_noise(double noise_mean, double noise_std_dev, double (*noise)[3], int num_points)
{
...
void generate_spiral(double frequency, double (*spiral)[3], int num_points)
{
  for (int i = 0; i < num_points; i++) {
...
void transpose(const double* pSrcMatrix, double* pDstMatrix, const int Rows, const int Columns)
{

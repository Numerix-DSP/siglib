...
//  wxMessageBox (_T("Got here"), _T("MyFrame::Flash"), wxOK | wxICON_INFORMATION, this);
                                                                                      ...
                                                                                      // Set mask for transparent area
                                                                                                           LEDBitmap->SetMask (new
                                                                                                                               wxMask (*LEDBitmap,
                                                                                                                                       wxColour
                                                                                                                                       (LED_TRANSPARENT_RED,
                                                                                                                                        LED_TRANSPARENT_GREEN,
                                                                                                                                        LED_TRANSPARENT_BLUE)));
                                                                                                           canvas->Refresh (); }
                                                                                                           }

                                                                                                           void LED::
                                                                                                           OnTimer (wxTimerEvent & WXUNUSED (event))
